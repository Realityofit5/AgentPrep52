// ============================================================
// IA_curriculum.js — Iowa Real Estate Study System
// Iowa Real Estate Commission Broker/Salesperson License — 2026
// Sources: Iowa Real Estate Commission, NMLS, PSI Exams
...
const CURRICULUM_IA = {
  ...
  meta: {
    title: "IA Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Iowa",
    stateCode: "IA",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — IA SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "IA Real Estate Salesperson/Broker",
      icon: "🌾",
      color: "#FFCD00",
      description: "Iowa Real Estate Commission — 96-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Iowa broker",
      ...
      fees: [
        ...
        { item: "Iowa license fee", amount: "$170", source: "Iowa Real Estate Commission" },
      ...
      modules: [

        {
          id: "ia_b01",
          order: 1,
          title: "Licensing Process & Iowa Real Estate Commission Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Iowa licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Iowa Real Estate",
              body: "The Iowa Real Estate Commission licenses and regulates real estate salespersons and brokers in Iowa.\n\nIowa requires 96 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Iowa:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nIowa uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 36 hours every 3 year(s)."
            },
            {
              heading: "96-Hour Pre-License Education",
              body: "Iowa requires 96 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Iowa real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Iowa\n• Iowa-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nIowa-specific education note: Iowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Iowa uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Iowa Real Estate Commission\n• Submit background check results\n• Pay license fee of $170\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Iowa licenses must be renewed every 3 year(s).\n\nCE requirements: 36 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Iowa-specific law\n• Elective topics\n\nIowa-specific requirement: Iowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations."
            },
            {
              heading: "Iowa-Specific Real Estate Law",
              body: "Key Iowa real estate law topics:\n\nIowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations.\n\nAdditional Iowa-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Iowa landlord-tenant law\n• Environmental regulations specific to Iowa\n• Agency law under Iowa statutes\n\nIowa unique aspect — agricultural land valuation and groundwater: Every Iowa real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "ia_b01q01",
              prompt: "How many hours of pre-license education does Iowa require before taking the PSI Exams exam?",
              choices: [
                "48 hours",
                "96 hours",
                "144 hours",
              ...
              answer: 1,
              explanation: "Iowa requires 96 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Iowa law, agency, contracts, finance, and other required topics."
            },
            {
              id: "ia_b01q02",
              prompt: "How often must Iowa real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 3 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Iowa real estate licenses are renewed every 3 year(s). Licensees must complete 36 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "ia_b01q03",
              prompt: "Iowa's unique real estate requirement regarding agricultural land valuation and groundwater means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Iowa-specific rules that differ from most other states",
                "All transactions in Iowa follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand agricultural land valuation and groundwater"
              ],
              answer: 1,
              explanation: "Iowa's unique agricultural land valuation and groundwater requirement means all licensees must understand state-specific rules. Iowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations."
            },
            {
              id: "ia_b01q04",
              prompt: "The PSI Exams exam used in Iowa consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Iowa consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "ia_b01q05",
              prompt: "A new Iowa licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "ia_b02",
          order: 2,
          title: "Property Ownership & Iowa Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Iowa-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Iowa",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nIowa-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Iowa must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Iowa",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nIowa marital property rules:\nIowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations.\n\nHomestead protection in Iowa provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Iowa",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nIowa-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Iowa",
              body: "Iowa uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Iowa where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Iowa.\n\nRecording in Iowa: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Iowa follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Iowa",
              body: "Transfer of title in Iowa requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nIowa deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Iowa property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "ia_b02q01",
              prompt: "In Iowa, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Iowa Real Estate Commission headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Iowa are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "ia_b02q02",
              prompt: "Which deed type provides the greatest protection for a Iowa buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Iowa. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "ia_b02q03",
              prompt: "Two friends purchase a Iowa property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Iowa. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "ia_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Iowa, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Iowa."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Iowa. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "ia_b04q02",
              prompt: "A Iowa buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Iowa Finance Authority (IFA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Iowa."
            },
            {
              id: "ia_b05q02",
              prompt: "A Iowa veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ia_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Iowa?",
              choices: [
...

        {
          id: "ia_b07",
          order: 7,
          title: "Fair Housing & Iowa Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Iowa-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Iowa Fair Housing Protections",
              body: "Iowa may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Iowa may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Iowa state statutes for current protected classes under Iowa fair housing law.\n\nIowa enforcement: File complaints with Iowa Real Estate Commission and/or HUD within applicable time limits. Iowa Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "ia_b08",
          order: 8,
          title: "Property Management & Iowa Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Iowa landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Iowa Landlord-Tenant Basics",
              body: "Iowa landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Iowa rules:\n• Security deposit: Iowa sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Iowa requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Iowa:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Iowa",
              body: "Property managers in Iowa generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Iowa statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nIowa property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "ia_b08q01",
              prompt: "A Iowa landlord collects a security deposit from a tenant. Under Iowa landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Iowa must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Iowa has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "ia_b10",
          order: 10,
          title: "Iowa License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Iowa license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Iowa License Law — Key Provisions",
              body: "Iowa real estate licensees must comply with:\n\nIowa Real Estate Commission rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nIowa specific: Iowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations."
            },
            {
              heading: "Iowa Real Estate Recovery Fund",
              body: "Iowa maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Iowa's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Iowa limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Iowa\n\nIowa trust account rules:\n• Client funds must be deposited promptly (check Iowa specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Iowa Real Estate Commission audit at any time"
            }
          ],
          quiz: [
            {
              id: "ia_b10q01",
              prompt: "A Iowa broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Iowa's license law and can result in license suspension or revocation."
            },
            {
              id: "ia_b10q02",
              prompt: "The Iowa Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ia_b11q02",
              prompt: "A Iowa investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Iowa state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Iowa rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Iowa state income tax on the gain (if Iowa has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "ia_b12",
          order: 12,
          title: "Iowa State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Iowa-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Iowa State Exam Key Topics",
              body: "Iowa state exam will focus on:\n\n1. Iowa license law — Iowa Real Estate Commission rules and procedures\n2. Iowa agency law — specific state requirements\n3. Iowa contract forms and requirements\n4. Iowa disclosure laws\n5. Iowa property tax system\n6. Iowa closing procedures\n7. Iowa-specific restrictions and regulations\n8. Iowa fair housing additions\n9. Iowa landlord-tenant law\n10. Iowa environmental law\n\nIowa unique state exam emphasis: Iowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations.\n\nStudy strategy:\n• Review Iowa Real Estate Commission website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Iowa-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "ia_b12q01",
              prompt: "Which Iowa licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Iowa Real Estate Commission has the legal authority to suspend or revoke a Iowa real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "ia_b12q02",
              prompt: "A Iowa licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "IA MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Iowa Division of Banking state requirements",
      requirements: [
        ...
        "Sponsored by a Iowa-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Iowa state license fee", amount: "$150–$300", source: "Iowa Division of Banking" },
      ...
      modules: [
        {
          id: "ia_m01",
          order: 1,
          title: "SAFE Act & Iowa MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Iowa Division of Banking requirements, and Iowa Finance Authority (IFA) programs.",
          content: [
            {
              heading: "Iowa MLO Regulation — Iowa Division of Banking",
              body: "Iowa MLOs are regulated by the Iowa Division of Banking through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Iowa must hold an active NMLS MLO license with a Iowa state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Iowa state endorsement through NMLS\n6. Obtain sponsorship from Iowa-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Iowa Finance Authority (IFA) Programs",
              body: "Iowa Finance Authority (IFA) provides mortgage programs for Iowa homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Iowa:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Iowa areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Iowa's state housing agency programs differentiates Iowa MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "ia_m01q01",
              prompt: "Which agency regulates Iowa MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Iowa MLO licenses are regulated by the Iowa Division of Banking. Real estate brokers and salespersons are regulated by the Iowa Real Estate Commission. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "ia_m01q02",
              prompt: "An MLO in Iowa must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "IA Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Iowa real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "ia_p01",
          order: 1,
          title: "Iowa Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Iowa listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Iowa Pre-Listing Preparation",
              body: "Steps to prepare a Iowa listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Iowa-specific issues: agricultural land valuation and groundwater\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Iowa-specific disclosure items: Iowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Iowa market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Iowa-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Iowa Market Dynamics",
              body: "Iowa's real estate market has unique characteristics:\n\nIowa follows the Iowa Groundwater Protection Act requiring disclosure of septic systems and wells. Iowa agricultural land is among the most productive farmland in the world and has unique valuation and transfer considerations.\n\nKey factors affecting Iowa real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nIowa market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Iowa-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Iowa: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "ia_p01q01",
              prompt: "During pre-listing due diligence for a Iowa property, an agent discovers the property may have agricultural land valuation and groundwater issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential agricultural land valuation and groundwater issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Iowa licensing roadmap + 96-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + agricultural land valuation and groundwater" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Iowa purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Iowa Finance Authority (IFA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Iowa additions) + Iowa license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Iowa-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Iowa tax considerations + 1031 exchange + Iowa state exam review + full practice exams" }
  ],

  resources: [
    { label: "Iowa License Requirements", url: "https://www.google.com/search?q=Iowa+real+estate+license+requirements", category: "broker" },
    { label: "Iowa Real Estate Commission Website", url: "https://www.google.com/search?q=Iowa+Real+Estate+Commission+official+website", category: "broker" },
    { label: "PSI Exams — Iowa Exam", url: "https://www.google.com/search?q=PSI+Exams+Iowa+real+estate+exam", category: "broker" },
    { label: "Iowa Finance Authority (IFA)", url: "https://www.google.com/search?q=Iowa+Finance+Authority+(IFA)+Iowa", category: "mlo" },
    { label: "Iowa Division of Banking", url: "https://www.google.com/search?q=Iowa+Division+of+Banking+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_IA;
