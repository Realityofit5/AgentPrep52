// ============================================================
// SD_curriculum.js — South Dakota Real Estate Study System
// South Dakota Real Estate Commission Broker/Salesperson License — 2026
// Sources: South Dakota Real Estate Commission, NMLS, PSI Exams
...
const CURRICULUM_SD = {
  ...
  meta: {
    title: "SD Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "South Dakota",
    stateCode: "SD",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — SD SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "SD Real Estate Salesperson/Broker",
      icon: "🦅",
      color: "#003087",
      description: "South Dakota Real Estate Commission — 116-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        "116 hours of approved pre-license education",
        "Pass PSI Exams exam: national + state sections; 75% passing score",
        "Background check",
        "Apply within 1 year of passing exam",
        "Must be sponsored by a licensed South Dakota broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "116-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$75", source: "PSI Exams" },
        { item: "South Dakota license fee", amount: "$225", source: "South Dakota Real Estate Commission" },
      ...
      modules: [

        {
          id: "sd_b01",
          order: 1,
          title: "Licensing Process & South Dakota Real Estate Commission Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete South Dakota licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates South Dakota Real Estate",
              body: "The South Dakota Real Estate Commission licenses and regulates real estate salespersons and brokers in South Dakota.\n\nSouth Dakota requires 116 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in South Dakota:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nSouth Dakota uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 24 hours every 2 year(s)."
            },
            {
              heading: "116-Hour Pre-License Education",
              body: "South Dakota requires 116 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• South Dakota real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in South Dakota\n• South Dakota-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nSouth Dakota-specific education note: South Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "South Dakota uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to South Dakota Real Estate Commission\n• Submit background check results\n• Pay license fee of $225\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "South Dakota licenses must be renewed every 2 year(s).\n\nCE requirements: 24 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• South Dakota-specific law\n• Elective topics\n\nSouth Dakota-specific requirement: South Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns."
            },
            {
              heading: "South Dakota-Specific Real Estate Law",
              body: "Key South Dakota real estate law topics:\n\nSouth Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns.\n\nAdditional South Dakota-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• South Dakota landlord-tenant law\n• Environmental regulations specific to South Dakota\n• Agency law under South Dakota statutes\n\nSouth Dakota unique aspect — no income tax and reservation land issues: Every South Dakota real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "sd_b01q01",
              prompt: "How many hours of pre-license education does South Dakota require before taking the PSI Exams exam?",
              choices: [
                "58 hours",
                "116 hours",
                "174 hours",
              ...
              answer: 1,
              explanation: "South Dakota requires 116 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, South Dakota law, agency, contracts, finance, and other required topics."
            },
            {
              id: "sd_b01q02",
              prompt: "How often must South Dakota real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "South Dakota real estate licenses are renewed every 2 year(s). Licensees must complete 24 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "sd_b01q03",
              prompt: "South Dakota's unique real estate requirement regarding no income tax and reservation land issues means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply South Dakota-specific rules that differ from most other states",
                "All transactions in South Dakota follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand no income tax and reservation land issues"
              ],
              answer: 1,
              explanation: "South Dakota's unique no income tax and reservation land issues requirement means all licensees must understand state-specific rules. South Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns."
            },
            {
              id: "sd_b01q04",
              prompt: "The PSI Exams exam used in South Dakota consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in South Dakota consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "sd_b01q05",
              prompt: "A new South Dakota licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "sd_b02",
          order: 2,
          title: "Property Ownership & South Dakota Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and South Dakota-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in South Dakota",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nSouth Dakota-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in South Dakota must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in South Dakota",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nSouth Dakota marital property rules:\nSouth Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns.\n\nHomestead protection in South Dakota provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in South Dakota",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nSouth Dakota-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in South Dakota",
              body: "South Dakota uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of South Dakota where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout South Dakota.\n\nRecording in South Dakota: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. South Dakota follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in South Dakota",
              body: "Transfer of title in South Dakota requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nSouth Dakota deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all South Dakota property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "sd_b02q01",
              prompt: "In South Dakota, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "South Dakota Real Estate Commission headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in South Dakota are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "sd_b02q02",
              prompt: "Which deed type provides the greatest protection for a South Dakota buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in South Dakota. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "sd_b02q03",
              prompt: "Two friends purchase a South Dakota property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of South Dakota",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in South Dakota. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "sd_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in South Dakota, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in South Dakota."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including South Dakota. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "sd_b04q02",
              prompt: "A South Dakota buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
...

        {
          id: "sd_b05",
          order: 5,
          title: "Real Estate Finance & South Dakota Mortgage Programs",
          week: "5-6",
          passingScore: 75,
          icon: "💰",
          objective: "Explain South Dakota financing options, South Dakota Housing Development Authority (SDHDA) programs, and key federal mortgage regulations.",
          content: [
            {
              heading: "South Dakota Housing Development Authority (SDHDA) Programs",
              body: "South Dakota Housing Development Authority (SDHDA) provides affordable homeownership programs for South Dakota residents:\n\nFirst-time homebuyer programs:\n• Below-market interest rate first mortgages\n• Income and purchase price limits apply (vary by county)\n• Must be primary residence\n\nDown payment assistance:\n• Grants or second mortgages for down payment and closing costs\n• Some programs forgivable after period of occupancy\n\nSpecial programs:\n• Veterans/military programs\n• Low-income and workforce housing programs\n• Renovation and rehabilitation loan programs\n\nMLO value in South Dakota: understanding South Dakota Housing Development Authority (SDHDA) programs is essential as many South Dakota first-time buyers use state housing agency financing."
            },
            {
              heading: "Federal Loan Programs in South Dakota",
              body: "Federal loan programs important in South Dakota:\n\nFHA Loans:\n• 3.5% down payment (with 580+ credit score)\n• MIP (mortgage insurance premium) required\n• Property must meet FHA minimum property standards\n• Common for first-time buyers in South Dakota\n\nVA Loans:\n• 0% down for eligible veterans and active military\n• No PMI required\n• Funding fee applies (waived for disabled veterans)\n• South Dakota military presence: check local military installations\n\nUSDA Rural Development:\n• 0% down for eligible rural properties\n• Income limits apply\n• Many South Dakota rural areas may qualify\n\nConventional/Fannie Mae-Freddie Mac:\n• Dominant in South Dakota's mortgage market\n• 3-20% down depending on program\n• Conforming loan limits vary by county"
            },
            {
              heading: "Deed of Trust vs. Mortgage in South Dakota",
              body: "Most states use either mortgages or deeds of trust as the security instrument for home loans.\n\nMortgage (two-party instrument):\n• Borrower (mortgagor) and lender (mortgagee)\n• Lender must use judicial foreclosure — court process\n• Generally slower and more expensive process\n• Borrower typically has right of redemption after foreclosure sale\n\nDeed of Trust (three-party instrument):\n• Trustor (borrower), trustee (holds legal title), beneficiary (lender)\n• Allows non-judicial (trustee's sale) foreclosure — faster and cheaper\n• Redemption rights vary; many deed of trust states have no redemption period\n\nSouth Dakota uses: check South Dakota statutes to determine whether South Dakota primarily uses mortgages or deeds of trust, and what the foreclosure process entails."
            }
          ],
          quiz: [
            {
              id: "sd_b05q01",
              prompt: "The South Dakota Housing Development Authority (SDHDA) provides down payment assistance to South Dakota homebuyers primarily to:",
              choices: [
              ...
              answer: 0,
              explanation: "South Dakota Housing Development Authority (SDHDA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in South Dakota."
            },
            {
              id: "sd_b05q02",
              prompt: "A South Dakota veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "sd_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in South Dakota?",
              choices: [
...

        {
          id: "sd_b07",
          order: 7,
          title: "Fair Housing & South Dakota Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and South Dakota-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "South Dakota Fair Housing Protections",
              body: "South Dakota may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in South Dakota may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck South Dakota state statutes for current protected classes under South Dakota fair housing law.\n\nSouth Dakota enforcement: File complaints with South Dakota Real Estate Commission and/or HUD within applicable time limits. South Dakota Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "sd_b08",
          order: 8,
          title: "Property Management & South Dakota Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply South Dakota landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "South Dakota Landlord-Tenant Basics",
              body: "South Dakota landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey South Dakota rules:\n• Security deposit: South Dakota sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: South Dakota requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in South Dakota:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in South Dakota",
              body: "Property managers in South Dakota generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck South Dakota statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nSouth Dakota property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "sd_b08q01",
              prompt: "A South Dakota landlord collects a security deposit from a tenant. Under South Dakota landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in South Dakota must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. South Dakota has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "sd_b10",
          order: 10,
          title: "South Dakota License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply South Dakota license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "South Dakota License Law — Key Provisions",
              body: "South Dakota real estate licensees must comply with:\n\nSouth Dakota Real Estate Commission rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nSouth Dakota specific: South Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns."
            },
            {
              heading: "South Dakota Real Estate Recovery Fund",
              body: "South Dakota maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of South Dakota's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current South Dakota limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in South Dakota\n\nSouth Dakota trust account rules:\n• Client funds must be deposited promptly (check South Dakota specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to South Dakota Real Estate Commission audit at any time"
            }
          ],
          quiz: [
            {
              id: "sd_b10q01",
              prompt: "A South Dakota broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of South Dakota's license law and can result in license suspension or revocation."
            },
            {
              id: "sd_b10q02",
              prompt: "The South Dakota Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "sd_b11q02",
              prompt: "A South Dakota investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, South Dakota state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a South Dakota rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) South Dakota state income tax on the gain (if South Dakota has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "sd_b12",
          order: 12,
          title: "South Dakota State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review South Dakota-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "South Dakota State Exam Key Topics",
              body: "South Dakota state exam will focus on:\n\n1. South Dakota license law — South Dakota Real Estate Commission rules and procedures\n2. South Dakota agency law — specific state requirements\n3. South Dakota contract forms and requirements\n4. South Dakota disclosure laws\n5. South Dakota property tax system\n6. South Dakota closing procedures\n7. South Dakota-specific restrictions and regulations\n8. South Dakota fair housing additions\n9. South Dakota landlord-tenant law\n10. South Dakota environmental law\n\nSouth Dakota unique state exam emphasis: South Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns.\n\nStudy strategy:\n• Review South Dakota Real Estate Commission website for current rules and statutes\n• Take multiple practice state exams\n• Focus on South Dakota-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "sd_b12q01",
              prompt: "Which South Dakota licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the South Dakota Real Estate Commission has the legal authority to suspend or revoke a South Dakota real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "sd_b12q02",
              prompt: "A South Dakota licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "SD MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + South Dakota Division of Banking state requirements",
      requirements: [
        ...
        "Sponsored by a South Dakota-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "South Dakota state license fee", amount: "$150–$300", source: "South Dakota Division of Banking" },
      ...
      modules: [
        {
          id: "sd_m01",
          order: 1,
          title: "SAFE Act & South Dakota MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, South Dakota Division of Banking requirements, and South Dakota Housing Development Authority (SDHDA) programs.",
          content: [
            {
              heading: "South Dakota MLO Regulation — South Dakota Division of Banking",
              body: "South Dakota MLOs are regulated by the South Dakota Division of Banking through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in South Dakota must hold an active NMLS MLO license with a South Dakota state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for South Dakota state endorsement through NMLS\n6. Obtain sponsorship from South Dakota-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "South Dakota Housing Development Authority (SDHDA) Programs",
              body: "South Dakota Housing Development Authority (SDHDA) provides mortgage programs for South Dakota homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in South Dakota:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural South Dakota areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing South Dakota's state housing agency programs differentiates South Dakota MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "sd_m01q01",
              prompt: "Which agency regulates South Dakota MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "South Dakota MLO licenses are regulated by the South Dakota Division of Banking. Real estate brokers and salespersons are regulated by the South Dakota Real Estate Commission. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "sd_m01q02",
              prompt: "An MLO in South Dakota must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "SD Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "South Dakota real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
        "Complete broker pre-license education",
        "Pass PSI Exams exam",
        "Active South Dakota license",
      ...
      modules: [
        {
          id: "sd_p01",
          order: 1,
          title: "South Dakota Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master South Dakota listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "South Dakota Pre-Listing Preparation",
              body: "Steps to prepare a South Dakota listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research South Dakota-specific issues: no income tax and reservation land issues\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• South Dakota-specific disclosure items: South Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider South Dakota market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• South Dakota-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "South Dakota Market Dynamics",
              body: "South Dakota's real estate market has unique characteristics:\n\nSouth Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns.\n\nKey factors affecting South Dakota real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nSouth Dakota market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• South Dakota-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in South Dakota: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "sd_p01q01",
              prompt: "During pre-listing due diligence for a South Dakota property, an agent discovers the property may have no income tax and reservation land issues issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential no income tax and reservation land issues issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "sd_p02",
          order: 2,
          title: "South Dakota Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute South Dakota buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "South Dakota buyer representation process:\n\n1. Initial consultation:\n• Explain South Dakota brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and South Dakota Housing Development Authority (SDHDA) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use South Dakota MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on South Dakota-specific considerations: no income tax and reservation land issues\n\n4. Making offers:\n• Explain South Dakota purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of South Dakota investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nSouth Dakota investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nSouth Dakota specific: no income tax and reservation land issues considerations for investment buyers in South Dakota."
            }
          ],
          quiz: [
            {
              id: "sd_p02q01",
              prompt: "A South Dakota investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
...

        {
          id: "sd_p03",
          order: 3,
          title: "South Dakota Closing Process & RESPA Compliance",
          week: "9-12",
          passingScore: 70,
          icon: "🎯",
          objective: "Navigate South Dakota closing procedures, RESPA compliance, and build ethical referral networks.",
          content: [
            {
              heading: "South Dakota Closing Procedures",
              body: "The South Dakota closing process:\n\n1. Pre-closing preparation:\n• Title company/attorney orders title search and issues commitment\n• Lender completes underwriting; issues clear to close\n• Closing disclosure prepared and delivered 3 business days before closing\n• Final walk-through by buyer\n\n2. Closing day:\n• Buyer and seller (or their representatives) attend closing\n• Sign all documents (deed, mortgage, closing disclosure, etc.)\n• Funds deposited and disbursed\n• Deed and mortgage recorded\n• Keys transferred\n\n3. Post-closing:\n• Confirm recording\n• Distribute closing packages to all parties\n• Upload documents to transaction management system\n• Collect commission\n\nSouth Dakota closing practice: South Dakota has no state income tax and no inheritance tax. South Dakota is a popular trust and LLC formation state due to favorable laws. South Dakota has significant Native American reservation land issues with checkerboard ownership patterns."
            },
            {
              heading: "RESPA Compliance in South Dakota",
              body: "RESPA Section 8 compliance in South Dakota real estate:\n\nILLEGAL:\n• Title company paying for agent's marketing in exchange for referrals\n• Lender sponsoring office expenses for mortgage referrals\n• Any payment in exchange for settlement service referrals\n• Marketing services agreements that function as referral fees\n\nLEGAL:\n• Genuine affiliated business arrangements (AfBA) with proper disclosure\n• Actual services for actual compensation\n• Educational co-marketing (properly structured)\n• Normal business development activities\n\nSouth Dakota specific: small markets may create pressure for informal quid pro quo arrangements. Agents must be vigilant that referral relationships don't cross RESPA lines regardless of market size."
            }
          ],
          quiz: [
            {
              id: "sd_p03q01",
              prompt: "A South Dakota title company offers to pay for a real estate agent's E&O insurance in exchange for referring all closings to the title company. Under RESPA, this arrangement is:",
              choices: [
  ...
  studyPlan: [
    { weeks: "1-2", focus: "South Dakota licensing roadmap + 116-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + no income tax and reservation land issues" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + South Dakota purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + South Dakota Housing Development Authority (SDHDA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (South Dakota additions) + South Dakota license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + South Dakota-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + South Dakota tax considerations + 1031 exchange + South Dakota state exam review + full practice exams" }
  ],

  resources: [
    { label: "South Dakota License Requirements", url: "https://www.google.com/search?q=South+Dakota+real+estate+license+requirements", category: "broker" },
    { label: "South Dakota Real Estate Commission Website", url: "https://www.google.com/search?q=South+Dakota+Real+Estate+Commission+official+website", category: "broker" },
    { label: "PSI Exams — South Dakota Exam", url: "https://www.google.com/search?q=PSI+Exams+South+Dakota+real+estate+exam", category: "broker" },
    { label: "South Dakota Housing Development Authority (SDHDA)", url: "https://www.google.com/search?q=South+Dakota+Housing+Development+Authority+(SDHDA)+South+Dakota", category: "mlo" },
    { label: "South Dakota Division of Banking", url: "https://www.google.com/search?q=South+Dakota+Division+of+Banking+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_SD;
