// ============================================================
// SC_curriculum.js — South Carolina Real Estate Study System
// South Carolina Real Estate Commission (SCREC) Broker/Salesperson License — 2026
// Sources: South Carolina Real Estate Commission (SCREC), NMLS, PSI Exams
...
const CURRICULUM_SC = {
  ...
  meta: {
    title: "SC Real Estate & MLO Licensing System 2026",
    version: "1.0",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — SC SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "SC Real Estate Salesperson/Broker",
      icon: "🌴",
      color: "#003087",
      description: "South Carolina Real Estate Commission (SCREC) — 90-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed South Carolina broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "90-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$63", source: "PSI Exams" },
        { item: "South Carolina license fee", amount: "$25", source: "South Carolina Real Estate Commission (SCREC)" },
      ...
      modules: [

        {
          id: "sc_b01",
          order: 1,
          title: "Licensing Process & South Carolina Real Estate Commission (SCREC) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete South Carolina licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates South Carolina Real Estate",
              body: "The South Carolina Real Estate Commission (SCREC) licenses and regulates real estate salespersons and brokers in South Carolina.\n\nSouth Carolina requires 90 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in South Carolina:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nSouth Carolina uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 10 hours every 2 year(s)."
            },
            {
              heading: "90-Hour Pre-License Education",
              body: "South Carolina requires 90 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• South Carolina real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in South Carolina\n• South Carolina-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nSouth Carolina-specific education note: South Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "South Carolina uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to South Carolina Real Estate Commission (SCREC)\n• Submit background check results\n• Pay license fee of $25\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "South Carolina licenses must be renewed every 2 year(s).\n\nCE requirements: 10 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• South Carolina-specific law\n• Elective topics\n\nSouth Carolina-specific requirement: South Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem."
            },
            {
              heading: "South Carolina-Specific Real Estate Law",
              body: "Key South Carolina real estate law topics:\n\nSouth Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem.\n\nAdditional South Carolina-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• South Carolina landlord-tenant law\n• Environmental regulations specific to South Carolina\n• Agency law under South Carolina statutes\n\nSouth Carolina unique aspect — attorney closings and heirs property issues: Every South Carolina real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "sc_b01q01",
              prompt: "How many hours of pre-license education does South Carolina require before taking the PSI Exams exam?",
              choices: [
                "45 hours",
                "90 hours",
                "135 hours",
              ...
              answer: 1,
              explanation: "South Carolina requires 90 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, South Carolina law, agency, contracts, finance, and other required topics."
            },
            {
              id: "sc_b01q02",
              prompt: "How often must South Carolina real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "South Carolina real estate licenses are renewed every 2 year(s). Licensees must complete 10 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "sc_b01q03",
              prompt: "South Carolina's unique real estate requirement regarding attorney closings and heirs property issues means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply South Carolina-specific rules that differ from most other states",
                "All transactions in South Carolina follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand attorney closings and heirs property issues"
              ],
              answer: 1,
              explanation: "South Carolina's unique attorney closings and heirs property issues requirement means all licensees must understand state-specific rules. South Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem."
            },
            {
              id: "sc_b01q04",
              prompt: "The PSI Exams exam used in South Carolina consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in South Carolina consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "sc_b01q05",
              prompt: "A new South Carolina licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "sc_b02",
          order: 2,
          title: "Property Ownership & South Carolina Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and South Carolina-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in South Carolina",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nSouth Carolina-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in South Carolina must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in South Carolina",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nSouth Carolina marital property rules:\nSouth Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem.\n\nHomestead protection in South Carolina provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in South Carolina",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nSouth Carolina-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in South Carolina",
              body: "South Carolina uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of South Carolina where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout South Carolina.\n\nRecording in South Carolina: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. South Carolina follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in South Carolina",
              body: "Transfer of title in South Carolina requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nSouth Carolina deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all South Carolina property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "sc_b02q01",
              prompt: "In South Carolina, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "South Carolina Real Estate Commission (SCREC) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in South Carolina are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "sc_b02q02",
              prompt: "Which deed type provides the greatest protection for a South Carolina buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in South Carolina. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "sc_b02q03",
              prompt: "Two friends purchase a South Carolina property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of South Carolina",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in South Carolina. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "sc_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in South Carolina, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in South Carolina."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including South Carolina. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "sc_b04q02",
              prompt: "A South Carolina buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
...

        {
          id: "sc_b05",
          order: 5,
          title: "Real Estate Finance & South Carolina Mortgage Programs",
          week: "5-6",
          passingScore: 75,
          icon: "💰",
          objective: "Explain South Carolina financing options, SC Housing (South Carolina State Housing Finance and Development Authority) programs, and key federal mortgage regulations.",
          content: [
            {
              heading: "SC Housing (South Carolina State Housing Finance and Development Authority) Programs",
              body: "SC Housing (South Carolina State Housing Finance and Development Authority) provides affordable homeownership programs for South Carolina residents:\n\nFirst-time homebuyer programs:\n• Below-market interest rate first mortgages\n• Income and purchase price limits apply (vary by county)\n• Must be primary residence\n\nDown payment assistance:\n• Grants or second mortgages for down payment and closing costs\n• Some programs forgivable after period of occupancy\n\nSpecial programs:\n• Veterans/military programs\n• Low-income and workforce housing programs\n• Renovation and rehabilitation loan programs\n\nMLO value in South Carolina: understanding SC Housing (South Carolina State Housing Finance and Development Authority) programs is essential as many South Carolina first-time buyers use state housing agency financing."
            },
            {
              heading: "Federal Loan Programs in South Carolina",
              body: "Federal loan programs important in South Carolina:\n\nFHA Loans:\n• 3.5% down payment (with 580+ credit score)\n• MIP (mortgage insurance premium) required\n• Property must meet FHA minimum property standards\n• Common for first-time buyers in South Carolina\n\nVA Loans:\n• 0% down for eligible veterans and active military\n• No PMI required\n• Funding fee applies (waived for disabled veterans)\n• South Carolina military presence: check local military installations\n\nUSDA Rural Development:\n• 0% down for eligible rural properties\n• Income limits apply\n• Many South Carolina rural areas may qualify\n\nConventional/Fannie Mae-Freddie Mac:\n• Dominant in South Carolina's mortgage market\n• 3-20% down depending on program\n• Conforming loan limits vary by county"
            },
            {
              heading: "Deed of Trust vs. Mortgage in South Carolina",
              body: "Most states use either mortgages or deeds of trust as the security instrument for home loans.\n\nMortgage (two-party instrument):\n• Borrower (mortgagor) and lender (mortgagee)\n• Lender must use judicial foreclosure — court process\n• Generally slower and more expensive process\n• Borrower typically has right of redemption after foreclosure sale\n\nDeed of Trust (three-party instrument):\n• Trustor (borrower), trustee (holds legal title), beneficiary (lender)\n• Allows non-judicial (trustee's sale) foreclosure — faster and cheaper\n• Redemption rights vary; many deed of trust states have no redemption period\n\nSouth Carolina uses: check South Carolina statutes to determine whether South Carolina primarily uses mortgages or deeds of trust, and what the foreclosure process entails."
            }
          ],
          quiz: [
            {
              id: "sc_b05q01",
              prompt: "The SC Housing (South Carolina State Housing Finance and Development Authority) provides down payment assistance to South Carolina homebuyers primarily to:",
              choices: [
              ...
              answer: 0,
              explanation: "SC Housing (South Carolina State Housing Finance and Development Authority) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in South Carolina."
            },
            {
              id: "sc_b05q02",
              prompt: "A South Carolina veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "sc_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in South Carolina?",
              choices: [
...

        {
          id: "sc_b07",
          order: 7,
          title: "Fair Housing & South Carolina Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and South Carolina-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "South Carolina Fair Housing Protections",
              body: "South Carolina may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in South Carolina may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck South Carolina state statutes for current protected classes under South Carolina fair housing law.\n\nSouth Carolina enforcement: File complaints with South Carolina Real Estate Commission (SCREC) and/or HUD within applicable time limits. South Carolina Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "sc_b08",
          order: 8,
          title: "Property Management & South Carolina Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply South Carolina landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "South Carolina Landlord-Tenant Basics",
              body: "South Carolina landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey South Carolina rules:\n• Security deposit: South Carolina sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: South Carolina requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in South Carolina:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in South Carolina",
              body: "Property managers in South Carolina generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck South Carolina statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nSouth Carolina property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "sc_b08q01",
              prompt: "A South Carolina landlord collects a security deposit from a tenant. Under South Carolina landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in South Carolina must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. South Carolina has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "sc_b10",
          order: 10,
          title: "South Carolina License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply South Carolina license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "South Carolina License Law — Key Provisions",
              body: "South Carolina real estate licensees must comply with:\n\nSouth Carolina Real Estate Commission (SCREC) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nSouth Carolina specific: South Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem."
            },
            {
              heading: "South Carolina Real Estate Recovery Fund",
              body: "South Carolina maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of South Carolina's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current South Carolina limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in South Carolina\n\nSouth Carolina trust account rules:\n• Client funds must be deposited promptly (check South Carolina specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to South Carolina Real Estate Commission (SCREC) audit at any time"
            }
          ],
          quiz: [
            {
              id: "sc_b10q01",
              prompt: "A South Carolina broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of South Carolina's license law and can result in license suspension or revocation."
            },
            {
              id: "sc_b10q02",
              prompt: "The South Carolina Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "sc_b11q02",
              prompt: "A South Carolina investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, South Carolina state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a South Carolina rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) South Carolina state income tax on the gain (if South Carolina has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "sc_b12",
          order: 12,
          title: "South Carolina State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review South Carolina-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "South Carolina State Exam Key Topics",
              body: "South Carolina state exam will focus on:\n\n1. South Carolina license law — South Carolina Real Estate Commission (SCREC) rules and procedures\n2. South Carolina agency law — specific state requirements\n3. South Carolina contract forms and requirements\n4. South Carolina disclosure laws\n5. South Carolina property tax system\n6. South Carolina closing procedures\n7. South Carolina-specific restrictions and regulations\n8. South Carolina fair housing additions\n9. South Carolina landlord-tenant law\n10. South Carolina environmental law\n\nSouth Carolina unique state exam emphasis: South Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem.\n\nStudy strategy:\n• Review South Carolina Real Estate Commission (SCREC) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on South Carolina-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "sc_b12q01",
              prompt: "Which South Carolina licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
                "The National Association of Realtors (NAR)",
                "The South Carolina Real Estate Commission (SCREC)",
                "The federal Department of Housing and Urban Development (HUD)",
                "The local Multiple Listing Service (MLS)"
              ],
              answer: 1,
              explanation: "Only the South Carolina Real Estate Commission (SCREC) has the legal authority to suspend or revoke a South Carolina real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "sc_b12q02",
              prompt: "A South Carolina licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "SC MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + South Carolina Board of Financial Institutions state requirements",
      requirements: [
        ...
        "Sponsored by a South Carolina-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "South Carolina state license fee", amount: "$150–$300", source: "South Carolina Board of Financial Institutions" },
      ...
      modules: [
        {
          id: "sc_m01",
          order: 1,
          title: "SAFE Act & South Carolina MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, South Carolina Board of Financial Institutions requirements, and SC Housing (South Carolina State Housing Finance and Development Authority) programs.",
          content: [
            {
              heading: "South Carolina MLO Regulation — South Carolina Board of Financial Institutions",
              body: "South Carolina MLOs are regulated by the South Carolina Board of Financial Institutions through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in South Carolina must hold an active NMLS MLO license with a South Carolina state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for South Carolina state endorsement through NMLS\n6. Obtain sponsorship from South Carolina-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "SC Housing (South Carolina State Housing Finance and Development Authority) Programs",
              body: "SC Housing (South Carolina State Housing Finance and Development Authority) provides mortgage programs for South Carolina homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in South Carolina:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural South Carolina areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing South Carolina's state housing agency programs differentiates South Carolina MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "sc_m01q01",
              prompt: "Which agency regulates South Carolina MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "South Carolina MLO licenses are regulated by the South Carolina Board of Financial Institutions. Real estate brokers and salespersons are regulated by the South Carolina Real Estate Commission (SCREC). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "sc_m01q02",
              prompt: "An MLO in South Carolina must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "SC Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "South Carolina real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "sc_p01",
          order: 1,
          title: "South Carolina Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master South Carolina listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "South Carolina Pre-Listing Preparation",
              body: "Steps to prepare a South Carolina listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research South Carolina-specific issues: attorney closings and heirs property issues\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• South Carolina-specific disclosure items: South Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider South Carolina market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• South Carolina-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "South Carolina Market Dynamics",
              body: "South Carolina's real estate market has unique characteristics:\n\nSouth Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem.\n\nKey factors affecting South Carolina real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nSouth Carolina market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• South Carolina-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in South Carolina: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "sc_p01q01",
              prompt: "During pre-listing due diligence for a South Carolina property, an agent discovers the property may have attorney closings and heirs property issues issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential attorney closings and heirs property issues issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "sc_p02",
          order: 2,
          title: "South Carolina Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute South Carolina buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "South Carolina buyer representation process:\n\n1. Initial consultation:\n• Explain South Carolina brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and SC Housing (South Carolina State Housing Finance and Development Authority) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use South Carolina MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on South Carolina-specific considerations: attorney closings and heirs property issues\n\n4. Making offers:\n• Explain South Carolina purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of South Carolina investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nSouth Carolina investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nSouth Carolina specific: attorney closings and heirs property issues considerations for investment buyers in South Carolina."
            }
          ],
          quiz: [
            {
              id: "sc_p02q01",
              prompt: "A South Carolina investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
...

        {
          id: "sc_p03",
          order: 3,
          title: "South Carolina Closing Process & RESPA Compliance",
          week: "9-12",
          passingScore: 70,
          icon: "🎯",
          objective: "Navigate South Carolina closing procedures, RESPA compliance, and build ethical referral networks.",
          content: [
            {
              heading: "South Carolina Closing Procedures",
              body: "The South Carolina closing process:\n\n1. Pre-closing preparation:\n• Title company/attorney orders title search and issues commitment\n• Lender completes underwriting; issues clear to close\n• Closing disclosure prepared and delivered 3 business days before closing\n• Final walk-through by buyer\n\n2. Closing day:\n• Buyer and seller (or their representatives) attend closing\n• Sign all documents (deed, mortgage, closing disclosure, etc.)\n• Funds deposited and disbursed\n• Deed and mortgage recorded\n• Keys transferred\n\n3. Post-closing:\n• Confirm recording\n• Distribute closing packages to all parties\n• Upload documents to transaction management system\n• Collect commission\n\nSouth Carolina closing practice: South Carolina requires attorneys to conduct all real estate closings. South Carolina has unique Gullah Geechee land ownership issues along the coast, with heirs' property (tenancy in common without clear title) being a significant problem."
            },
            {
              heading: "RESPA Compliance in South Carolina",
              body: "RESPA Section 8 compliance in South Carolina real estate:\n\nILLEGAL:\n• Title company paying for agent's marketing in exchange for referrals\n• Lender sponsoring office expenses for mortgage referrals\n• Any payment in exchange for settlement service referrals\n• Marketing services agreements that function as referral fees\n\nLEGAL:\n• Genuine affiliated business arrangements (AfBA) with proper disclosure\n• Actual services for actual compensation\n• Educational co-marketing (properly structured)\n• Normal business development activities\n\nSouth Carolina specific: small markets may create pressure for informal quid pro quo arrangements. Agents must be vigilant that referral relationships don't cross RESPA lines regardless of market size."
            }
          ],
          quiz: [
            {
              id: "sc_p03q01",
              prompt: "A South Carolina title company offers to pay for a real estate agent's E&O insurance in exchange for referring all closings to the title company. Under RESPA, this arrangement is:",
              choices: [
  ...
  studyPlan: [
    { weeks: "1-2", focus: "South Carolina licensing roadmap + 90-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + attorney closings and heirs property issues" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + South Carolina purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + SC Housing (South Carolina State Housing Finance and Development Authority) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (South Carolina additions) + South Carolina license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + South Carolina-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + South Carolina tax considerations + 1031 exchange + South Carolina state exam review + full practice exams" }
  ],

  resources: [
    { label: "South Carolina License Requirements", url: "https://www.google.com/search?q=South+Carolina+real+estate+license+requirements", category: "broker" },
    { label: "South Carolina Real Estate Commission (SCREC) Website", url: "https://www.google.com/search?q=South+Carolina+Real+Estate+Commission+(SCREC)+official+website", category: "broker" },
    { label: "PSI Exams — South Carolina Exam", url: "https://www.google.com/search?q=PSI+Exams+South+Carolina+real+estate+exam", category: "broker" },
    { label: "SC Housing (South Carolina State Housing Finance and Development Authority)", url: "https://www.google.com/search?q=SC+Housing+(South+Carolina+State+Housing+Finance+and+Development+Authority)+South+Carolina", category: "mlo" },
    { label: "South Carolina Board of Financial Institutions", url: "https://www.google.com/search?q=South+Carolina+Board+of+Financial+Institutions+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_SC;
