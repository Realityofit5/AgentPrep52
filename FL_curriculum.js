// ============================================================
// FL_curriculum.js — Florida Real Estate Study System
// Florida Department of Business and Professional Regulation (DBPR) Broker/Salesperson License — 2026
// Sources: Florida Department of Business and Professional Regulation (DBPR), NMLS, Pearson VUE
...
const CURRICULUM_FL = {
  ...
  meta: {
    title: "FL Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Florida",
    stateCode: "FL",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — FL SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "FL Real Estate Salesperson/Broker",
      icon: "🌴",
      color: "#F37021",
      description: "Florida Department of Business and Professional Regulation (DBPR) — 63-hour pre-license + Pearson VUE exam + state-specific requirements",
      requirements: [
        "18+ years old",
      ...
      fees: [
        { item: "63-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "Pearson VUE exam fee", amount: "$36.75", source: "Pearson VUE" },
        { item: "Florida license fee", amount: "$89", source: "Florida Department of Business and Professional Regulation (DBPR)" },
      ...
      modules: [

        {
          id: "fl_b01",
          order: 1,
          title: "Licensing Process & Florida Department of Business and Professional Regulation (DBPR) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Florida licensing process including pre-license education, Pearson VUE exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Florida Real Estate",
              body: "The Florida Department of Business and Professional Regulation (DBPR) licenses and regulates real estate salespersons and brokers in Florida.\n\nFlorida requires 63 hours of pre-license education before taking the Pearson VUE licensing exam.\n\nLicense types in Florida:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nFlorida uses Pearson VUE for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 14 hours every 2 year(s)."
            },
            {
              heading: "63-Hour Pre-License Education",
              body: "Florida requires 63 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Florida real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Florida\n• Florida-specific statutes and regulations\n\nAfter completing the course, candidates must pass the Pearson VUE exam and apply for their license.\n\nFlorida-specific education note: Florida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Florida uses Pearson VUE for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Florida Department of Business and Professional Regulation (DBPR)\n• Submit background check results\n• Pay license fee of $89\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Florida licenses must be renewed every 2 year(s).\n\nCE requirements: 14 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Florida-specific law\n• Elective topics\n\nFlorida-specific requirement: Florida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases."
            },
            {
              heading: "Florida-Specific Real Estate Law",
              body: "Key Florida real estate law topics:\n\nFlorida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases.\n\nAdditional Florida-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Florida landlord-tenant law\n• Environmental regulations specific to Florida\n• Agency law under Florida statutes\n\nFlorida unique aspect — condominium law and disclosure: Every Florida real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "fl_b01q01",
              prompt: "How many hours of pre-license education does Florida require before taking the Pearson VUE exam?",
              choices: [
                "31 hours",
                "63 hours",
                "94 hours",
              ...
              answer: 1,
              explanation: "Florida requires 63 hours of approved pre-license education before candidates can take the Pearson VUE licensing exam. This education covers real estate principles, Florida law, agency, contracts, finance, and other required topics."
            },
            {
              id: "fl_b01q02",
              prompt: "How often must Florida real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Florida real estate licenses are renewed every 2 year(s). Licensees must complete 14 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "fl_b01q03",
              prompt: "Florida's unique real estate requirement regarding condominium law and disclosure means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Florida-specific rules that differ from most other states",
                "All transactions in Florida follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand condominium law and disclosure"
              ],
              answer: 1,
              explanation: "Florida's unique condominium law and disclosure requirement means all licensees must understand state-specific rules. Florida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases."
            },
            {
              id: "fl_b01q04",
              prompt: "The Pearson VUE exam used in Florida consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The Pearson VUE exam in Florida consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "fl_b01q05",
              prompt: "A new Florida licensee fails the national section of the Pearson VUE exam but passes the state section. They must:",
              choices: [
...

        {
          id: "fl_b02",
          order: 2,
          title: "Property Ownership & Florida Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Florida-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Florida",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nFlorida-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Florida must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Florida",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nFlorida marital property rules:\nFlorida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases.\n\nHomestead protection in Florida provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Florida",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nFlorida-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Florida",
              body: "Florida uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Florida where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Florida.\n\nRecording in Florida: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Florida follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Florida",
              body: "Transfer of title in Florida requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nFlorida deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Florida property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "fl_b02q01",
              prompt: "In Florida, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Florida Department of Business and Professional Regulation (DBPR) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Florida are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "fl_b02q02",
              prompt: "Which deed type provides the greatest protection for a Florida buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Florida. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "fl_b02q03",
              prompt: "Two friends purchase a Florida property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Florida",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Florida. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "fl_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Florida, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Florida."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Florida. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "fl_b04q02",
              prompt: "A Florida buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Florida Housing Finance Corporation down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Florida."
            },
            {
              id: "fl_b05q02",
              prompt: "A Florida veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "fl_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Florida?",
              choices: [
...

        {
          id: "fl_b07",
          order: 7,
          title: "Fair Housing & Florida Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Florida-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Florida Fair Housing Protections",
              body: "Florida may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Florida may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Florida state statutes for current protected classes under Florida fair housing law.\n\nFlorida enforcement: File complaints with Florida Department of Business and Professional Regulation (DBPR) and/or HUD within applicable time limits. Florida Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "fl_b08",
          order: 8,
          title: "Property Management & Florida Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Florida landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Florida Landlord-Tenant Basics",
              body: "Florida landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Florida rules:\n• Security deposit: Florida sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Florida requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Florida:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Florida",
              body: "Property managers in Florida generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Florida statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nFlorida property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "fl_b08q01",
              prompt: "A Florida landlord collects a security deposit from a tenant. Under Florida landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Florida must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Florida has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "fl_b10",
          order: 10,
          title: "Florida License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Florida license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Florida License Law — Key Provisions",
              body: "Florida real estate licensees must comply with:\n\nFlorida Department of Business and Professional Regulation (DBPR) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nFlorida specific: Florida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases."
            },
            {
              heading: "Florida Real Estate Recovery Fund",
              body: "Florida maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Florida's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Florida limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Florida\n\nFlorida trust account rules:\n• Client funds must be deposited promptly (check Florida specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Florida Department of Business and Professional Regulation (DBPR) audit at any time"
            }
          ],
          quiz: [
            {
              id: "fl_b10q01",
              prompt: "A Florida broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Florida's license law and can result in license suspension or revocation."
            },
            {
              id: "fl_b10q02",
              prompt: "The Florida Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "fl_b11q02",
              prompt: "A Florida investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Florida state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Florida rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Florida state income tax on the gain (if Florida has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "fl_b12",
          order: 12,
          title: "Florida State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Florida-specific exam topics, practice state exam questions, and prepare for the Pearson VUE exam.",
          content: [
            {
              heading: "Florida State Exam Key Topics",
              body: "Florida state exam will focus on:\n\n1. Florida license law — Florida Department of Business and Professional Regulation (DBPR) rules and procedures\n2. Florida agency law — specific state requirements\n3. Florida contract forms and requirements\n4. Florida disclosure laws\n5. Florida property tax system\n6. Florida closing procedures\n7. Florida-specific restrictions and regulations\n8. Florida fair housing additions\n9. Florida landlord-tenant law\n10. Florida environmental law\n\nFlorida unique state exam emphasis: Florida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases.\n\nStudy strategy:\n• Review Florida Department of Business and Professional Regulation (DBPR) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Florida-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "fl_b12q01",
              prompt: "Which Florida licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Florida Department of Business and Professional Regulation (DBPR) has the legal authority to suspend or revoke a Florida real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "fl_b12q02",
              prompt: "A Florida licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "FL MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Florida Office of Financial Regulation state requirements",
      requirements: [
        ...
        "Sponsored by a Florida-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Florida state license fee", amount: "$150–$300", source: "Florida Office of Financial Regulation" },
      ...
      modules: [
        {
          id: "fl_m01",
          order: 1,
          title: "SAFE Act & Florida MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Florida Office of Financial Regulation requirements, and Florida Housing Finance Corporation programs.",
          content: [
            {
              heading: "Florida MLO Regulation — Florida Office of Financial Regulation",
              body: "Florida MLOs are regulated by the Florida Office of Financial Regulation through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Florida must hold an active NMLS MLO license with a Florida state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Florida state endorsement through NMLS\n6. Obtain sponsorship from Florida-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Florida Housing Finance Corporation Programs",
              body: "Florida Housing Finance Corporation provides mortgage programs for Florida homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Florida:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Florida areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Florida's state housing agency programs differentiates Florida MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "fl_m01q01",
              prompt: "Which agency regulates Florida MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Florida MLO licenses are regulated by the Florida Office of Financial Regulation. Real estate brokers and salespersons are regulated by the Florida Department of Business and Professional Regulation (DBPR). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "fl_m01q02",
              prompt: "An MLO in Florida must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "FL Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Florida real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "fl_p01",
          order: 1,
          title: "Florida Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Florida listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Florida Pre-Listing Preparation",
              body: "Steps to prepare a Florida listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Florida-specific issues: condominium law and disclosure\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Florida-specific disclosure items: Florida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Florida market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Florida-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Florida Market Dynamics",
              body: "Florida's real estate market has unique characteristics:\n\nFlorida has extensive condominium law (Chapter 718, F.S.) including mandatory HOA/condo disclosure documents and the 3-day right of rescission for condo purchases.\n\nKey factors affecting Florida real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nFlorida market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Florida-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Florida: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "fl_p01q01",
              prompt: "During pre-listing due diligence for a Florida property, an agent discovers the property may have condominium law and disclosure issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential condominium law and disclosure issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Florida licensing roadmap + 63-hour pre-license + Pearson VUE exam structure + property ownership + concurrent ownership + condominium law and disclosure" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Florida purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Florida Housing Finance Corporation programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Florida additions) + Florida license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Florida-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Florida tax considerations + 1031 exchange + Florida state exam review + full practice exams" }
  ],

  resources: [
    { label: "Florida License Requirements", url: "https://www.google.com/search?q=Florida+real+estate+license+requirements", category: "broker" },
    { label: "Florida Department of Business and Professional Regulation (DBPR) Website", url: "https://www.google.com/search?q=Florida+Department+of+Business+and+Professional+Regulation+(DBPR)+official+website", category: "broker" },
    { label: "Pearson VUE — Florida Exam", url: "https://www.google.com/search?q=Pearson+VUE+Florida+real+estate+exam", category: "broker" },
    { label: "Florida Housing Finance Corporation", url: "https://www.google.com/search?q=Florida+Housing+Finance+Corporation+Florida", category: "mlo" },
    { label: "Florida Office of Financial Regulation", url: "https://www.google.com/search?q=Florida+Office+of+Financial+Regulation+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_FL;
