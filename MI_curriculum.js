// ============================================================
// MI_curriculum.js — Michigan Real Estate Study System
// Michigan Department of Licensing and Regulatory Affairs (LARA) Broker/Salesperson License — 2026
// Sources: Michigan Department of Licensing and Regulatory Affairs (LARA), NMLS, PSI Exams
...
const CURRICULUM_MI = {
  ...
  meta: {
    title: "MI Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Michigan",
    stateCode: "MI",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — MI SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "MI Real Estate Salesperson/Broker",
      icon: "🚗",
      color: "#003087",
      description: "Michigan Department of Licensing and Regulatory Affairs (LARA) — 40-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Michigan broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "40-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$79", source: "PSI Exams" },
        { item: "Michigan license fee", amount: "$88", source: "Michigan Department of Licensing and Regulatory Affairs (LARA)" },
      ...
      modules: [

        {
          id: "mi_b01",
          order: 1,
          title: "Licensing Process & Michigan Department of Licensing and Regulatory Affairs (LARA) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Michigan licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Michigan Real Estate",
              body: "The Michigan Department of Licensing and Regulatory Affairs (LARA) licenses and regulates real estate salespersons and brokers in Michigan.\n\nMichigan requires 40 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Michigan:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nMichigan uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 18 hours every 3 year(s)."
            },
            {
              heading: "40-Hour Pre-License Education",
              body: "Michigan requires 40 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Michigan real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Michigan\n• Michigan-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nMichigan-specific education note: Michigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Michigan uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Michigan Department of Licensing and Regulatory Affairs (LARA)\n• Submit background check results\n• Pay license fee of $88\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Michigan licenses must be renewed every 3 year(s).\n\nCE requirements: 18 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Michigan-specific law\n• Elective topics\n\nMichigan-specific requirement: Michigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes."
            },
            {
              heading: "Michigan-Specific Real Estate Law",
              body: "Key Michigan real estate law topics:\n\nMichigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes.\n\nAdditional Michigan-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Michigan landlord-tenant law\n• Environmental regulations specific to Michigan\n• Agency law under Michigan statutes\n\nMichigan unique aspect — Great Lakes waterfront property and seller disclosure: Every Michigan real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "mi_b01q01",
              prompt: "How many hours of pre-license education does Michigan require before taking the PSI Exams exam?",
              choices: [
                "20 hours",
                "40 hours",
                "60 hours",
              ...
              answer: 1,
              explanation: "Michigan requires 40 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Michigan law, agency, contracts, finance, and other required topics."
            },
            {
              id: "mi_b01q02",
              prompt: "How often must Michigan real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 3 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Michigan real estate licenses are renewed every 3 year(s). Licensees must complete 18 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "mi_b01q03",
              prompt: "Michigan's unique real estate requirement regarding Great Lakes waterfront property and seller disclosure means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Michigan-specific rules that differ from most other states",
                "All transactions in Michigan follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand Great Lakes waterfront property and seller disclosure"
              ],
              answer: 1,
              explanation: "Michigan's unique Great Lakes waterfront property and seller disclosure requirement means all licensees must understand state-specific rules. Michigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes."
            },
            {
              id: "mi_b01q04",
              prompt: "The PSI Exams exam used in Michigan consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Michigan consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "mi_b01q05",
              prompt: "A new Michigan licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "mi_b02",
          order: 2,
          title: "Property Ownership & Michigan Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Michigan-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Michigan",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nMichigan-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Michigan must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Michigan",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nMichigan marital property rules:\nMichigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes.\n\nHomestead protection in Michigan provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Michigan",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nMichigan-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Michigan",
              body: "Michigan uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Michigan where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Michigan.\n\nRecording in Michigan: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Michigan follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Michigan",
              body: "Transfer of title in Michigan requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nMichigan deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Michigan property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "mi_b02q01",
              prompt: "In Michigan, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Michigan Department of Licensing and Regulatory Affairs (LARA) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Michigan are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "mi_b02q02",
              prompt: "Which deed type provides the greatest protection for a Michigan buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Michigan. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "mi_b02q03",
              prompt: "Two friends purchase a Michigan property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Michigan. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "mi_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Michigan, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Michigan."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Michigan. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "mi_b04q02",
              prompt: "A Michigan buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Michigan State Housing Development Authority (MSHDA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Michigan."
            },
            {
              id: "mi_b05q02",
              prompt: "A Michigan veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "mi_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Michigan?",
              choices: [
...

        {
          id: "mi_b07",
          order: 7,
          title: "Fair Housing & Michigan Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Michigan-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Michigan Fair Housing Protections",
              body: "Michigan may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Michigan may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Michigan state statutes for current protected classes under Michigan fair housing law.\n\nMichigan enforcement: File complaints with Michigan Department of Licensing and Regulatory Affairs (LARA) and/or HUD within applicable time limits. Michigan Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "mi_b08",
          order: 8,
          title: "Property Management & Michigan Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Michigan landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Michigan Landlord-Tenant Basics",
              body: "Michigan landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Michigan rules:\n• Security deposit: Michigan sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Michigan requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Michigan:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Michigan",
              body: "Property managers in Michigan generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Michigan statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nMichigan property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "mi_b08q01",
              prompt: "A Michigan landlord collects a security deposit from a tenant. Under Michigan landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Michigan must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Michigan has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "mi_b10",
          order: 10,
          title: "Michigan License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Michigan license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Michigan License Law — Key Provisions",
              body: "Michigan real estate licensees must comply with:\n\nMichigan Department of Licensing and Regulatory Affairs (LARA) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nMichigan specific: Michigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes."
            },
            {
              heading: "Michigan Real Estate Recovery Fund",
              body: "Michigan maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Michigan's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Michigan limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Michigan\n\nMichigan trust account rules:\n• Client funds must be deposited promptly (check Michigan specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Michigan Department of Licensing and Regulatory Affairs (LARA) audit at any time"
            }
          ],
          quiz: [
            {
              id: "mi_b10q01",
              prompt: "A Michigan broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Michigan's license law and can result in license suspension or revocation."
            },
            {
              id: "mi_b10q02",
              prompt: "The Michigan Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "mi_b11q02",
              prompt: "A Michigan investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Michigan state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Michigan rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Michigan state income tax on the gain (if Michigan has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "mi_b12",
          order: 12,
          title: "Michigan State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Michigan-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Michigan State Exam Key Topics",
              body: "Michigan state exam will focus on:\n\n1. Michigan license law — Michigan Department of Licensing and Regulatory Affairs (LARA) rules and procedures\n2. Michigan agency law — specific state requirements\n3. Michigan contract forms and requirements\n4. Michigan disclosure laws\n5. Michigan property tax system\n6. Michigan closing procedures\n7. Michigan-specific restrictions and regulations\n8. Michigan fair housing additions\n9. Michigan landlord-tenant law\n10. Michigan environmental law\n\nMichigan unique state exam emphasis: Michigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes.\n\nStudy strategy:\n• Review Michigan Department of Licensing and Regulatory Affairs (LARA) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Michigan-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "mi_b12q01",
              prompt: "Which Michigan licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Michigan Department of Licensing and Regulatory Affairs (LARA) has the legal authority to suspend or revoke a Michigan real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "mi_b12q02",
              prompt: "A Michigan licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "MI MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Michigan Department of Insurance and Financial Services state requirements",
      requirements: [
        ...
        "Sponsored by a Michigan-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Michigan state license fee", amount: "$150–$300", source: "Michigan Department of Insurance and Financial Services" },
      ...
      modules: [
        {
          id: "mi_m01",
          order: 1,
          title: "SAFE Act & Michigan MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Michigan Department of Insurance and Financial Services requirements, and Michigan State Housing Development Authority (MSHDA) programs.",
          content: [
            {
              heading: "Michigan MLO Regulation — Michigan Department of Insurance and Financial Services",
              body: "Michigan MLOs are regulated by the Michigan Department of Insurance and Financial Services through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Michigan must hold an active NMLS MLO license with a Michigan state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Michigan state endorsement through NMLS\n6. Obtain sponsorship from Michigan-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Michigan State Housing Development Authority (MSHDA) Programs",
              body: "Michigan State Housing Development Authority (MSHDA) provides mortgage programs for Michigan homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Michigan:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Michigan areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Michigan's state housing agency programs differentiates Michigan MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "mi_m01q01",
              prompt: "Which agency regulates Michigan MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Michigan MLO licenses are regulated by the Michigan Department of Insurance and Financial Services. Real estate brokers and salespersons are regulated by the Michigan Department of Licensing and Regulatory Affairs (LARA). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "mi_m01q02",
              prompt: "An MLO in Michigan must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "MI Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Michigan real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "mi_p01",
          order: 1,
          title: "Michigan Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Michigan listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Michigan Pre-Listing Preparation",
              body: "Steps to prepare a Michigan listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Michigan-specific issues: Great Lakes waterfront property and seller disclosure\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Michigan-specific disclosure items: Michigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Michigan market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Michigan-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Michigan Market Dynamics",
              body: "Michigan's real estate market has unique characteristics:\n\nMichigan follows the Michigan Seller Disclosure Act requiring a Seller's Disclosure Statement for all residential property sales. Michigan has unique waterfront property regulations due to the Great Lakes.\n\nKey factors affecting Michigan real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nMichigan market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Michigan-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Michigan: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "mi_p01q01",
              prompt: "During pre-listing due diligence for a Michigan property, an agent discovers the property may have Great Lakes waterfront property and seller disclosure issues. The agent should:",
              choices: [
...

        {
          id: "mi_p02",
          order: 2,
          title: "Michigan Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute Michigan buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "Michigan buyer representation process:\n\n1. Initial consultation:\n• Explain Michigan brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and Michigan State Housing Development Authority (MSHDA) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use Michigan MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on Michigan-specific considerations: Great Lakes waterfront property and seller disclosure\n\n4. Making offers:\n• Explain Michigan purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of Michigan investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nMichigan investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nMichigan specific: Great Lakes waterfront property and seller disclosure considerations for investment buyers in Michigan."
            }
          ],
          quiz: [
            {
              id: "mi_p02q01",
              prompt: "A Michigan investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Michigan licensing roadmap + 40-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + Great Lakes waterfront property and seller disclosure" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Michigan purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Michigan State Housing Development Authority (MSHDA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Michigan additions) + Michigan license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Michigan-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Michigan tax considerations + 1031 exchange + Michigan state exam review + full practice exams" }
  ],

  resources: [
    { label: "Michigan License Requirements", url: "https://www.google.com/search?q=Michigan+real+estate+license+requirements", category: "broker" },
    { label: "Michigan Department of Licensing and Regulatory Affairs (LARA) Website", url: "https://www.google.com/search?q=Michigan+Department+of+Licensing+and+Regulatory+Affairs+(LARA)+official+website", category: "broker" },
    { label: "PSI Exams — Michigan Exam", url: "https://www.google.com/search?q=PSI+Exams+Michigan+real+estate+exam", category: "broker" },
    { label: "Michigan State Housing Development Authority (MSHDA)", url: "https://www.google.com/search?q=Michigan+State+Housing+Development+Authority+(MSHDA)+Michigan", category: "mlo" },
    { label: "Michigan Department of Insurance and Financial Services", url: "https://www.google.com/search?q=Michigan+Department+of+Insurance+and+Financial+Services+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_MI;
