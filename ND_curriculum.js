// ============================================================
// ND_curriculum.js — North Dakota Real Estate Study System
// North Dakota Real Estate Commission (NDREC) Broker/Salesperson License — 2026
// Sources: North Dakota Real Estate Commission (NDREC), NMLS, PSI Exams
...
const CURRICULUM_ND = {
  ...
  meta: {
    title: "ND Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "North Dakota",
    stateCode: "ND",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — ND SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "ND Real Estate Salesperson/Broker",
      icon: "🌾",
      color: "#003087",
      description: "North Dakota Real Estate Commission (NDREC) — 90-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed North Dakota broker",
      ...
      fees: [
        ...
        { item: "North Dakota license fee", amount: "$110", source: "North Dakota Real Estate Commission (NDREC)" },
      ...
      modules: [

        {
          id: "nd_b01",
          order: 1,
          title: "Licensing Process & North Dakota Real Estate Commission (NDREC) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete North Dakota licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates North Dakota Real Estate",
              body: "The North Dakota Real Estate Commission (NDREC) licenses and regulates real estate salespersons and brokers in North Dakota.\n\nNorth Dakota requires 90 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in North Dakota:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nNorth Dakota uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 12 hours every 2 year(s)."
            },
            {
              heading: "90-Hour Pre-License Education",
              body: "North Dakota requires 90 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• North Dakota real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in North Dakota\n• North Dakota-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nNorth Dakota-specific education note: North Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "North Dakota uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to North Dakota Real Estate Commission (NDREC)\n• Submit background check results\n• Pay license fee of $110\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "North Dakota licenses must be renewed every 2 year(s).\n\nCE requirements: 12 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• North Dakota-specific law\n• Elective topics\n\nNorth Dakota-specific requirement: North Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues."
            },
            {
              heading: "North Dakota-Specific Real Estate Law",
              body: "Key North Dakota real estate law topics:\n\nNorth Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues.\n\nAdditional North Dakota-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• North Dakota landlord-tenant law\n• Environmental regulations specific to North Dakota\n• Agency law under North Dakota statutes\n\nNorth Dakota unique aspect — community property and Bakken oil/mineral rights: Every North Dakota real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "nd_b01q01",
              prompt: "How many hours of pre-license education does North Dakota require before taking the PSI Exams exam?",
              choices: [
                "45 hours",
                "90 hours",
                "135 hours",
              ...
              answer: 1,
              explanation: "North Dakota requires 90 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, North Dakota law, agency, contracts, finance, and other required topics."
            },
            {
              id: "nd_b01q02",
              prompt: "How often must North Dakota real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "North Dakota real estate licenses are renewed every 2 year(s). Licensees must complete 12 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "nd_b01q03",
              prompt: "North Dakota's unique real estate requirement regarding community property and Bakken oil/mineral rights means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply North Dakota-specific rules that differ from most other states",
                "All transactions in North Dakota follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand community property and Bakken oil/mineral rights"
              ],
              answer: 1,
              explanation: "North Dakota's unique community property and Bakken oil/mineral rights requirement means all licensees must understand state-specific rules. North Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues."
            },
            {
              id: "nd_b01q04",
              prompt: "The PSI Exams exam used in North Dakota consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in North Dakota consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "nd_b01q05",
              prompt: "A new North Dakota licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "nd_b02",
          order: 2,
          title: "Property Ownership & North Dakota Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and North Dakota-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in North Dakota",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nNorth Dakota-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in North Dakota must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in North Dakota",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nNorth Dakota marital property rules:\nNorth Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues.\n\nHomestead protection in North Dakota provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in North Dakota",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nNorth Dakota-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in North Dakota",
              body: "North Dakota uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of North Dakota where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout North Dakota.\n\nRecording in North Dakota: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. North Dakota follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in North Dakota",
              body: "Transfer of title in North Dakota requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nNorth Dakota deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all North Dakota property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "nd_b02q01",
              prompt: "In North Dakota, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "North Dakota Real Estate Commission (NDREC) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in North Dakota are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "nd_b02q02",
              prompt: "Which deed type provides the greatest protection for a North Dakota buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in North Dakota. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "nd_b02q03",
              prompt: "Two friends purchase a North Dakota property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of North Dakota",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in North Dakota. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "nd_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in North Dakota, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in North Dakota."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including North Dakota. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "nd_b04q02",
              prompt: "A North Dakota buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
...

        {
          id: "nd_b05",
          order: 5,
          title: "Real Estate Finance & North Dakota Mortgage Programs",
          week: "5-6",
          passingScore: 75,
          icon: "💰",
          objective: "Explain North Dakota financing options, North Dakota Housing Finance Agency (NDHFA) programs, and key federal mortgage regulations.",
          content: [
            {
              heading: "North Dakota Housing Finance Agency (NDHFA) Programs",
              body: "North Dakota Housing Finance Agency (NDHFA) provides affordable homeownership programs for North Dakota residents:\n\nFirst-time homebuyer programs:\n• Below-market interest rate first mortgages\n• Income and purchase price limits apply (vary by county)\n• Must be primary residence\n\nDown payment assistance:\n• Grants or second mortgages for down payment and closing costs\n• Some programs forgivable after period of occupancy\n\nSpecial programs:\n• Veterans/military programs\n• Low-income and workforce housing programs\n• Renovation and rehabilitation loan programs\n\nMLO value in North Dakota: understanding North Dakota Housing Finance Agency (NDHFA) programs is essential as many North Dakota first-time buyers use state housing agency financing."
            },
            {
              heading: "Federal Loan Programs in North Dakota",
              body: "Federal loan programs important in North Dakota:\n\nFHA Loans:\n• 3.5% down payment (with 580+ credit score)\n• MIP (mortgage insurance premium) required\n• Property must meet FHA minimum property standards\n• Common for first-time buyers in North Dakota\n\nVA Loans:\n• 0% down for eligible veterans and active military\n• No PMI required\n• Funding fee applies (waived for disabled veterans)\n• North Dakota military presence: check local military installations\n\nUSDA Rural Development:\n• 0% down for eligible rural properties\n• Income limits apply\n• Many North Dakota rural areas may qualify\n\nConventional/Fannie Mae-Freddie Mac:\n• Dominant in North Dakota's mortgage market\n• 3-20% down depending on program\n• Conforming loan limits vary by county"
            },
            {
              heading: "Deed of Trust vs. Mortgage in North Dakota",
              body: "Most states use either mortgages or deeds of trust as the security instrument for home loans.\n\nMortgage (two-party instrument):\n• Borrower (mortgagor) and lender (mortgagee)\n• Lender must use judicial foreclosure — court process\n• Generally slower and more expensive process\n• Borrower typically has right of redemption after foreclosure sale\n\nDeed of Trust (three-party instrument):\n• Trustor (borrower), trustee (holds legal title), beneficiary (lender)\n• Allows non-judicial (trustee's sale) foreclosure — faster and cheaper\n• Redemption rights vary; many deed of trust states have no redemption period\n\nNorth Dakota uses: check North Dakota statutes to determine whether North Dakota primarily uses mortgages or deeds of trust, and what the foreclosure process entails."
            }
          ],
          quiz: [
            {
              id: "nd_b05q01",
              prompt: "The North Dakota Housing Finance Agency (NDHFA) provides down payment assistance to North Dakota homebuyers primarily to:",
              choices: [
              ...
              answer: 0,
              explanation: "North Dakota Housing Finance Agency (NDHFA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in North Dakota."
            },
            {
              id: "nd_b05q02",
              prompt: "A North Dakota veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "nd_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in North Dakota?",
              choices: [
...

        {
          id: "nd_b07",
          order: 7,
          title: "Fair Housing & North Dakota Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and North Dakota-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "North Dakota Fair Housing Protections",
              body: "North Dakota may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in North Dakota may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck North Dakota state statutes for current protected classes under North Dakota fair housing law.\n\nNorth Dakota enforcement: File complaints with North Dakota Real Estate Commission (NDREC) and/or HUD within applicable time limits. North Dakota Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "nd_b08",
          order: 8,
          title: "Property Management & North Dakota Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply North Dakota landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "North Dakota Landlord-Tenant Basics",
              body: "North Dakota landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey North Dakota rules:\n• Security deposit: North Dakota sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: North Dakota requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in North Dakota:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in North Dakota",
              body: "Property managers in North Dakota generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck North Dakota statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nNorth Dakota property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "nd_b08q01",
              prompt: "A North Dakota landlord collects a security deposit from a tenant. Under North Dakota landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in North Dakota must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. North Dakota has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "nd_b10",
          order: 10,
          title: "North Dakota License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply North Dakota license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "North Dakota License Law — Key Provisions",
              body: "North Dakota real estate licensees must comply with:\n\nNorth Dakota Real Estate Commission (NDREC) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nNorth Dakota specific: North Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues."
            },
            {
              heading: "North Dakota Real Estate Recovery Fund",
              body: "North Dakota maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of North Dakota's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current North Dakota limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in North Dakota\n\nNorth Dakota trust account rules:\n• Client funds must be deposited promptly (check North Dakota specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to North Dakota Real Estate Commission (NDREC) audit at any time"
            }
          ],
          quiz: [
            {
              id: "nd_b10q01",
              prompt: "A North Dakota broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of North Dakota's license law and can result in license suspension or revocation."
            },
            {
              id: "nd_b10q02",
              prompt: "The North Dakota Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "nd_b11q02",
              prompt: "A North Dakota investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, North Dakota state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a North Dakota rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) North Dakota state income tax on the gain (if North Dakota has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "nd_b12",
          order: 12,
          title: "North Dakota State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review North Dakota-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "North Dakota State Exam Key Topics",
              body: "North Dakota state exam will focus on:\n\n1. North Dakota license law — North Dakota Real Estate Commission (NDREC) rules and procedures\n2. North Dakota agency law — specific state requirements\n3. North Dakota contract forms and requirements\n4. North Dakota disclosure laws\n5. North Dakota property tax system\n6. North Dakota closing procedures\n7. North Dakota-specific restrictions and regulations\n8. North Dakota fair housing additions\n9. North Dakota landlord-tenant law\n10. North Dakota environmental law\n\nNorth Dakota unique state exam emphasis: North Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues.\n\nStudy strategy:\n• Review North Dakota Real Estate Commission (NDREC) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on North Dakota-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "nd_b12q01",
              prompt: "Which North Dakota licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the North Dakota Real Estate Commission (NDREC) has the legal authority to suspend or revoke a North Dakota real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "nd_b12q02",
              prompt: "A North Dakota licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "ND MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + North Dakota Department of Financial Institutions state requirements",
      requirements: [
        ...
        "Sponsored by a North Dakota-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "North Dakota state license fee", amount: "$150–$300", source: "North Dakota Department of Financial Institutions" },
      ...
      modules: [
        {
          id: "nd_m01",
          order: 1,
          title: "SAFE Act & North Dakota MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, North Dakota Department of Financial Institutions requirements, and North Dakota Housing Finance Agency (NDHFA) programs.",
          content: [
            {
              heading: "North Dakota MLO Regulation — North Dakota Department of Financial Institutions",
              body: "North Dakota MLOs are regulated by the North Dakota Department of Financial Institutions through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in North Dakota must hold an active NMLS MLO license with a North Dakota state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for North Dakota state endorsement through NMLS\n6. Obtain sponsorship from North Dakota-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "North Dakota Housing Finance Agency (NDHFA) Programs",
              body: "North Dakota Housing Finance Agency (NDHFA) provides mortgage programs for North Dakota homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in North Dakota:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural North Dakota areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing North Dakota's state housing agency programs differentiates North Dakota MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "nd_m01q01",
              prompt: "Which agency regulates North Dakota MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "North Dakota MLO licenses are regulated by the North Dakota Department of Financial Institutions. Real estate brokers and salespersons are regulated by the North Dakota Real Estate Commission (NDREC). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "nd_m01q02",
              prompt: "An MLO in North Dakota must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "ND Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "North Dakota real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
        "Complete broker pre-license education",
        "Pass PSI Exams exam",
        "Active North Dakota license",
      ...
      modules: [
        {
          id: "nd_p01",
          order: 1,
          title: "North Dakota Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master North Dakota listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "North Dakota Pre-Listing Preparation",
              body: "Steps to prepare a North Dakota listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research North Dakota-specific issues: community property and Bakken oil/mineral rights\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• North Dakota-specific disclosure items: North Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider North Dakota market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• North Dakota-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "North Dakota Market Dynamics",
              body: "North Dakota's real estate market has unique characteristics:\n\nNorth Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues.\n\nKey factors affecting North Dakota real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nNorth Dakota market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• North Dakota-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in North Dakota: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "nd_p01q01",
              prompt: "During pre-listing due diligence for a North Dakota property, an agent discovers the property may have community property and Bakken oil/mineral rights issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential community property and Bakken oil/mineral rights issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "nd_p02",
          order: 2,
          title: "North Dakota Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute North Dakota buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "North Dakota buyer representation process:\n\n1. Initial consultation:\n• Explain North Dakota brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and North Dakota Housing Finance Agency (NDHFA) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use North Dakota MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on North Dakota-specific considerations: community property and Bakken oil/mineral rights\n\n4. Making offers:\n• Explain North Dakota purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of North Dakota investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nNorth Dakota investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nNorth Dakota specific: community property and Bakken oil/mineral rights considerations for investment buyers in North Dakota."
            }
          ],
          quiz: [
            {
              id: "nd_p02q01",
              prompt: "A North Dakota investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
...

        {
          id: "nd_p03",
          order: 3,
          title: "North Dakota Closing Process & RESPA Compliance",
          week: "9-12",
          passingScore: 70,
          icon: "🎯",
          objective: "Navigate North Dakota closing procedures, RESPA compliance, and build ethical referral networks.",
          content: [
            {
              heading: "North Dakota Closing Procedures",
              body: "The North Dakota closing process:\n\n1. Pre-closing preparation:\n• Title company/attorney orders title search and issues commitment\n• Lender completes underwriting; issues clear to close\n• Closing disclosure prepared and delivered 3 business days before closing\n• Final walk-through by buyer\n\n2. Closing day:\n• Buyer and seller (or their representatives) attend closing\n• Sign all documents (deed, mortgage, closing disclosure, etc.)\n• Funds deposited and disbursed\n• Deed and mortgage recorded\n• Keys transferred\n\n3. Post-closing:\n• Confirm recording\n• Distribute closing packages to all parties\n• Upload documents to transaction management system\n• Collect commission\n\nNorth Dakota closing practice: North Dakota follows community property law. North Dakota has experienced significant oil boom real estate activity in the Bakken Formation region (Williston Basin), creating unique mineral rights and surface rights issues."
            },
            {
              heading: "RESPA Compliance in North Dakota",
              body: "RESPA Section 8 compliance in North Dakota real estate:\n\nILLEGAL:\n• Title company paying for agent's marketing in exchange for referrals\n• Lender sponsoring office expenses for mortgage referrals\n• Any payment in exchange for settlement service referrals\n• Marketing services agreements that function as referral fees\n\nLEGAL:\n• Genuine affiliated business arrangements (AfBA) with proper disclosure\n• Actual services for actual compensation\n• Educational co-marketing (properly structured)\n• Normal business development activities\n\nNorth Dakota specific: small markets may create pressure for informal quid pro quo arrangements. Agents must be vigilant that referral relationships don't cross RESPA lines regardless of market size."
            }
          ],
          quiz: [
            {
              id: "nd_p03q01",
              prompt: "A North Dakota title company offers to pay for a real estate agent's E&O insurance in exchange for referring all closings to the title company. Under RESPA, this arrangement is:",
              choices: [
  ...
  studyPlan: [
    { weeks: "1-2", focus: "North Dakota licensing roadmap + 90-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + community property and Bakken oil/mineral rights" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + North Dakota purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + North Dakota Housing Finance Agency (NDHFA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (North Dakota additions) + North Dakota license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + North Dakota-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + North Dakota tax considerations + 1031 exchange + North Dakota state exam review + full practice exams" }
  ],

  resources: [
    { label: "North Dakota License Requirements", url: "https://www.google.com/search?q=North+Dakota+real+estate+license+requirements", category: "broker" },
    { label: "North Dakota Real Estate Commission (NDREC) Website", url: "https://www.google.com/search?q=North+Dakota+Real+Estate+Commission+(NDREC)+official+website", category: "broker" },
    { label: "PSI Exams — North Dakota Exam", url: "https://www.google.com/search?q=PSI+Exams+North+Dakota+real+estate+exam", category: "broker" },
    { label: "North Dakota Housing Finance Agency (NDHFA)", url: "https://www.google.com/search?q=North+Dakota+Housing+Finance+Agency+(NDHFA)+North+Dakota", category: "mlo" },
    { label: "North Dakota Department of Financial Institutions", url: "https://www.google.com/search?q=North+Dakota+Department+of+Financial+Institutions+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_ND;
