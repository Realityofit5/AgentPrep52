// ============================================================
// CT_curriculum.js — Connecticut Real Estate Study System
// Connecticut Real Estate Commission Broker/Salesperson License — 2026
// Sources: Connecticut Real Estate Commission, NMLS, PSI Exams
...
const CURRICULUM_CT = {
  ...
  meta: {
    title: "CT Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Connecticut",
    stateCode: "CT",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — CT SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "CT Real Estate Salesperson/Broker",
      icon: "🏛️",
      color: "#003087",
      description: "Connecticut Real Estate Commission — 60-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Connecticut broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "60-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$59", source: "PSI Exams" },
        { item: "Connecticut license fee", amount: "$285", source: "Connecticut Real Estate Commission" },
      ...
      modules: [

        {
          id: "ct_b01",
          order: 1,
          title: "Licensing Process & Connecticut Real Estate Commission Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Connecticut licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Connecticut Real Estate",
              body: "The Connecticut Real Estate Commission licenses and regulates real estate salespersons and brokers in Connecticut.\n\nConnecticut requires 60 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Connecticut:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nConnecticut uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 12 hours every 2 year(s)."
            },
            {
              heading: "60-Hour Pre-License Education",
              body: "Connecticut requires 60 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Connecticut real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Connecticut\n• Connecticut-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nConnecticut-specific education note: Connecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Connecticut uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Connecticut Real Estate Commission\n• Submit background check results\n• Pay license fee of $285\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Connecticut licenses must be renewed every 2 year(s).\n\nCE requirements: 12 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Connecticut-specific law\n• Elective topics\n\nConnecticut-specific requirement: Connecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney."
            },
            {
              heading: "Connecticut-Specific Real Estate Law",
              body: "Key Connecticut real estate law topics:\n\nConnecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney.\n\nAdditional Connecticut-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Connecticut landlord-tenant law\n• Environmental regulations specific to Connecticut\n• Agency law under Connecticut statutes\n\nConnecticut unique aspect — attorney closing requirement: Every Connecticut real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "ct_b01q01",
              prompt: "How many hours of pre-license education does Connecticut require before taking the PSI Exams exam?",
              choices: [
                "30 hours",
                "60 hours",
                "90 hours",
              ...
              answer: 1,
              explanation: "Connecticut requires 60 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Connecticut law, agency, contracts, finance, and other required topics."
            },
            {
              id: "ct_b01q02",
              prompt: "How often must Connecticut real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Connecticut real estate licenses are renewed every 2 year(s). Licensees must complete 12 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "ct_b01q03",
              prompt: "Connecticut's unique real estate requirement regarding attorney closing requirement means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Connecticut-specific rules that differ from most other states",
                "All transactions in Connecticut follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand attorney closing requirement"
              ],
              answer: 1,
              explanation: "Connecticut's unique attorney closing requirement requirement means all licensees must understand state-specific rules. Connecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney."
            },
            {
              id: "ct_b01q04",
              prompt: "The PSI Exams exam used in Connecticut consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Connecticut consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "ct_b01q05",
              prompt: "A new Connecticut licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "ct_b02",
          order: 2,
          title: "Property Ownership & Connecticut Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Connecticut-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Connecticut",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nConnecticut-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Connecticut must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Connecticut",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nConnecticut marital property rules:\nConnecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney.\n\nHomestead protection in Connecticut provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Connecticut",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nConnecticut-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Connecticut",
              body: "Connecticut uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Connecticut where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Connecticut.\n\nRecording in Connecticut: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Connecticut follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Connecticut",
              body: "Transfer of title in Connecticut requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nConnecticut deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Connecticut property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "ct_b02q01",
              prompt: "In Connecticut, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Connecticut Real Estate Commission headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Connecticut are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "ct_b02q02",
              prompt: "Which deed type provides the greatest protection for a Connecticut buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Connecticut. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "ct_b02q03",
              prompt: "Two friends purchase a Connecticut property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Connecticut",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Connecticut. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "ct_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Connecticut, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Connecticut."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Connecticut. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "ct_b04q02",
              prompt: "A Connecticut buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
...

        {
          id: "ct_b05",
          order: 5,
          title: "Real Estate Finance & Connecticut Mortgage Programs",
          week: "5-6",
          passingScore: 75,
          icon: "💰",
          objective: "Explain Connecticut financing options, CHFA (Connecticut Housing Finance Authority) programs, and key federal mortgage regulations.",
          content: [
            {
              heading: "CHFA (Connecticut Housing Finance Authority) Programs",
              body: "CHFA (Connecticut Housing Finance Authority) provides affordable homeownership programs for Connecticut residents:\n\nFirst-time homebuyer programs:\n• Below-market interest rate first mortgages\n• Income and purchase price limits apply (vary by county)\n• Must be primary residence\n\nDown payment assistance:\n• Grants or second mortgages for down payment and closing costs\n• Some programs forgivable after period of occupancy\n\nSpecial programs:\n• Veterans/military programs\n• Low-income and workforce housing programs\n• Renovation and rehabilitation loan programs\n\nMLO value in Connecticut: understanding CHFA (Connecticut Housing Finance Authority) programs is essential as many Connecticut first-time buyers use state housing agency financing."
            },
            {
              heading: "Federal Loan Programs in Connecticut",
              body: "Federal loan programs important in Connecticut:\n\nFHA Loans:\n• 3.5% down payment (with 580+ credit score)\n• MIP (mortgage insurance premium) required\n• Property must meet FHA minimum property standards\n• Common for first-time buyers in Connecticut\n\nVA Loans:\n• 0% down for eligible veterans and active military\n• No PMI required\n• Funding fee applies (waived for disabled veterans)\n• Connecticut military presence: check local military installations\n\nUSDA Rural Development:\n• 0% down for eligible rural properties\n• Income limits apply\n• Many Connecticut rural areas may qualify\n\nConventional/Fannie Mae-Freddie Mac:\n• Dominant in Connecticut's mortgage market\n• 3-20% down depending on program\n• Conforming loan limits vary by county"
            },
            {
              heading: "Deed of Trust vs. Mortgage in Connecticut",
              body: "Most states use either mortgages or deeds of trust as the security instrument for home loans.\n\nMortgage (two-party instrument):\n• Borrower (mortgagor) and lender (mortgagee)\n• Lender must use judicial foreclosure — court process\n• Generally slower and more expensive process\n• Borrower typically has right of redemption after foreclosure sale\n\nDeed of Trust (three-party instrument):\n• Trustor (borrower), trustee (holds legal title), beneficiary (lender)\n• Allows non-judicial (trustee's sale) foreclosure — faster and cheaper\n• Redemption rights vary; many deed of trust states have no redemption period\n\nConnecticut uses: check Connecticut statutes to determine whether Connecticut primarily uses mortgages or deeds of trust, and what the foreclosure process entails."
            }
          ],
          quiz: [
            {
              id: "ct_b05q01",
              prompt: "The CHFA (Connecticut Housing Finance Authority) provides down payment assistance to Connecticut homebuyers primarily to:",
              choices: [
              ...
              answer: 0,
              explanation: "CHFA (Connecticut Housing Finance Authority) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Connecticut."
            },
            {
              id: "ct_b05q02",
              prompt: "A Connecticut veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ct_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Connecticut?",
              choices: [
...

        {
          id: "ct_b07",
          order: 7,
          title: "Fair Housing & Connecticut Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Connecticut-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Connecticut Fair Housing Protections",
              body: "Connecticut may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Connecticut may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Connecticut state statutes for current protected classes under Connecticut fair housing law.\n\nConnecticut enforcement: File complaints with Connecticut Real Estate Commission and/or HUD within applicable time limits. Connecticut Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "ct_b08",
          order: 8,
          title: "Property Management & Connecticut Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Connecticut landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Connecticut Landlord-Tenant Basics",
              body: "Connecticut landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Connecticut rules:\n• Security deposit: Connecticut sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Connecticut requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Connecticut:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Connecticut",
              body: "Property managers in Connecticut generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Connecticut statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nConnecticut property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "ct_b08q01",
              prompt: "A Connecticut landlord collects a security deposit from a tenant. Under Connecticut landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Connecticut must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Connecticut has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "ct_b10",
          order: 10,
          title: "Connecticut License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Connecticut license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Connecticut License Law — Key Provisions",
              body: "Connecticut real estate licensees must comply with:\n\nConnecticut Real Estate Commission rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nConnecticut specific: Connecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney."
            },
            {
              heading: "Connecticut Real Estate Recovery Fund",
              body: "Connecticut maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Connecticut's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Connecticut limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Connecticut\n\nConnecticut trust account rules:\n• Client funds must be deposited promptly (check Connecticut specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Connecticut Real Estate Commission audit at any time"
            }
          ],
          quiz: [
            {
              id: "ct_b10q01",
              prompt: "A Connecticut broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Connecticut's license law and can result in license suspension or revocation."
            },
            {
              id: "ct_b10q02",
              prompt: "The Connecticut Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ct_b11q02",
              prompt: "A Connecticut investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Connecticut state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Connecticut rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Connecticut state income tax on the gain (if Connecticut has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "ct_b12",
          order: 12,
          title: "Connecticut State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Connecticut-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Connecticut State Exam Key Topics",
              body: "Connecticut state exam will focus on:\n\n1. Connecticut license law — Connecticut Real Estate Commission rules and procedures\n2. Connecticut agency law — specific state requirements\n3. Connecticut contract forms and requirements\n4. Connecticut disclosure laws\n5. Connecticut property tax system\n6. Connecticut closing procedures\n7. Connecticut-specific restrictions and regulations\n8. Connecticut fair housing additions\n9. Connecticut landlord-tenant law\n10. Connecticut environmental law\n\nConnecticut unique state exam emphasis: Connecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney.\n\nStudy strategy:\n• Review Connecticut Real Estate Commission website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Connecticut-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "ct_b12q01",
              prompt: "Which Connecticut licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Connecticut Real Estate Commission has the legal authority to suspend or revoke a Connecticut real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "ct_b12q02",
              prompt: "A Connecticut licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "CT MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Connecticut Department of Banking state requirements",
      requirements: [
        ...
        "Sponsored by a Connecticut-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Connecticut state license fee", amount: "$150–$300", source: "Connecticut Department of Banking" },
      ...
      modules: [
        {
          id: "ct_m01",
          order: 1,
          title: "SAFE Act & Connecticut MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Connecticut Department of Banking requirements, and CHFA (Connecticut Housing Finance Authority) programs.",
          content: [
            {
              heading: "Connecticut MLO Regulation — Connecticut Department of Banking",
              body: "Connecticut MLOs are regulated by the Connecticut Department of Banking through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Connecticut must hold an active NMLS MLO license with a Connecticut state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Connecticut state endorsement through NMLS\n6. Obtain sponsorship from Connecticut-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "CHFA (Connecticut Housing Finance Authority) Programs",
              body: "CHFA (Connecticut Housing Finance Authority) provides mortgage programs for Connecticut homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Connecticut:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Connecticut areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Connecticut's state housing agency programs differentiates Connecticut MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "ct_m01q01",
              prompt: "Which agency regulates Connecticut MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Connecticut MLO licenses are regulated by the Connecticut Department of Banking. Real estate brokers and salespersons are regulated by the Connecticut Real Estate Commission. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "ct_m01q02",
              prompt: "An MLO in Connecticut must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "CT Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Connecticut real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "ct_p01",
          order: 1,
          title: "Connecticut Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Connecticut listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Connecticut Pre-Listing Preparation",
              body: "Steps to prepare a Connecticut listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Connecticut-specific issues: attorney closing requirement\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Connecticut-specific disclosure items: Connecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Connecticut market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Connecticut-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Connecticut Market Dynamics",
              body: "Connecticut's real estate market has unique characteristics:\n\nConnecticut requires attorney review period for residential contracts (5 business days). All real estate closings must be conducted by a Connecticut-licensed attorney.\n\nKey factors affecting Connecticut real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nConnecticut market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Connecticut-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Connecticut: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "ct_p01q01",
              prompt: "During pre-listing due diligence for a Connecticut property, an agent discovers the property may have attorney closing requirement issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential attorney closing requirement issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "ct_p02",
          order: 2,
          title: "Connecticut Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute Connecticut buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "Connecticut buyer representation process:\n\n1. Initial consultation:\n• Explain Connecticut brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and CHFA (Connecticut Housing Finance Authority) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use Connecticut MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on Connecticut-specific considerations: attorney closing requirement\n\n4. Making offers:\n• Explain Connecticut purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of Connecticut investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nConnecticut investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nConnecticut specific: attorney closing requirement considerations for investment buyers in Connecticut."
            }
          ],
          quiz: [
            {
              id: "ct_p02q01",
              prompt: "A Connecticut investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Connecticut licensing roadmap + 60-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + attorney closing requirement" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Connecticut purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + CHFA (Connecticut Housing Finance Authority) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Connecticut additions) + Connecticut license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Connecticut-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Connecticut tax considerations + 1031 exchange + Connecticut state exam review + full practice exams" }
  ],

  resources: [
    { label: "Connecticut License Requirements", url: "https://www.google.com/search?q=Connecticut+real+estate+license+requirements", category: "broker" },
    { label: "Connecticut Real Estate Commission Website", url: "https://www.google.com/search?q=Connecticut+Real+Estate+Commission+official+website", category: "broker" },
    { label: "PSI Exams — Connecticut Exam", url: "https://www.google.com/search?q=PSI+Exams+Connecticut+real+estate+exam", category: "broker" },
    { label: "CHFA (Connecticut Housing Finance Authority)", url: "https://www.google.com/search?q=CHFA+(Connecticut+Housing+Finance+Authority)+Connecticut", category: "mlo" },
    { label: "Connecticut Department of Banking", url: "https://www.google.com/search?q=Connecticut+Department+of+Banking+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_CT;
