// ============================================================
// RI_curriculum.js — Rhode Island Real Estate Study System
// Rhode Island Real Estate Commission Broker/Salesperson License — 2026
// Sources: Rhode Island Real Estate Commission, NMLS, PSI Exams
...
const CURRICULUM_RI = {
  ...
  meta: {
    title: "RI Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Rhode Island",
    stateCode: "RI",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — RI SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "RI Real Estate Salesperson/Broker",
      icon: "⚓",
      color: "#003087",
      description: "Rhode Island Real Estate Commission — 45-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        "45 hours of approved pre-license education",
        "Pass PSI Exams exam: national + state sections; 75% passing score",
        "Background check",
        "Apply within 1 year of passing exam",
        "Must be sponsored by a licensed Rhode Island broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "45-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$65", source: "PSI Exams" },
        { item: "Rhode Island license fee", amount: "$75", source: "Rhode Island Real Estate Commission" },
      ...
      modules: [

        {
          id: "ri_b01",
          order: 1,
          title: "Licensing Process & Rhode Island Real Estate Commission Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Rhode Island licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Rhode Island Real Estate",
              body: "The Rhode Island Real Estate Commission licenses and regulates real estate salespersons and brokers in Rhode Island.\n\nRhode Island requires 45 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Rhode Island:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nRhode Island uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 24 hours every 2 year(s)."
            },
            {
              heading: "45-Hour Pre-License Education",
              body: "Rhode Island requires 45 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Rhode Island real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Rhode Island\n• Rhode Island-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nRhode Island-specific education note: Rhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC)."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Rhode Island uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Rhode Island Real Estate Commission\n• Submit background check results\n• Pay license fee of $75\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Rhode Island licenses must be renewed every 2 year(s).\n\nCE requirements: 24 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Rhode Island-specific law\n• Elective topics\n\nRhode Island-specific requirement: Rhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC)."
            },
            {
              heading: "Rhode Island-Specific Real Estate Law",
              body: "Key Rhode Island real estate law topics:\n\nRhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC).\n\nAdditional Rhode Island-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Rhode Island landlord-tenant law\n• Environmental regulations specific to Rhode Island\n• Agency law under Rhode Island statutes\n\nRhode Island unique aspect — attorney closings and coastal property regulations: Every Rhode Island real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "ri_b01q01",
              prompt: "How many hours of pre-license education does Rhode Island require before taking the PSI Exams exam?",
              choices: [
                "22 hours",
                "45 hours",
                "67 hours",
              ...
              answer: 1,
              explanation: "Rhode Island requires 45 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Rhode Island law, agency, contracts, finance, and other required topics."
            },
            {
              id: "ri_b01q02",
              prompt: "How often must Rhode Island real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Rhode Island real estate licenses are renewed every 2 year(s). Licensees must complete 24 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "ri_b01q03",
              prompt: "Rhode Island's unique real estate requirement regarding attorney closings and coastal property regulations means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Rhode Island-specific rules that differ from most other states",
                "All transactions in Rhode Island follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand attorney closings and coastal property regulations"
              ],
              answer: 1,
              explanation: "Rhode Island's unique attorney closings and coastal property regulations requirement means all licensees must understand state-specific rules. Rhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC)."
            },
            {
              id: "ri_b01q04",
              prompt: "The PSI Exams exam used in Rhode Island consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Rhode Island consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "ri_b01q05",
              prompt: "A new Rhode Island licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "ri_b02",
          order: 2,
          title: "Property Ownership & Rhode Island Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Rhode Island-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Rhode Island",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nRhode Island-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Rhode Island must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Rhode Island",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nRhode Island marital property rules:\nRhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC).\n\nHomestead protection in Rhode Island provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Rhode Island",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nRhode Island-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Rhode Island",
              body: "Rhode Island uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Rhode Island where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Rhode Island.\n\nRecording in Rhode Island: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Rhode Island follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Rhode Island",
              body: "Transfer of title in Rhode Island requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nRhode Island deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Rhode Island property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "ri_b02q01",
              prompt: "In Rhode Island, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Rhode Island Real Estate Commission headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Rhode Island are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "ri_b02q02",
              prompt: "Which deed type provides the greatest protection for a Rhode Island buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Rhode Island. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "ri_b02q03",
              prompt: "Two friends purchase a Rhode Island property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Rhode Island",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Rhode Island. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "ri_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Rhode Island, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Rhode Island."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Rhode Island. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "ri_b04q02",
              prompt: "A Rhode Island buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Rhode Island Housing (RIHousing) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Rhode Island."
            },
            {
              id: "ri_b05q02",
              prompt: "A Rhode Island veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ri_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Rhode Island?",
              choices: [
...

        {
          id: "ri_b07",
          order: 7,
          title: "Fair Housing & Rhode Island Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Rhode Island-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Rhode Island Fair Housing Protections",
              body: "Rhode Island may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Rhode Island may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Rhode Island state statutes for current protected classes under Rhode Island fair housing law.\n\nRhode Island enforcement: File complaints with Rhode Island Real Estate Commission and/or HUD within applicable time limits. Rhode Island Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "ri_b08",
          order: 8,
          title: "Property Management & Rhode Island Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Rhode Island landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Rhode Island Landlord-Tenant Basics",
              body: "Rhode Island landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Rhode Island rules:\n• Security deposit: Rhode Island sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Rhode Island requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Rhode Island:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Rhode Island",
              body: "Property managers in Rhode Island generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Rhode Island statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nRhode Island property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "ri_b08q01",
              prompt: "A Rhode Island landlord collects a security deposit from a tenant. Under Rhode Island landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Rhode Island must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Rhode Island has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "ri_b10",
          order: 10,
          title: "Rhode Island License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Rhode Island license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Rhode Island License Law — Key Provisions",
              body: "Rhode Island real estate licensees must comply with:\n\nRhode Island Real Estate Commission rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nRhode Island specific: Rhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC)."
            },
            {
              heading: "Rhode Island Real Estate Recovery Fund",
              body: "Rhode Island maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Rhode Island's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Rhode Island limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Rhode Island\n\nRhode Island trust account rules:\n• Client funds must be deposited promptly (check Rhode Island specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Rhode Island Real Estate Commission audit at any time"
            }
          ],
          quiz: [
            {
              id: "ri_b10q01",
              prompt: "A Rhode Island broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Rhode Island's license law and can result in license suspension or revocation."
            },
            {
              id: "ri_b10q02",
              prompt: "The Rhode Island Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ri_b11q02",
              prompt: "A Rhode Island investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Rhode Island state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Rhode Island rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Rhode Island state income tax on the gain (if Rhode Island has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "ri_b12",
          order: 12,
          title: "Rhode Island State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Rhode Island-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Rhode Island State Exam Key Topics",
              body: "Rhode Island state exam will focus on:\n\n1. Rhode Island license law — Rhode Island Real Estate Commission rules and procedures\n2. Rhode Island agency law — specific state requirements\n3. Rhode Island contract forms and requirements\n4. Rhode Island disclosure laws\n5. Rhode Island property tax system\n6. Rhode Island closing procedures\n7. Rhode Island-specific restrictions and regulations\n8. Rhode Island fair housing additions\n9. Rhode Island landlord-tenant law\n10. Rhode Island environmental law\n\nRhode Island unique state exam emphasis: Rhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC).\n\nStudy strategy:\n• Review Rhode Island Real Estate Commission website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Rhode Island-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "ri_b12q01",
              prompt: "Which Rhode Island licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Rhode Island Real Estate Commission has the legal authority to suspend or revoke a Rhode Island real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "ri_b12q02",
              prompt: "A Rhode Island licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "RI MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Rhode Island Division of Banking state requirements",
      requirements: [
        ...
        "Sponsored by a Rhode Island-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Rhode Island state license fee", amount: "$150–$300", source: "Rhode Island Division of Banking" },
      ...
      modules: [
        {
          id: "ri_m01",
          order: 1,
          title: "SAFE Act & Rhode Island MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Rhode Island Division of Banking requirements, and Rhode Island Housing (RIHousing) programs.",
          content: [
            {
              heading: "Rhode Island MLO Regulation — Rhode Island Division of Banking",
              body: "Rhode Island MLOs are regulated by the Rhode Island Division of Banking through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Rhode Island must hold an active NMLS MLO license with a Rhode Island state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Rhode Island state endorsement through NMLS\n6. Obtain sponsorship from Rhode Island-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Rhode Island Housing (RIHousing) Programs",
              body: "Rhode Island Housing (RIHousing) provides mortgage programs for Rhode Island homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Rhode Island:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Rhode Island areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Rhode Island's state housing agency programs differentiates Rhode Island MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "ri_m01q01",
              prompt: "Which agency regulates Rhode Island MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Rhode Island MLO licenses are regulated by the Rhode Island Division of Banking. Real estate brokers and salespersons are regulated by the Rhode Island Real Estate Commission. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "ri_m01q02",
              prompt: "An MLO in Rhode Island must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "RI Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Rhode Island real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
        "Complete broker pre-license education",
        "Pass PSI Exams exam",
        "Active Rhode Island license",
      ...
      modules: [
        {
          id: "ri_p01",
          order: 1,
          title: "Rhode Island Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Rhode Island listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Rhode Island Pre-Listing Preparation",
              body: "Steps to prepare a Rhode Island listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Rhode Island-specific issues: attorney closings and coastal property regulations\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Rhode Island-specific disclosure items: Rhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC).\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Rhode Island market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Rhode Island-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Rhode Island Market Dynamics",
              body: "Rhode Island's real estate market has unique characteristics:\n\nRhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC).\n\nKey factors affecting Rhode Island real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nRhode Island market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Rhode Island-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Rhode Island: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "ri_p01q01",
              prompt: "During pre-listing due diligence for a Rhode Island property, an agent discovers the property may have attorney closings and coastal property regulations issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential attorney closings and coastal property regulations issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "ri_p02",
          order: 2,
          title: "Rhode Island Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute Rhode Island buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "Rhode Island buyer representation process:\n\n1. Initial consultation:\n• Explain Rhode Island brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and Rhode Island Housing (RIHousing) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use Rhode Island MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on Rhode Island-specific considerations: attorney closings and coastal property regulations\n\n4. Making offers:\n• Explain Rhode Island purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of Rhode Island investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nRhode Island investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nRhode Island specific: attorney closings and coastal property regulations considerations for investment buyers in Rhode Island."
            }
          ],
          quiz: [
            {
              id: "ri_p02q01",
              prompt: "A Rhode Island investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
...

        {
          id: "ri_p03",
          order: 3,
          title: "Rhode Island Closing Process & RESPA Compliance",
          week: "9-12",
          passingScore: 70,
          icon: "🎯",
          objective: "Navigate Rhode Island closing procedures, RESPA compliance, and build ethical referral networks.",
          content: [
            {
              heading: "Rhode Island Closing Procedures",
              body: "The Rhode Island closing process:\n\n1. Pre-closing preparation:\n• Title company/attorney orders title search and issues commitment\n• Lender completes underwriting; issues clear to close\n• Closing disclosure prepared and delivered 3 business days before closing\n• Final walk-through by buyer\n\n2. Closing day:\n• Buyer and seller (or their representatives) attend closing\n• Sign all documents (deed, mortgage, closing disclosure, etc.)\n• Funds deposited and disbursed\n• Deed and mortgage recorded\n• Keys transferred\n\n3. Post-closing:\n• Confirm recording\n• Distribute closing packages to all parties\n• Upload documents to transaction management system\n• Collect commission\n\nRhode Island closing practice: Rhode Island requires attorney involvement in real estate closings. Rhode Island is one of the smallest states but has unique coastal and waterfront property regulations under the Coastal Resources Management Council (CRMC)."
            },
            {
              heading: "RESPA Compliance in Rhode Island",
              body: "RESPA Section 8 compliance in Rhode Island real estate:\n\nILLEGAL:\n• Title company paying for agent's marketing in exchange for referrals\n• Lender sponsoring office expenses for mortgage referrals\n• Any payment in exchange for settlement service referrals\n• Marketing services agreements that function as referral fees\n\nLEGAL:\n• Genuine affiliated business arrangements (AfBA) with proper disclosure\n• Actual services for actual compensation\n• Educational co-marketing (properly structured)\n• Normal business development activities\n\nRhode Island specific: small markets may create pressure for informal quid pro quo arrangements. Agents must be vigilant that referral relationships don't cross RESPA lines regardless of market size."
            }
          ],
          quiz: [
            {
              id: "ri_p03q01",
              prompt: "A Rhode Island title company offers to pay for a real estate agent's E&O insurance in exchange for referring all closings to the title company. Under RESPA, this arrangement is:",
              choices: [
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Rhode Island licensing roadmap + 45-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + attorney closings and coastal property regulations" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Rhode Island purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Rhode Island Housing (RIHousing) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Rhode Island additions) + Rhode Island license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Rhode Island-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Rhode Island tax considerations + 1031 exchange + Rhode Island state exam review + full practice exams" }
  ],

  resources: [
    { label: "Rhode Island License Requirements", url: "https://www.google.com/search?q=Rhode+Island+real+estate+license+requirements", category: "broker" },
    { label: "Rhode Island Real Estate Commission Website", url: "https://www.google.com/search?q=Rhode+Island+Real+Estate+Commission+official+website", category: "broker" },
    { label: "PSI Exams — Rhode Island Exam", url: "https://www.google.com/search?q=PSI+Exams+Rhode+Island+real+estate+exam", category: "broker" },
    { label: "Rhode Island Housing (RIHousing)", url: "https://www.google.com/search?q=Rhode+Island+Housing+(RIHousing)+Rhode+Island", category: "mlo" },
    { label: "Rhode Island Division of Banking", url: "https://www.google.com/search?q=Rhode+Island+Division+of+Banking+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_RI;
