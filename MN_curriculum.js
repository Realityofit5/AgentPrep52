// ============================================================
// MN_curriculum.js — Minnesota Real Estate Study System
// Minnesota Department of Commerce Broker/Salesperson License — 2026
// Sources: Minnesota Department of Commerce, NMLS, PSI Exams
...
const CURRICULUM_MN = {
  ...
  meta: {
    title: "MN Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Minnesota",
    stateCode: "MN",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — MN SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "MN Real Estate Salesperson/Broker",
      icon: "❄️",
      color: "#003087",
      description: "Minnesota Department of Commerce — 90-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Minnesota broker",
      ...
      fees: [
        ...
        { item: "Minnesota license fee", amount: "$60", source: "Minnesota Department of Commerce" },
      ...
      modules: [

        {
          id: "mn_b01",
          order: 1,
          title: "Licensing Process & Minnesota Department of Commerce Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Minnesota licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Minnesota Real Estate",
              body: "The Minnesota Department of Commerce licenses and regulates real estate salespersons and brokers in Minnesota.\n\nMinnesota requires 90 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Minnesota:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nMinnesota uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 30 hours every 2 year(s)."
            },
            {
              heading: "90-Hour Pre-License Education",
              body: "Minnesota requires 90 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Minnesota real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Minnesota\n• Minnesota-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nMinnesota-specific education note: Minnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Minnesota uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Minnesota Department of Commerce\n• Submit background check results\n• Pay license fee of $60\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Minnesota licenses must be renewed every 2 year(s).\n\nCE requirements: 30 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Minnesota-specific law\n• Elective topics\n\nMinnesota-specific requirement: Minnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form."
            },
            {
              heading: "Minnesota-Specific Real Estate Law",
              body: "Key Minnesota real estate law topics:\n\nMinnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form.\n\nAdditional Minnesota-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Minnesota landlord-tenant law\n• Environmental regulations specific to Minnesota\n• Agency law under Minnesota statutes\n\nMinnesota unique aspect — dual agency disclosure and waterfront regulations: Every Minnesota real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "mn_b01q01",
              prompt: "How many hours of pre-license education does Minnesota require before taking the PSI Exams exam?",
              choices: [
                "45 hours",
                "90 hours",
                "135 hours",
              ...
              answer: 1,
              explanation: "Minnesota requires 90 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Minnesota law, agency, contracts, finance, and other required topics."
            },
            {
              id: "mn_b01q02",
              prompt: "How often must Minnesota real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Minnesota real estate licenses are renewed every 2 year(s). Licensees must complete 30 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "mn_b01q03",
              prompt: "Minnesota's unique real estate requirement regarding dual agency disclosure and waterfront regulations means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Minnesota-specific rules that differ from most other states",
                "All transactions in Minnesota follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand dual agency disclosure and waterfront regulations"
              ],
              answer: 1,
              explanation: "Minnesota's unique dual agency disclosure and waterfront regulations requirement means all licensees must understand state-specific rules. Minnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form."
            },
            {
              id: "mn_b01q04",
              prompt: "The PSI Exams exam used in Minnesota consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Minnesota consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "mn_b01q05",
              prompt: "A new Minnesota licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "mn_b02",
          order: 2,
          title: "Property Ownership & Minnesota Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Minnesota-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Minnesota",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nMinnesota-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Minnesota must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Minnesota",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nMinnesota marital property rules:\nMinnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form.\n\nHomestead protection in Minnesota provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Minnesota",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nMinnesota-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Minnesota",
              body: "Minnesota uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Minnesota where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Minnesota.\n\nRecording in Minnesota: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Minnesota follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Minnesota",
              body: "Transfer of title in Minnesota requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nMinnesota deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Minnesota property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "mn_b02q01",
              prompt: "In Minnesota, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Minnesota Department of Commerce headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Minnesota are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "mn_b02q02",
              prompt: "Which deed type provides the greatest protection for a Minnesota buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Minnesota. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "mn_b02q03",
              prompt: "Two friends purchase a Minnesota property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Minnesota",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Minnesota. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "mn_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Minnesota, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Minnesota."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Minnesota. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "mn_b04q02",
              prompt: "A Minnesota buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Minnesota Housing Finance Agency down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Minnesota."
            },
            {
              id: "mn_b05q02",
              prompt: "A Minnesota veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "mn_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Minnesota?",
              choices: [
...

        {
          id: "mn_b07",
          order: 7,
          title: "Fair Housing & Minnesota Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Minnesota-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Minnesota Fair Housing Protections",
              body: "Minnesota may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Minnesota may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Minnesota state statutes for current protected classes under Minnesota fair housing law.\n\nMinnesota enforcement: File complaints with Minnesota Department of Commerce and/or HUD within applicable time limits. Minnesota Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "mn_b08",
          order: 8,
          title: "Property Management & Minnesota Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Minnesota landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Minnesota Landlord-Tenant Basics",
              body: "Minnesota landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Minnesota rules:\n• Security deposit: Minnesota sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Minnesota requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Minnesota:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Minnesota",
              body: "Property managers in Minnesota generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Minnesota statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nMinnesota property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "mn_b08q01",
              prompt: "A Minnesota landlord collects a security deposit from a tenant. Under Minnesota landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Minnesota must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Minnesota has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "mn_b10",
          order: 10,
          title: "Minnesota License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Minnesota license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Minnesota License Law — Key Provisions",
              body: "Minnesota real estate licensees must comply with:\n\nMinnesota Department of Commerce rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nMinnesota specific: Minnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form."
            },
            {
              heading: "Minnesota Real Estate Recovery Fund",
              body: "Minnesota maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Minnesota's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Minnesota limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Minnesota\n\nMinnesota trust account rules:\n• Client funds must be deposited promptly (check Minnesota specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Minnesota Department of Commerce audit at any time"
            }
          ],
          quiz: [
            {
              id: "mn_b10q01",
              prompt: "A Minnesota broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Minnesota's license law and can result in license suspension or revocation."
            },
            {
              id: "mn_b10q02",
              prompt: "The Minnesota Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "mn_b11q02",
              prompt: "A Minnesota investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Minnesota state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Minnesota rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Minnesota state income tax on the gain (if Minnesota has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "mn_b12",
          order: 12,
          title: "Minnesota State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Minnesota-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Minnesota State Exam Key Topics",
              body: "Minnesota state exam will focus on:\n\n1. Minnesota license law — Minnesota Department of Commerce rules and procedures\n2. Minnesota agency law — specific state requirements\n3. Minnesota contract forms and requirements\n4. Minnesota disclosure laws\n5. Minnesota property tax system\n6. Minnesota closing procedures\n7. Minnesota-specific restrictions and regulations\n8. Minnesota fair housing additions\n9. Minnesota landlord-tenant law\n10. Minnesota environmental law\n\nMinnesota unique state exam emphasis: Minnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form.\n\nStudy strategy:\n• Review Minnesota Department of Commerce website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Minnesota-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "mn_b12q01",
              prompt: "Which Minnesota licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Minnesota Department of Commerce has the legal authority to suspend or revoke a Minnesota real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "mn_b12q02",
              prompt: "A Minnesota licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "MN MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Minnesota Department of Commerce state requirements",
      requirements: [
        ...
        "Sponsored by a Minnesota-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Minnesota state license fee", amount: "$150–$300", source: "Minnesota Department of Commerce" },
      ...
      modules: [
        {
          id: "mn_m01",
          order: 1,
          title: "SAFE Act & Minnesota MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Minnesota Department of Commerce requirements, and Minnesota Housing Finance Agency programs.",
          content: [
            {
              heading: "Minnesota MLO Regulation — Minnesota Department of Commerce",
              body: "Minnesota MLOs are regulated by the Minnesota Department of Commerce through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Minnesota must hold an active NMLS MLO license with a Minnesota state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Minnesota state endorsement through NMLS\n6. Obtain sponsorship from Minnesota-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Minnesota Housing Finance Agency Programs",
              body: "Minnesota Housing Finance Agency provides mortgage programs for Minnesota homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Minnesota:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Minnesota areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Minnesota's state housing agency programs differentiates Minnesota MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "mn_m01q01",
              prompt: "Which agency regulates Minnesota MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Minnesota MLO licenses are regulated by the Minnesota Department of Commerce. Real estate brokers and salespersons are regulated by the Minnesota Department of Commerce. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "mn_m01q02",
              prompt: "An MLO in Minnesota must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "MN Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Minnesota real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "mn_p01",
          order: 1,
          title: "Minnesota Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Minnesota listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Minnesota Pre-Listing Preparation",
              body: "Steps to prepare a Minnesota listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Minnesota-specific issues: dual agency disclosure and waterfront regulations\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Minnesota-specific disclosure items: Minnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Minnesota market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Minnesota-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Minnesota Market Dynamics",
              body: "Minnesota's real estate market has unique characteristics:\n\nMinnesota follows the MREEA (Minnesota Real Estate Educators Association) curriculum for pre-license education. Minnesota uses 'dual agency' but requires a specific dual agency disclosure form.\n\nKey factors affecting Minnesota real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nMinnesota market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Minnesota-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Minnesota: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "mn_p01q01",
              prompt: "During pre-listing due diligence for a Minnesota property, an agent discovers the property may have dual agency disclosure and waterfront regulations issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential dual agency disclosure and waterfront regulations issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "mn_p02",
          order: 2,
          title: "Minnesota Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute Minnesota buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "Minnesota buyer representation process:\n\n1. Initial consultation:\n• Explain Minnesota brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and Minnesota Housing Finance Agency programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use Minnesota MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on Minnesota-specific considerations: dual agency disclosure and waterfront regulations\n\n4. Making offers:\n• Explain Minnesota purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of Minnesota investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nMinnesota investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nMinnesota specific: dual agency disclosure and waterfront regulations considerations for investment buyers in Minnesota."
            }
          ],
          quiz: [
            {
              id: "mn_p02q01",
              prompt: "A Minnesota investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Minnesota licensing roadmap + 90-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + dual agency disclosure and waterfront regulations" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Minnesota purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Minnesota Housing Finance Agency programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Minnesota additions) + Minnesota license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Minnesota-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Minnesota tax considerations + 1031 exchange + Minnesota state exam review + full practice exams" }
  ],

  resources: [
    { label: "Minnesota License Requirements", url: "https://www.google.com/search?q=Minnesota+real+estate+license+requirements", category: "broker" },
    { label: "Minnesota Department of Commerce Website", url: "https://www.google.com/search?q=Minnesota+Department+of+Commerce+official+website", category: "broker" },
    { label: "PSI Exams — Minnesota Exam", url: "https://www.google.com/search?q=PSI+Exams+Minnesota+real+estate+exam", category: "broker" },
    { label: "Minnesota Housing Finance Agency", url: "https://www.google.com/search?q=Minnesota+Housing+Finance+Agency+Minnesota", category: "mlo" },
    { label: "Minnesota Department of Commerce", url: "https://www.google.com/search?q=Minnesota+Department+of+Commerce+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_MN;
