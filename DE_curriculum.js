// ============================================================
// DE_curriculum.js — Delaware Real Estate Study System
// Delaware Real Estate Commission Broker/Salesperson License — 2026
// Sources: Delaware Real Estate Commission, NMLS, PSI Exams
...
const CURRICULUM_DE = {
  ...
  meta: {
    title: "DE Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Delaware",
    stateCode: "DE",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — DE SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "DE Real Estate Salesperson/Broker",
      icon: "🌊",
      color: "#003580",
      description: "Delaware Real Estate Commission — 99-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        "99 hours of approved pre-license education",
        "Pass PSI Exams exam: national + state sections; 75% passing score",
        "Background check",
        "Apply within 1 year of passing exam",
        "Must be sponsored by a licensed Delaware broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "99-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$65", source: "PSI Exams" },
        { item: "Delaware license fee", amount: "$134", source: "Delaware Real Estate Commission" },
      ...
      modules: [

        {
          id: "de_b01",
          order: 1,
          title: "Licensing Process & Delaware Real Estate Commission Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Delaware licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Delaware Real Estate",
              body: "The Delaware Real Estate Commission licenses and regulates real estate salespersons and brokers in Delaware.\n\nDelaware requires 99 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Delaware:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nDelaware uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 21 hours every 2 year(s)."
            },
            {
              heading: "99-Hour Pre-License Education",
              body: "Delaware requires 99 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Delaware real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Delaware\n• Delaware-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nDelaware-specific education note: Delaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Delaware uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Delaware Real Estate Commission\n• Submit background check results\n• Pay license fee of $134\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Delaware licenses must be renewed every 2 year(s).\n\nCE requirements: 21 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Delaware-specific law\n• Elective topics\n\nDelaware-specific requirement: Delaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state."
            },
            {
              heading: "Delaware-Specific Real Estate Law",
              body: "Key Delaware real estate law topics:\n\nDelaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state.\n\nAdditional Delaware-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Delaware landlord-tenant law\n• Environmental regulations specific to Delaware\n• Agency law under Delaware statutes\n\nDelaware unique aspect — attorney closing and corporate law: Every Delaware real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "de_b01q01",
              prompt: "How many hours of pre-license education does Delaware require before taking the PSI Exams exam?",
              choices: [
                "49 hours",
                "99 hours",
                "148 hours",
              ...
              answer: 1,
              explanation: "Delaware requires 99 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Delaware law, agency, contracts, finance, and other required topics."
            },
            {
              id: "de_b01q02",
              prompt: "How often must Delaware real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Delaware real estate licenses are renewed every 2 year(s). Licensees must complete 21 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "de_b01q03",
              prompt: "Delaware's unique real estate requirement regarding attorney closing and corporate law means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Delaware-specific rules that differ from most other states",
                "All transactions in Delaware follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand attorney closing and corporate law"
              ],
              answer: 1,
              explanation: "Delaware's unique attorney closing and corporate law requirement means all licensees must understand state-specific rules. Delaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state."
            },
            {
              id: "de_b01q04",
              prompt: "The PSI Exams exam used in Delaware consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Delaware consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "de_b01q05",
              prompt: "A new Delaware licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "de_b02",
          order: 2,
          title: "Property Ownership & Delaware Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Delaware-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Delaware",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nDelaware-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Delaware must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Delaware",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nDelaware marital property rules:\nDelaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state.\n\nHomestead protection in Delaware provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Delaware",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nDelaware-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Delaware",
              body: "Delaware uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Delaware where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Delaware.\n\nRecording in Delaware: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Delaware follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Delaware",
              body: "Transfer of title in Delaware requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nDelaware deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Delaware property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "de_b02q01",
              prompt: "In Delaware, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Delaware Real Estate Commission headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Delaware are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "de_b02q02",
              prompt: "Which deed type provides the greatest protection for a Delaware buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Delaware. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "de_b02q03",
              prompt: "Two friends purchase a Delaware property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Delaware",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Delaware. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "de_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Delaware, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Delaware."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Delaware. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "de_b04q02",
              prompt: "A Delaware buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Delaware State Housing Authority (DSHA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Delaware."
            },
            {
              id: "de_b05q02",
              prompt: "A Delaware veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "de_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Delaware?",
              choices: [
...

        {
          id: "de_b07",
          order: 7,
          title: "Fair Housing & Delaware Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Delaware-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Delaware Fair Housing Protections",
              body: "Delaware may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Delaware may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Delaware state statutes for current protected classes under Delaware fair housing law.\n\nDelaware enforcement: File complaints with Delaware Real Estate Commission and/or HUD within applicable time limits. Delaware Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "de_b08",
          order: 8,
          title: "Property Management & Delaware Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Delaware landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Delaware Landlord-Tenant Basics",
              body: "Delaware landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Delaware rules:\n• Security deposit: Delaware sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Delaware requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Delaware:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Delaware",
              body: "Property managers in Delaware generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Delaware statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nDelaware property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "de_b08q01",
              prompt: "A Delaware landlord collects a security deposit from a tenant. Under Delaware landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Delaware must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Delaware has varying radon risk depending on local geology."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Delaware's license law and can result in license suspension or revocation."
            },
            {
              id: "de_b10q02",
              prompt: "The Delaware Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "de_b11q02",
              prompt: "A Delaware investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Delaware state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Delaware rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Delaware state income tax on the gain (if Delaware has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "de_b12",
          order: 12,
          title: "Delaware State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Delaware-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Delaware State Exam Key Topics",
              body: "Delaware state exam will focus on:\n\n1. Delaware license law — Delaware Real Estate Commission rules and procedures\n2. Delaware agency law — specific state requirements\n3. Delaware contract forms and requirements\n4. Delaware disclosure laws\n5. Delaware property tax system\n6. Delaware closing procedures\n7. Delaware-specific restrictions and regulations\n8. Delaware fair housing additions\n9. Delaware landlord-tenant law\n10. Delaware environmental law\n\nDelaware unique state exam emphasis: Delaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state.\n\nStudy strategy:\n• Review Delaware Real Estate Commission website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Delaware-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "de_b12q01",
              prompt: "Which Delaware licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Delaware Real Estate Commission has the legal authority to suspend or revoke a Delaware real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "de_b12q02",
              prompt: "A Delaware licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "DE MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Office of the State Bank Commissioner state requirements",
      requirements: [
        ...
        "Sponsored by a Delaware-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Delaware state license fee", amount: "$150–$300", source: "Office of the State Bank Commissioner" },
      ...
      modules: [
        {
          id: "de_m01",
          order: 1,
          title: "SAFE Act & Delaware MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Office of the State Bank Commissioner requirements, and Delaware State Housing Authority (DSHA) programs.",
          content: [
            {
              heading: "Delaware MLO Regulation — Office of the State Bank Commissioner",
              body: "Delaware MLOs are regulated by the Office of the State Bank Commissioner through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Delaware must hold an active NMLS MLO license with a Delaware state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Delaware state endorsement through NMLS\n6. Obtain sponsorship from Delaware-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Delaware State Housing Authority (DSHA) Programs",
              body: "Delaware State Housing Authority (DSHA) provides mortgage programs for Delaware homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Delaware:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Delaware areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Delaware's state housing agency programs differentiates Delaware MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "de_m01q01",
              prompt: "Which agency regulates Delaware MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Delaware MLO licenses are regulated by the Office of the State Bank Commissioner. Real estate brokers and salespersons are regulated by the Delaware Real Estate Commission. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "de_m01q02",
              prompt: "An MLO in Delaware must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "DE Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Delaware real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "de_p01",
          order: 1,
          title: "Delaware Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Delaware listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Delaware Pre-Listing Preparation",
              body: "Steps to prepare a Delaware listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Delaware-specific issues: attorney closing and corporate law\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Delaware-specific disclosure items: Delaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Delaware market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Delaware-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Delaware Market Dynamics",
              body: "Delaware's real estate market has unique characteristics:\n\nDelaware requires attorney involvement in real estate closings. Delaware has no sales tax and low property taxes, making it a business-friendly state.\n\nKey factors affecting Delaware real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nDelaware market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Delaware-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Delaware: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "de_p01q01",
              prompt: "During pre-listing due diligence for a Delaware property, an agent discovers the property may have attorney closing and corporate law issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential attorney closing and corporate law issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Delaware licensing roadmap + 99-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + attorney closing and corporate law" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Delaware purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Delaware State Housing Authority (DSHA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Delaware additions) + Delaware license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Delaware-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Delaware tax considerations + 1031 exchange + Delaware state exam review + full practice exams" }
  ],

  resources: [
    { label: "Delaware License Requirements", url: "https://www.google.com/search?q=Delaware+real+estate+license+requirements", category: "broker" },
    { label: "Delaware Real Estate Commission Website", url: "https://www.google.com/search?q=Delaware+Real+Estate+Commission+official+website", category: "broker" },
    { label: "PSI Exams — Delaware Exam", url: "https://www.google.com/search?q=PSI+Exams+Delaware+real+estate+exam", category: "broker" },
    { label: "Delaware State Housing Authority (DSHA)", url: "https://www.google.com/search?q=Delaware+State+Housing+Authority+(DSHA)+Delaware", category: "mlo" },
    { label: "Office of the State Bank Commissioner", url: "https://www.google.com/search?q=Office+of+the+State+Bank+Commissioner+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_DE;
