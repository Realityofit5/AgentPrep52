// ============================================================
// GA_curriculum.js — Georgia Real Estate Study System
// Georgia Real Estate Commission (GREC) Broker/Salesperson License — 2026
// Sources: Georgia Real Estate Commission (GREC), NMLS, PSI Exams
...
const CURRICULUM_GA = {
  ...
  meta: {
    title: "GA Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Georgia",
    stateCode: "GA",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — GA SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "GA Real Estate Salesperson/Broker",
      icon: "🍑",
      color: "#BA0C2F",
      description: "Georgia Real Estate Commission (GREC) — 75-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
      ...
      fees: [
        ...
        { item: "PSI Exams exam fee", amount: "$121", source: "PSI Exams" },
        { item: "Georgia license fee", amount: "$170", source: "Georgia Real Estate Commission (GREC)" },
      ...
      modules: [

        {
          id: "ga_b01",
          order: 1,
          title: "Licensing Process & Georgia Real Estate Commission (GREC) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Georgia licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Georgia Real Estate",
              body: "The Georgia Real Estate Commission (GREC) licenses and regulates real estate salespersons and brokers in Georgia.\n\nGeorgia requires 75 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Georgia:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nGeorgia uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 36 hours every 4 year(s)."
            },
            {
              heading: "75-Hour Pre-License Education",
              body: "Georgia requires 75 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Georgia real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Georgia\n• Georgia-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nGeorgia-specific education note: Georgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Georgia uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Georgia Real Estate Commission (GREC)\n• Submit background check results\n• Pay license fee of $170\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Georgia licenses must be renewed every 4 year(s).\n\nCE requirements: 36 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Georgia-specific law\n• Elective topics\n\nGeorgia-specific requirement: Georgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act."
            },
            {
              heading: "Georgia-Specific Real Estate Law",
              body: "Key Georgia real estate law topics:\n\nGeorgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act.\n\nAdditional Georgia-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Georgia landlord-tenant law\n• Environmental regulations specific to Georgia\n• Agency law under Georgia statutes\n\nGeorgia unique aspect — community association management: Every Georgia real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "ga_b01q01",
              prompt: "How many hours of pre-license education does Georgia require before taking the PSI Exams exam?",
              choices: [
                "37 hours",
                "75 hours",
                "112 hours",
              ...
              answer: 1,
              explanation: "Georgia requires 75 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Georgia law, agency, contracts, finance, and other required topics."
            },
            {
              id: "ga_b01q02",
              prompt: "How often must Georgia real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 4 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Georgia real estate licenses are renewed every 4 year(s). Licensees must complete 36 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "ga_b01q03",
              prompt: "Georgia's unique real estate requirement regarding community association management means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Georgia-specific rules that differ from most other states",
                "All transactions in Georgia follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand community association management"
              ],
              answer: 1,
              explanation: "Georgia's unique community association management requirement means all licensees must understand state-specific rules. Georgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act."
            },
            {
              id: "ga_b01q04",
              prompt: "The PSI Exams exam used in Georgia consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Georgia consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "ga_b01q05",
              prompt: "A new Georgia licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "ga_b02",
          order: 2,
          title: "Property Ownership & Georgia Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Georgia-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Georgia",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nGeorgia-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Georgia must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Georgia",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nGeorgia marital property rules:\nGeorgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act.\n\nHomestead protection in Georgia provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Georgia",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nGeorgia-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Georgia",
              body: "Georgia uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Georgia where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Georgia.\n\nRecording in Georgia: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Georgia follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Georgia",
              body: "Transfer of title in Georgia requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nGeorgia deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Georgia property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "ga_b02q01",
              prompt: "In Georgia, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Georgia Real Estate Commission (GREC) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Georgia are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "ga_b02q02",
              prompt: "Which deed type provides the greatest protection for a Georgia buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Georgia. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "ga_b02q03",
              prompt: "Two friends purchase a Georgia property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Georgia",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Georgia. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "ga_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Georgia, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Georgia."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Georgia. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "ga_b04q02",
              prompt: "A Georgia buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Georgia Dream Homeownership Program down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Georgia."
            },
            {
              id: "ga_b05q02",
              prompt: "A Georgia veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ga_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Georgia?",
              choices: [
...

        {
          id: "ga_b07",
          order: 7,
          title: "Fair Housing & Georgia Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Georgia-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Georgia Fair Housing Protections",
              body: "Georgia may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Georgia may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Georgia state statutes for current protected classes under Georgia fair housing law.\n\nGeorgia enforcement: File complaints with Georgia Real Estate Commission (GREC) and/or HUD within applicable time limits. Georgia Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "ga_b08",
          order: 8,
          title: "Property Management & Georgia Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Georgia landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Georgia Landlord-Tenant Basics",
              body: "Georgia landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Georgia rules:\n• Security deposit: Georgia sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Georgia requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Georgia:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Georgia",
              body: "Property managers in Georgia generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Georgia statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nGeorgia property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "ga_b08q01",
              prompt: "A Georgia landlord collects a security deposit from a tenant. Under Georgia landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Georgia must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Georgia has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "ga_b10",
          order: 10,
          title: "Georgia License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Georgia license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Georgia License Law — Key Provisions",
              body: "Georgia real estate licensees must comply with:\n\nGeorgia Real Estate Commission (GREC) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nGeorgia specific: Georgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act."
            },
            {
              heading: "Georgia Real Estate Recovery Fund",
              body: "Georgia maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Georgia's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Georgia limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Georgia\n\nGeorgia trust account rules:\n• Client funds must be deposited promptly (check Georgia specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Georgia Real Estate Commission (GREC) audit at any time"
            }
          ],
          quiz: [
            {
              id: "ga_b10q01",
              prompt: "A Georgia broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Georgia's license law and can result in license suspension or revocation."
            },
            {
              id: "ga_b10q02",
              prompt: "The Georgia Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ga_b11q02",
              prompt: "A Georgia investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Georgia state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Georgia rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Georgia state income tax on the gain (if Georgia has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "ga_b12",
          order: 12,
          title: "Georgia State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Georgia-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Georgia State Exam Key Topics",
              body: "Georgia state exam will focus on:\n\n1. Georgia license law — Georgia Real Estate Commission (GREC) rules and procedures\n2. Georgia agency law — specific state requirements\n3. Georgia contract forms and requirements\n4. Georgia disclosure laws\n5. Georgia property tax system\n6. Georgia closing procedures\n7. Georgia-specific restrictions and regulations\n8. Georgia fair housing additions\n9. Georgia landlord-tenant law\n10. Georgia environmental law\n\nGeorgia unique state exam emphasis: Georgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act.\n\nStudy strategy:\n• Review Georgia Real Estate Commission (GREC) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Georgia-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "ga_b12q01",
              prompt: "Which Georgia licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "GA MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Georgia Department of Banking and Finance state requirements",
      requirements: [
        ...
        "Sponsored by a Georgia-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Georgia state license fee", amount: "$150–$300", source: "Georgia Department of Banking and Finance" },
      ...
      modules: [
        {
          id: "ga_m01",
          order: 1,
          title: "SAFE Act & Georgia MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Georgia Department of Banking and Finance requirements, and Georgia Dream Homeownership Program programs.",
          content: [
            {
              heading: "Georgia MLO Regulation — Georgia Department of Banking and Finance",
              body: "Georgia MLOs are regulated by the Georgia Department of Banking and Finance through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Georgia must hold an active NMLS MLO license with a Georgia state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Georgia state endorsement through NMLS\n6. Obtain sponsorship from Georgia-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Georgia Dream Homeownership Program Programs",
              body: "Georgia Dream Homeownership Program provides mortgage programs for Georgia homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Georgia:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Georgia areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Georgia's state housing agency programs differentiates Georgia MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "ga_m01q01",
              prompt: "Which agency regulates Georgia MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Georgia MLO licenses are regulated by the Georgia Department of Banking and Finance. Real estate brokers and salespersons are regulated by the Georgia Real Estate Commission (GREC). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "ga_m01q02",
              prompt: "An MLO in Georgia must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "GA Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Georgia real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "ga_p01",
          order: 1,
          title: "Georgia Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Georgia listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Georgia Pre-Listing Preparation",
              body: "Steps to prepare a Georgia listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Georgia-specific issues: community association management\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Georgia-specific disclosure items: Georgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Georgia market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Georgia-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Georgia Market Dynamics",
              body: "Georgia's real estate market has unique characteristics:\n\nGeorgia requires a Community Association Manager (CAM) license for managing HOAs with more than 10 units or collecting more than $100,000. Georgia follows the Brokerage Relationships in Real Estate Transactions Act.\n\nKey factors affecting Georgia real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nGeorgia market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Georgia-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Georgia: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "ga_p01q01",
              prompt: "During pre-listing due diligence for a Georgia property, an agent discovers the property may have community association management issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential community association management issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Georgia licensing roadmap + 75-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + community association management" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Georgia purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Georgia Dream Homeownership Program programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Georgia additions) + Georgia license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Georgia-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Georgia tax considerations + 1031 exchange + Georgia state exam review + full practice exams" }
  ],

  resources: [
    { label: "Georgia License Requirements", url: "https://www.google.com/search?q=Georgia+real+estate+license+requirements", category: "broker" },
    { label: "Georgia Real Estate Commission (GREC) Website", url: "https://www.google.com/search?q=Georgia+Real+Estate+Commission+(GREC)+official+website", category: "broker" },
    { label: "PSI Exams — Georgia Exam", url: "https://www.google.com/search?q=PSI+Exams+Georgia+real+estate+exam", category: "broker" },
    { label: "Georgia Dream Homeownership Program", url: "https://www.google.com/search?q=Georgia+Dream+Homeownership+Program+Georgia", category: "mlo" },
    { label: "Georgia Department of Banking and Finance", url: "https://www.google.com/search?q=Georgia+Department+of+Banking+and+Finance+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_GA;
