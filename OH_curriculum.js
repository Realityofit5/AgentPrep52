// ============================================================
// OH_curriculum.js — Ohio Real Estate Study System
// Ohio Division of Real Estate and Professional Licensing Broker/Salesperson License — 2026
// Sources: Ohio Division of Real Estate and Professional Licensing, NMLS, PSI Exams
...
const CURRICULUM_OH = {
  ...
  meta: {
    title: "OH Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Ohio",
    stateCode: "OH",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — OH SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "OH Real Estate Salesperson/Broker",
      icon: "🌸",
      color: "#BB0000",
      description: "Ohio Division of Real Estate and Professional Licensing — 120-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Ohio broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "120-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$58", source: "PSI Exams" },
        { item: "Ohio license fee", amount: "$60", source: "Ohio Division of Real Estate and Professional Licensing" },
      ...
      modules: [

        {
          id: "oh_b01",
          order: 1,
          title: "Licensing Process & Ohio Division of Real Estate and Professional Licensing Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Ohio licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Ohio Real Estate",
              body: "The Ohio Division of Real Estate and Professional Licensing licenses and regulates real estate salespersons and brokers in Ohio.\n\nOhio requires 120 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Ohio:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nOhio uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 30 hours every 3 year(s)."
            },
            {
              heading: "120-Hour Pre-License Education",
              body: "Ohio requires 120 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Ohio real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Ohio\n• Ohio-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nOhio-specific education note: Ohio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Ohio uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Ohio Division of Real Estate and Professional Licensing\n• Submit background check results\n• Pay license fee of $60\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Ohio licenses must be renewed every 3 year(s).\n\nCE requirements: 30 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Ohio-specific law\n• Elective topics\n\nOhio-specific requirement: Ohio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate."
            },
            {
              heading: "Ohio-Specific Real Estate Law",
              body: "Key Ohio real estate law topics:\n\nOhio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate.\n\nAdditional Ohio-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Ohio landlord-tenant law\n• Environmental regulations specific to Ohio\n• Agency law under Ohio statutes\n\nOhio unique aspect — transfer on death deed and post-license requirement: Every Ohio real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "oh_b01q01",
              prompt: "How many hours of pre-license education does Ohio require before taking the PSI Exams exam?",
              choices: [
                "60 hours",
                "120 hours",
                "180 hours",
              ...
              answer: 1,
              explanation: "Ohio requires 120 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Ohio law, agency, contracts, finance, and other required topics."
            },
            {
              id: "oh_b01q02",
              prompt: "How often must Ohio real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 3 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Ohio real estate licenses are renewed every 3 year(s). Licensees must complete 30 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "oh_b01q03",
              prompt: "Ohio's unique real estate requirement regarding transfer on death deed and post-license requirement means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Ohio-specific rules that differ from most other states",
                "All transactions in Ohio follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand transfer on death deed and post-license requirement"
              ],
              answer: 1,
              explanation: "Ohio's unique transfer on death deed and post-license requirement requirement means all licensees must understand state-specific rules. Ohio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate."
            },
            {
              id: "oh_b01q04",
              prompt: "The PSI Exams exam used in Ohio consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Ohio consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "oh_b01q05",
              prompt: "A new Ohio licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "oh_b02",
          order: 2,
          title: "Property Ownership & Ohio Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Ohio-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Ohio",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nOhio-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Ohio must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Ohio",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nOhio marital property rules:\nOhio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate.\n\nHomestead protection in Ohio provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Ohio",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nOhio-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Ohio",
              body: "Ohio uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Ohio where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Ohio.\n\nRecording in Ohio: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Ohio follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Ohio",
              body: "Transfer of title in Ohio requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nOhio deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Ohio property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "oh_b02q01",
              prompt: "In Ohio, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Ohio Division of Real Estate and Professional Licensing headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Ohio are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "oh_b02q02",
              prompt: "Which deed type provides the greatest protection for a Ohio buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Ohio. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "oh_b02q03",
              prompt: "Two friends purchase a Ohio property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Ohio. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "oh_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Ohio, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Ohio."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Ohio. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "oh_b04q02",
              prompt: "A Ohio buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Ohio Housing Finance Agency (OHFA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Ohio."
            },
            {
              id: "oh_b05q02",
              prompt: "A Ohio veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "oh_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Ohio?",
              choices: [
...

        {
          id: "oh_b07",
          order: 7,
          title: "Fair Housing & Ohio Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Ohio-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Ohio Fair Housing Protections",
              body: "Ohio may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Ohio may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Ohio state statutes for current protected classes under Ohio fair housing law.\n\nOhio enforcement: File complaints with Ohio Division of Real Estate and Professional Licensing and/or HUD within applicable time limits. Ohio Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "oh_b08",
          order: 8,
          title: "Property Management & Ohio Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Ohio landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Ohio Landlord-Tenant Basics",
              body: "Ohio landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Ohio rules:\n• Security deposit: Ohio sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Ohio requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Ohio:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Ohio",
              body: "Property managers in Ohio generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Ohio statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nOhio property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "oh_b08q01",
              prompt: "A Ohio landlord collects a security deposit from a tenant. Under Ohio landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Ohio must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Ohio has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "oh_b10",
          order: 10,
          title: "Ohio License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Ohio license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Ohio License Law — Key Provisions",
              body: "Ohio real estate licensees must comply with:\n\nOhio Division of Real Estate and Professional Licensing rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nOhio specific: Ohio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate."
            },
            {
              heading: "Ohio Real Estate Recovery Fund",
              body: "Ohio maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Ohio's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Ohio limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Ohio\n\nOhio trust account rules:\n• Client funds must be deposited promptly (check Ohio specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Ohio Division of Real Estate and Professional Licensing audit at any time"
            }
          ],
          quiz: [
            {
              id: "oh_b10q01",
              prompt: "A Ohio broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Ohio's license law and can result in license suspension or revocation."
            },
            {
              id: "oh_b10q02",
              prompt: "The Ohio Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "oh_b11q02",
              prompt: "A Ohio investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Ohio state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Ohio rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Ohio state income tax on the gain (if Ohio has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "oh_b12",
          order: 12,
          title: "Ohio State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Ohio-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Ohio State Exam Key Topics",
              body: "Ohio state exam will focus on:\n\n1. Ohio license law — Ohio Division of Real Estate and Professional Licensing rules and procedures\n2. Ohio agency law — specific state requirements\n3. Ohio contract forms and requirements\n4. Ohio disclosure laws\n5. Ohio property tax system\n6. Ohio closing procedures\n7. Ohio-specific restrictions and regulations\n8. Ohio fair housing additions\n9. Ohio landlord-tenant law\n10. Ohio environmental law\n\nOhio unique state exam emphasis: Ohio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate.\n\nStudy strategy:\n• Review Ohio Division of Real Estate and Professional Licensing website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Ohio-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "oh_b12q01",
              prompt: "Which Ohio licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Ohio Division of Real Estate and Professional Licensing has the legal authority to suspend or revoke a Ohio real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "oh_b12q02",
              prompt: "A Ohio licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "OH MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Ohio Division of Financial Institutions state requirements",
      requirements: [
        ...
        "Sponsored by a Ohio-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Ohio state license fee", amount: "$150–$300", source: "Ohio Division of Financial Institutions" },
      ...
      modules: [
        {
          id: "oh_m01",
          order: 1,
          title: "SAFE Act & Ohio MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Ohio Division of Financial Institutions requirements, and Ohio Housing Finance Agency (OHFA) programs.",
          content: [
            {
              heading: "Ohio MLO Regulation — Ohio Division of Financial Institutions",
              body: "Ohio MLOs are regulated by the Ohio Division of Financial Institutions through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Ohio must hold an active NMLS MLO license with a Ohio state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Ohio state endorsement through NMLS\n6. Obtain sponsorship from Ohio-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Ohio Housing Finance Agency (OHFA) Programs",
              body: "Ohio Housing Finance Agency (OHFA) provides mortgage programs for Ohio homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Ohio:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Ohio areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Ohio's state housing agency programs differentiates Ohio MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "oh_m01q01",
              prompt: "Which agency regulates Ohio MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Ohio MLO licenses are regulated by the Ohio Division of Financial Institutions. Real estate brokers and salespersons are regulated by the Ohio Division of Real Estate and Professional Licensing. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "oh_m01q02",
              prompt: "An MLO in Ohio must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "OH Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Ohio real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "oh_p01",
          order: 1,
          title: "Ohio Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Ohio listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Ohio Pre-Listing Preparation",
              body: "Steps to prepare a Ohio listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Ohio-specific issues: transfer on death deed and post-license requirement\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Ohio-specific disclosure items: Ohio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Ohio market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Ohio-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Ohio Market Dynamics",
              body: "Ohio's real estate market has unique characteristics:\n\nOhio requires a 20-hour post-license requirement within 2 years. Ohio has a unique transfer on death deed (affidavit) that allows real property to pass to a beneficiary without probate.\n\nKey factors affecting Ohio real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nOhio market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Ohio-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Ohio: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "oh_p01q01",
              prompt: "During pre-listing due diligence for a Ohio property, an agent discovers the property may have transfer on death deed and post-license requirement issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential transfer on death deed and post-license requirement issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Ohio licensing roadmap + 120-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + transfer on death deed and post-license requirement" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Ohio purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Ohio Housing Finance Agency (OHFA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Ohio additions) + Ohio license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Ohio-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Ohio tax considerations + 1031 exchange + Ohio state exam review + full practice exams" }
  ],

  resources: [
    { label: "Ohio License Requirements", url: "https://www.google.com/search?q=Ohio+real+estate+license+requirements", category: "broker" },
    { label: "Ohio Division of Real Estate and Professional Licensing Website", url: "https://www.google.com/search?q=Ohio+Division+of+Real+Estate+and+Professional+Licensing+official+website", category: "broker" },
    { label: "PSI Exams — Ohio Exam", url: "https://www.google.com/search?q=PSI+Exams+Ohio+real+estate+exam", category: "broker" },
    { label: "Ohio Housing Finance Agency (OHFA)", url: "https://www.google.com/search?q=Ohio+Housing+Finance+Agency+(OHFA)+Ohio", category: "mlo" },
    { label: "Ohio Division of Financial Institutions", url: "https://www.google.com/search?q=Ohio+Division+of+Financial+Institutions+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_OH;
