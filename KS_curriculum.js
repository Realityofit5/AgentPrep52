// ============================================================
// KS_curriculum.js — Kansas Real Estate Study System
// Kansas Real Estate Commission (KREC) Broker/Salesperson License — 2026
// Sources: Kansas Real Estate Commission (KREC), NMLS, PSI Exams
...
const CURRICULUM_KS = {
  ...
  meta: {
    title: "KS Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Kansas",
    stateCode: "KS",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — KS SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "KS Real Estate Salesperson/Broker",
      icon: "🌻",
      color: "#0051A5",
      description: "Kansas Real Estate Commission (KREC) — 30-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        "30 hours of approved pre-license education",
        "Pass PSI Exams exam: national + state sections; 75% passing score",
        "Background check",
        "Apply within 1 year of passing exam",
        "Must be sponsored by a licensed Kansas broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "30-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$75", source: "PSI Exams" },
        { item: "Kansas license fee", amount: "$125", source: "Kansas Real Estate Commission (KREC)" },
      ...
      modules: [

        {
          id: "ks_b01",
          order: 1,
          title: "Licensing Process & Kansas Real Estate Commission (KREC) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Kansas licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Kansas Real Estate",
              body: "The Kansas Real Estate Commission (KREC) licenses and regulates real estate salespersons and brokers in Kansas.\n\nKansas requires 30 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Kansas:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nKansas uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 12 hours every 2 year(s)."
            },
            {
              heading: "30-Hour Pre-License Education",
              body: "Kansas requires 30 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Kansas real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Kansas\n• Kansas-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nKansas-specific education note: Kansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Kansas uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Kansas Real Estate Commission (KREC)\n• Submit background check results\n• Pay license fee of $125\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Kansas licenses must be renewed every 2 year(s).\n\nCE requirements: 12 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Kansas-specific law\n• Elective topics\n\nKansas-specific requirement: Kansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties."
            },
            {
              heading: "Kansas-Specific Real Estate Law",
              body: "Key Kansas real estate law topics:\n\nKansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties.\n\nAdditional Kansas-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Kansas landlord-tenant law\n• Environmental regulations specific to Kansas\n• Agency law under Kansas statutes\n\nKansas unique aspect — water rights and agricultural transactions: Every Kansas real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "ks_b01q01",
              prompt: "How many hours of pre-license education does Kansas require before taking the PSI Exams exam?",
              choices: [
                "15 hours",
                "30 hours",
                "45 hours",
              ...
              answer: 1,
              explanation: "Kansas requires 30 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Kansas law, agency, contracts, finance, and other required topics."
            },
            {
              id: "ks_b01q02",
              prompt: "How often must Kansas real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Kansas real estate licenses are renewed every 2 year(s). Licensees must complete 12 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "ks_b01q03",
              prompt: "Kansas's unique real estate requirement regarding water rights and agricultural transactions means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Kansas-specific rules that differ from most other states",
                "All transactions in Kansas follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand water rights and agricultural transactions"
              ],
              answer: 1,
              explanation: "Kansas's unique water rights and agricultural transactions requirement means all licensees must understand state-specific rules. Kansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties."
            },
            {
              id: "ks_b01q04",
              prompt: "The PSI Exams exam used in Kansas consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Kansas consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "ks_b01q05",
              prompt: "A new Kansas licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "ks_b02",
          order: 2,
          title: "Property Ownership & Kansas Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Kansas-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Kansas",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nKansas-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Kansas must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Kansas",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nKansas marital property rules:\nKansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties.\n\nHomestead protection in Kansas provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Kansas",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nKansas-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Kansas",
              body: "Kansas uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Kansas where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Kansas.\n\nRecording in Kansas: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Kansas follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Kansas",
              body: "Transfer of title in Kansas requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nKansas deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Kansas property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "ks_b02q01",
              prompt: "In Kansas, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Kansas Real Estate Commission (KREC) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Kansas are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "ks_b02q02",
              prompt: "Which deed type provides the greatest protection for a Kansas buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Kansas. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "ks_b02q03",
              prompt: "Two friends purchase a Kansas property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Kansas",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Kansas. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "ks_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Kansas, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Kansas."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Kansas. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "ks_b04q02",
              prompt: "A Kansas buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Kansas Housing Resources Corporation (KHRC) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Kansas."
            },
            {
              id: "ks_b05q02",
              prompt: "A Kansas veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ks_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Kansas?",
              choices: [
...

        {
          id: "ks_b07",
          order: 7,
          title: "Fair Housing & Kansas Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Kansas-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Kansas Fair Housing Protections",
              body: "Kansas may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Kansas may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Kansas state statutes for current protected classes under Kansas fair housing law.\n\nKansas enforcement: File complaints with Kansas Real Estate Commission (KREC) and/or HUD within applicable time limits. Kansas Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "ks_b08",
          order: 8,
          title: "Property Management & Kansas Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Kansas landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Kansas Landlord-Tenant Basics",
              body: "Kansas landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Kansas rules:\n• Security deposit: Kansas sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Kansas requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Kansas:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Kansas",
              body: "Property managers in Kansas generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Kansas statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nKansas property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "ks_b08q01",
              prompt: "A Kansas landlord collects a security deposit from a tenant. Under Kansas landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Kansas must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Kansas has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "ks_b10",
          order: 10,
          title: "Kansas License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Kansas license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Kansas License Law — Key Provisions",
              body: "Kansas real estate licensees must comply with:\n\nKansas Real Estate Commission (KREC) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nKansas specific: Kansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties."
            },
            {
              heading: "Kansas Real Estate Recovery Fund",
              body: "Kansas maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Kansas's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Kansas limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Kansas\n\nKansas trust account rules:\n• Client funds must be deposited promptly (check Kansas specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Kansas Real Estate Commission (KREC) audit at any time"
            }
          ],
          quiz: [
            {
              id: "ks_b10q01",
              prompt: "A Kansas broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Kansas's license law and can result in license suspension or revocation."
            },
            {
              id: "ks_b10q02",
              prompt: "The Kansas Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ks_b11q02",
              prompt: "A Kansas investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Kansas state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Kansas rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Kansas state income tax on the gain (if Kansas has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "ks_b12",
          order: 12,
          title: "Kansas State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Kansas-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Kansas State Exam Key Topics",
              body: "Kansas state exam will focus on:\n\n1. Kansas license law — Kansas Real Estate Commission (KREC) rules and procedures\n2. Kansas agency law — specific state requirements\n3. Kansas contract forms and requirements\n4. Kansas disclosure laws\n5. Kansas property tax system\n6. Kansas closing procedures\n7. Kansas-specific restrictions and regulations\n8. Kansas fair housing additions\n9. Kansas landlord-tenant law\n10. Kansas environmental law\n\nKansas unique state exam emphasis: Kansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties.\n\nStudy strategy:\n• Review Kansas Real Estate Commission (KREC) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Kansas-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "ks_b12q01",
              prompt: "Which Kansas licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Kansas Real Estate Commission (KREC) has the legal authority to suspend or revoke a Kansas real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "ks_b12q02",
              prompt: "A Kansas licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      ...
      requirements: [
        ...
        "Sponsored by a Kansas-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Kansas state license fee", amount: "$150–$300", source: "Office of the State Bank Commissioner" },
      ...
      modules: [
        {
          id: "ks_m01",
          order: 1,
          title: "SAFE Act & Kansas MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Office of the State Bank Commissioner requirements, and Kansas Housing Resources Corporation (KHRC) programs.",
          content: [
            {
              heading: "Kansas MLO Regulation — Office of the State Bank Commissioner",
              body: "Kansas MLOs are regulated by the Office of the State Bank Commissioner through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Kansas must hold an active NMLS MLO license with a Kansas state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Kansas state endorsement through NMLS\n6. Obtain sponsorship from Kansas-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Kansas Housing Resources Corporation (KHRC) Programs",
              body: "Kansas Housing Resources Corporation (KHRC) provides mortgage programs for Kansas homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Kansas:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Kansas areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Kansas's state housing agency programs differentiates Kansas MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "ks_m01q01",
              prompt: "Which agency regulates Kansas MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Kansas MLO licenses are regulated by the Office of the State Bank Commissioner. Real estate brokers and salespersons are regulated by the Kansas Real Estate Commission (KREC). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "ks_m01q02",
              prompt: "An MLO in Kansas must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "KS Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Kansas real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "ks_p01",
          order: 1,
          title: "Kansas Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Kansas listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Kansas Pre-Listing Preparation",
              body: "Steps to prepare a Kansas listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Kansas-specific issues: water rights and agricultural transactions\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Kansas-specific disclosure items: Kansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Kansas market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Kansas-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Kansas Market Dynamics",
              body: "Kansas's real estate market has unique characteristics:\n\nKansas has minimal pre-license requirements (only 30 hours) but requires specific Kansas law content. Kansas follows the prior appropriation water rights doctrine for agricultural properties.\n\nKey factors affecting Kansas real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nKansas market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Kansas-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Kansas: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "ks_p01q01",
              prompt: "During pre-listing due diligence for a Kansas property, an agent discovers the property may have water rights and agricultural transactions issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential water rights and agricultural transactions issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Kansas licensing roadmap + 30-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + water rights and agricultural transactions" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Kansas purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Kansas Housing Resources Corporation (KHRC) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Kansas additions) + Kansas license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Kansas-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Kansas tax considerations + 1031 exchange + Kansas state exam review + full practice exams" }
  ],

  resources: [
    { label: "Kansas License Requirements", url: "https://www.google.com/search?q=Kansas+real+estate+license+requirements", category: "broker" },
    { label: "Kansas Real Estate Commission (KREC) Website", url: "https://www.google.com/search?q=Kansas+Real+Estate+Commission+(KREC)+official+website", category: "broker" },
    { label: "PSI Exams — Kansas Exam", url: "https://www.google.com/search?q=PSI+Exams+Kansas+real+estate+exam", category: "broker" },
    { label: "Kansas Housing Resources Corporation (KHRC)", url: "https://www.google.com/search?q=Kansas+Housing+Resources+Corporation+(KHRC)+Kansas", category: "mlo" },
...
if (typeof module !== 'undefined') module.exports = CURRICULUM_KS;
