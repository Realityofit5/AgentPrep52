// ============================================================
// NH_curriculum.js — New Hampshire Real Estate Study System
// New Hampshire Real Estate Commission Broker/Salesperson License — 2026
// Sources: New Hampshire Real Estate Commission, NMLS, PSI Exams
...
const CURRICULUM_NH = {
  ...
  meta: {
    title: "NH Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "New Hampshire",
    stateCode: "NH",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — NH SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "NH Real Estate Salesperson/Broker",
      icon: "🍂",
      color: "#003087",
      description: "New Hampshire Real Estate Commission — 40-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        "40 hours of approved pre-license education",
        "Pass PSI Exams exam: national + state sections; 75% passing score",
        "Background check",
        "Apply within 1 year of passing exam",
        "Must be sponsored by a licensed New Hampshire broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "40-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$75", source: "PSI Exams" },
        { item: "New Hampshire license fee", amount: "$130", source: "New Hampshire Real Estate Commission" },
      ...
      modules: [

        {
          id: "nh_b01",
          order: 1,
          title: "Licensing Process & New Hampshire Real Estate Commission Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete New Hampshire licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates New Hampshire Real Estate",
              body: "The New Hampshire Real Estate Commission licenses and regulates real estate salespersons and brokers in New Hampshire.\n\nNew Hampshire requires 40 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in New Hampshire:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nNew Hampshire uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 15 hours every 3 year(s)."
            },
            {
              heading: "40-Hour Pre-License Education",
              body: "New Hampshire requires 40 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• New Hampshire real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in New Hampshire\n• New Hampshire-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nNew Hampshire-specific education note: New Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "New Hampshire uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to New Hampshire Real Estate Commission\n• Submit background check results\n• Pay license fee of $130\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "New Hampshire licenses must be renewed every 3 year(s).\n\nCE requirements: 15 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• New Hampshire-specific law\n• Elective topics\n\nNew Hampshire-specific requirement: New Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties."
            },
            {
              heading: "New Hampshire-Specific Real Estate Law",
              body: "Key New Hampshire real estate law topics:\n\nNew Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties.\n\nAdditional New Hampshire-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• New Hampshire landlord-tenant law\n• Environmental regulations specific to New Hampshire\n• Agency law under New Hampshire statutes\n\nNew Hampshire unique aspect — no income/sales tax and waterfront disclosure: Every New Hampshire real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "nh_b01q01",
              prompt: "How many hours of pre-license education does New Hampshire require before taking the PSI Exams exam?",
              choices: [
                "20 hours",
                "40 hours",
                "60 hours",
              ...
              answer: 1,
              explanation: "New Hampshire requires 40 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, New Hampshire law, agency, contracts, finance, and other required topics."
            },
            {
              id: "nh_b01q02",
              prompt: "How often must New Hampshire real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 3 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "New Hampshire real estate licenses are renewed every 3 year(s). Licensees must complete 15 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "nh_b01q03",
              prompt: "New Hampshire's unique real estate requirement regarding no income/sales tax and waterfront disclosure means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply New Hampshire-specific rules that differ from most other states",
                "All transactions in New Hampshire follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand no income/sales tax and waterfront disclosure"
              ],
              answer: 1,
              explanation: "New Hampshire's unique no income/sales tax and waterfront disclosure requirement means all licensees must understand state-specific rules. New Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties."
            },
            {
              id: "nh_b01q04",
              prompt: "The PSI Exams exam used in New Hampshire consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in New Hampshire consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "nh_b01q05",
              prompt: "A new New Hampshire licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "nh_b02",
          order: 2,
          title: "Property Ownership & New Hampshire Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and New Hampshire-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in New Hampshire",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nNew Hampshire-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in New Hampshire must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in New Hampshire",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nNew Hampshire marital property rules:\nNew Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties.\n\nHomestead protection in New Hampshire provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in New Hampshire",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nNew Hampshire-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in New Hampshire",
              body: "New Hampshire uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of New Hampshire where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout New Hampshire.\n\nRecording in New Hampshire: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. New Hampshire follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in New Hampshire",
              body: "Transfer of title in New Hampshire requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nNew Hampshire deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all New Hampshire property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "nh_b02q01",
              prompt: "In New Hampshire, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "New Hampshire Real Estate Commission headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in New Hampshire are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "nh_b02q02",
              prompt: "Which deed type provides the greatest protection for a New Hampshire buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in New Hampshire. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "nh_b02q03",
              prompt: "Two friends purchase a New Hampshire property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of New Hampshire",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in New Hampshire. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "nh_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in New Hampshire, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in New Hampshire."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including New Hampshire. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "nh_b04q02",
              prompt: "A New Hampshire buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
...

        {
          id: "nh_b05",
          order: 5,
          title: "Real Estate Finance & New Hampshire Mortgage Programs",
          week: "5-6",
          passingScore: 75,
          icon: "💰",
          objective: "Explain New Hampshire financing options, New Hampshire Housing Finance Authority (NHHFA) programs, and key federal mortgage regulations.",
          content: [
            {
              heading: "New Hampshire Housing Finance Authority (NHHFA) Programs",
              body: "New Hampshire Housing Finance Authority (NHHFA) provides affordable homeownership programs for New Hampshire residents:\n\nFirst-time homebuyer programs:\n• Below-market interest rate first mortgages\n• Income and purchase price limits apply (vary by county)\n• Must be primary residence\n\nDown payment assistance:\n• Grants or second mortgages for down payment and closing costs\n• Some programs forgivable after period of occupancy\n\nSpecial programs:\n• Veterans/military programs\n• Low-income and workforce housing programs\n• Renovation and rehabilitation loan programs\n\nMLO value in New Hampshire: understanding New Hampshire Housing Finance Authority (NHHFA) programs is essential as many New Hampshire first-time buyers use state housing agency financing."
            },
            {
              heading: "Federal Loan Programs in New Hampshire",
              body: "Federal loan programs important in New Hampshire:\n\nFHA Loans:\n• 3.5% down payment (with 580+ credit score)\n• MIP (mortgage insurance premium) required\n• Property must meet FHA minimum property standards\n• Common for first-time buyers in New Hampshire\n\nVA Loans:\n• 0% down for eligible veterans and active military\n• No PMI required\n• Funding fee applies (waived for disabled veterans)\n• New Hampshire military presence: check local military installations\n\nUSDA Rural Development:\n• 0% down for eligible rural properties\n• Income limits apply\n• Many New Hampshire rural areas may qualify\n\nConventional/Fannie Mae-Freddie Mac:\n• Dominant in New Hampshire's mortgage market\n• 3-20% down depending on program\n• Conforming loan limits vary by county"
            },
            {
              heading: "Deed of Trust vs. Mortgage in New Hampshire",
              body: "Most states use either mortgages or deeds of trust as the security instrument for home loans.\n\nMortgage (two-party instrument):\n• Borrower (mortgagor) and lender (mortgagee)\n• Lender must use judicial foreclosure — court process\n• Generally slower and more expensive process\n• Borrower typically has right of redemption after foreclosure sale\n\nDeed of Trust (three-party instrument):\n• Trustor (borrower), trustee (holds legal title), beneficiary (lender)\n• Allows non-judicial (trustee's sale) foreclosure — faster and cheaper\n• Redemption rights vary; many deed of trust states have no redemption period\n\nNew Hampshire uses: check New Hampshire statutes to determine whether New Hampshire primarily uses mortgages or deeds of trust, and what the foreclosure process entails."
            }
          ],
          quiz: [
            {
              id: "nh_b05q01",
              prompt: "The New Hampshire Housing Finance Authority (NHHFA) provides down payment assistance to New Hampshire homebuyers primarily to:",
              choices: [
              ...
              answer: 0,
              explanation: "New Hampshire Housing Finance Authority (NHHFA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in New Hampshire."
            },
            {
              id: "nh_b05q02",
              prompt: "A New Hampshire veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "nh_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in New Hampshire?",
              choices: [
...

        {
          id: "nh_b07",
          order: 7,
          title: "Fair Housing & New Hampshire Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and New Hampshire-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "New Hampshire Fair Housing Protections",
              body: "New Hampshire may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in New Hampshire may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck New Hampshire state statutes for current protected classes under New Hampshire fair housing law.\n\nNew Hampshire enforcement: File complaints with New Hampshire Real Estate Commission and/or HUD within applicable time limits. New Hampshire Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "nh_b08",
          order: 8,
          title: "Property Management & New Hampshire Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply New Hampshire landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "New Hampshire Landlord-Tenant Basics",
              body: "New Hampshire landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey New Hampshire rules:\n• Security deposit: New Hampshire sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: New Hampshire requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in New Hampshire:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in New Hampshire",
              body: "Property managers in New Hampshire generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck New Hampshire statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nNew Hampshire property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "nh_b08q01",
              prompt: "A New Hampshire landlord collects a security deposit from a tenant. Under New Hampshire landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in New Hampshire must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. New Hampshire has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "nh_b10",
          order: 10,
          title: "New Hampshire License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply New Hampshire license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "New Hampshire License Law — Key Provisions",
              body: "New Hampshire real estate licensees must comply with:\n\nNew Hampshire Real Estate Commission rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nNew Hampshire specific: New Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties."
            },
            {
              heading: "New Hampshire Real Estate Recovery Fund",
              body: "New Hampshire maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of New Hampshire's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current New Hampshire limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in New Hampshire\n\nNew Hampshire trust account rules:\n• Client funds must be deposited promptly (check New Hampshire specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to New Hampshire Real Estate Commission audit at any time"
            }
          ],
          quiz: [
            {
              id: "nh_b10q01",
              prompt: "A New Hampshire broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of New Hampshire's license law and can result in license suspension or revocation."
            },
            {
              id: "nh_b10q02",
              prompt: "The New Hampshire Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "nh_b11q02",
              prompt: "A New Hampshire investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, New Hampshire state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a New Hampshire rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) New Hampshire state income tax on the gain (if New Hampshire has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "nh_b12",
          order: 12,
          title: "New Hampshire State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review New Hampshire-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "New Hampshire State Exam Key Topics",
              body: "New Hampshire state exam will focus on:\n\n1. New Hampshire license law — New Hampshire Real Estate Commission rules and procedures\n2. New Hampshire agency law — specific state requirements\n3. New Hampshire contract forms and requirements\n4. New Hampshire disclosure laws\n5. New Hampshire property tax system\n6. New Hampshire closing procedures\n7. New Hampshire-specific restrictions and regulations\n8. New Hampshire fair housing additions\n9. New Hampshire landlord-tenant law\n10. New Hampshire environmental law\n\nNew Hampshire unique state exam emphasis: New Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties.\n\nStudy strategy:\n• Review New Hampshire Real Estate Commission website for current rules and statutes\n• Take multiple practice state exams\n• Focus on New Hampshire-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "nh_b12q01",
              prompt: "Which New Hampshire licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the New Hampshire Real Estate Commission has the legal authority to suspend or revoke a New Hampshire real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "nh_b12q02",
              prompt: "A New Hampshire licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "NH MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + New Hampshire Banking Department state requirements",
      requirements: [
        ...
        "Sponsored by a New Hampshire-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "New Hampshire state license fee", amount: "$150–$300", source: "New Hampshire Banking Department" },
      ...
      modules: [
        {
          id: "nh_m01",
          order: 1,
          title: "SAFE Act & New Hampshire MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, New Hampshire Banking Department requirements, and New Hampshire Housing Finance Authority (NHHFA) programs.",
          content: [
            {
              heading: "New Hampshire MLO Regulation — New Hampshire Banking Department",
              body: "New Hampshire MLOs are regulated by the New Hampshire Banking Department through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in New Hampshire must hold an active NMLS MLO license with a New Hampshire state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for New Hampshire state endorsement through NMLS\n6. Obtain sponsorship from New Hampshire-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "New Hampshire Housing Finance Authority (NHHFA) Programs",
              body: "New Hampshire Housing Finance Authority (NHHFA) provides mortgage programs for New Hampshire homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in New Hampshire:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural New Hampshire areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing New Hampshire's state housing agency programs differentiates New Hampshire MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "nh_m01q01",
              prompt: "Which agency regulates New Hampshire MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "New Hampshire MLO licenses are regulated by the New Hampshire Banking Department. Real estate brokers and salespersons are regulated by the New Hampshire Real Estate Commission. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "nh_m01q02",
              prompt: "An MLO in New Hampshire must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "NH Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "New Hampshire real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
        "Complete broker pre-license education",
        "Pass PSI Exams exam",
        "Active New Hampshire license",
      ...
      modules: [
        {
          id: "nh_p01",
          order: 1,
          title: "New Hampshire Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master New Hampshire listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "New Hampshire Pre-Listing Preparation",
              body: "Steps to prepare a New Hampshire listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research New Hampshire-specific issues: no income/sales tax and waterfront disclosure\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• New Hampshire-specific disclosure items: New Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider New Hampshire market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• New Hampshire-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "New Hampshire Market Dynamics",
              body: "New Hampshire's real estate market has unique characteristics:\n\nNew Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties.\n\nKey factors affecting New Hampshire real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nNew Hampshire market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• New Hampshire-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in New Hampshire: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "nh_p01q01",
              prompt: "During pre-listing due diligence for a New Hampshire property, an agent discovers the property may have no income/sales tax and waterfront disclosure issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential no income/sales tax and waterfront disclosure issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "nh_p02",
          order: 2,
          title: "New Hampshire Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute New Hampshire buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "New Hampshire buyer representation process:\n\n1. Initial consultation:\n• Explain New Hampshire brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and New Hampshire Housing Finance Authority (NHHFA) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use New Hampshire MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on New Hampshire-specific considerations: no income/sales tax and waterfront disclosure\n\n4. Making offers:\n• Explain New Hampshire purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of New Hampshire investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nNew Hampshire investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nNew Hampshire specific: no income/sales tax and waterfront disclosure considerations for investment buyers in New Hampshire."
            }
          ],
          quiz: [
            {
              id: "nh_p02q01",
              prompt: "A New Hampshire investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
...

        {
          id: "nh_p03",
          order: 3,
          title: "New Hampshire Closing Process & RESPA Compliance",
          week: "9-12",
          passingScore: 70,
          icon: "🎯",
          objective: "Navigate New Hampshire closing procedures, RESPA compliance, and build ethical referral networks.",
          content: [
            {
              heading: "New Hampshire Closing Procedures",
              body: "The New Hampshire closing process:\n\n1. Pre-closing preparation:\n• Title company/attorney orders title search and issues commitment\n• Lender completes underwriting; issues clear to close\n• Closing disclosure prepared and delivered 3 business days before closing\n• Final walk-through by buyer\n\n2. Closing day:\n• Buyer and seller (or their representatives) attend closing\n• Sign all documents (deed, mortgage, closing disclosure, etc.)\n• Funds deposited and disbursed\n• Deed and mortgage recorded\n• Keys transferred\n\n3. Post-closing:\n• Confirm recording\n• Distribute closing packages to all parties\n• Upload documents to transaction management system\n• Collect commission\n\nNew Hampshire closing practice: New Hampshire has no state income tax or sales tax. New Hampshire requires attorneys to perform closings in many circumstances. New Hampshire has specific disclosure requirements for wells, septic systems, and waterfront properties."
            },
            {
              heading: "RESPA Compliance in New Hampshire",
              body: "RESPA Section 8 compliance in New Hampshire real estate:\n\nILLEGAL:\n• Title company paying for agent's marketing in exchange for referrals\n• Lender sponsoring office expenses for mortgage referrals\n• Any payment in exchange for settlement service referrals\n• Marketing services agreements that function as referral fees\n\nLEGAL:\n• Genuine affiliated business arrangements (AfBA) with proper disclosure\n• Actual services for actual compensation\n• Educational co-marketing (properly structured)\n• Normal business development activities\n\nNew Hampshire specific: small markets may create pressure for informal quid pro quo arrangements. Agents must be vigilant that referral relationships don't cross RESPA lines regardless of market size."
            }
          ],
          quiz: [
            {
              id: "nh_p03q01",
              prompt: "A New Hampshire title company offers to pay for a real estate agent's E&O insurance in exchange for referring all closings to the title company. Under RESPA, this arrangement is:",
              choices: [
  ...
  studyPlan: [
    { weeks: "1-2", focus: "New Hampshire licensing roadmap + 40-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + no income/sales tax and waterfront disclosure" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + New Hampshire purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + New Hampshire Housing Finance Authority (NHHFA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (New Hampshire additions) + New Hampshire license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + New Hampshire-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + New Hampshire tax considerations + 1031 exchange + New Hampshire state exam review + full practice exams" }
  ],

  resources: [
    { label: "New Hampshire License Requirements", url: "https://www.google.com/search?q=New+Hampshire+real+estate+license+requirements", category: "broker" },
    { label: "New Hampshire Real Estate Commission Website", url: "https://www.google.com/search?q=New+Hampshire+Real+Estate+Commission+official+website", category: "broker" },
    { label: "PSI Exams — New Hampshire Exam", url: "https://www.google.com/search?q=PSI+Exams+New+Hampshire+real+estate+exam", category: "broker" },
    { label: "New Hampshire Housing Finance Authority (NHHFA)", url: "https://www.google.com/search?q=New+Hampshire+Housing+Finance+Authority+(NHHFA)+New+Hampshire", category: "mlo" },
    { label: "New Hampshire Banking Department", url: "https://www.google.com/search?q=New+Hampshire+Banking+Department+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_NH;
