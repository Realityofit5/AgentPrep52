// ============================================================
// NM_curriculum.js — New Mexico Real Estate Study System
// New Mexico Real Estate Commission (NMREC) Broker/Salesperson License — 2026
// Sources: New Mexico Real Estate Commission (NMREC), NMLS, PSI Exams
...
const CURRICULUM_NM = {
  ...
  meta: {
    title: "NM Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "New Mexico",
    stateCode: "NM",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — NM SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "NM Real Estate Salesperson/Broker",
      icon: "🌵",
      color: "#003580",
      description: "New Mexico Real Estate Commission (NMREC) — 90-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed New Mexico broker",
      ...
      fees: [
        ...
        { item: "New Mexico license fee", amount: "$270", source: "New Mexico Real Estate Commission (NMREC)" },
      ...
      modules: [

        {
          id: "nm_b01",
          order: 1,
          title: "Licensing Process & New Mexico Real Estate Commission (NMREC) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete New Mexico licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates New Mexico Real Estate",
              body: "The New Mexico Real Estate Commission (NMREC) licenses and regulates real estate salespersons and brokers in New Mexico.\n\nNew Mexico requires 90 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in New Mexico:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nNew Mexico uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 36 hours every 3 year(s)."
            },
            {
              heading: "90-Hour Pre-License Education",
              body: "New Mexico requires 90 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• New Mexico real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in New Mexico\n• New Mexico-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nNew Mexico-specific education note: New Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "New Mexico uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to New Mexico Real Estate Commission (NMREC)\n• Submit background check results\n• Pay license fee of $270\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "New Mexico licenses must be renewed every 3 year(s).\n\nCE requirements: 36 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• New Mexico-specific law\n• Elective topics\n\nNew Mexico-specific requirement: New Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas."
            },
            {
              heading: "New Mexico-Specific Real Estate Law",
              body: "Key New Mexico real estate law topics:\n\nNew Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas.\n\nAdditional New Mexico-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• New Mexico landlord-tenant law\n• Environmental regulations specific to New Mexico\n• Agency law under New Mexico statutes\n\nNew Mexico unique aspect — community property, acequias, and pueblo land grants: Every New Mexico real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "nm_b01q01",
              prompt: "How many hours of pre-license education does New Mexico require before taking the PSI Exams exam?",
              choices: [
                "45 hours",
                "90 hours",
                "135 hours",
              ...
              answer: 1,
              explanation: "New Mexico requires 90 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, New Mexico law, agency, contracts, finance, and other required topics."
            },
            {
              id: "nm_b01q02",
              prompt: "How often must New Mexico real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 3 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "New Mexico real estate licenses are renewed every 3 year(s). Licensees must complete 36 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "nm_b01q03",
              prompt: "New Mexico's unique real estate requirement regarding community property, acequias, and pueblo land grants means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply New Mexico-specific rules that differ from most other states",
                "All transactions in New Mexico follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand community property, acequias, and pueblo land grants"
              ],
              answer: 1,
              explanation: "New Mexico's unique community property, acequias, and pueblo land grants requirement means all licensees must understand state-specific rules. New Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas."
            },
            {
              id: "nm_b01q04",
              prompt: "The PSI Exams exam used in New Mexico consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in New Mexico consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "nm_b01q05",
              prompt: "A new New Mexico licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "nm_b02",
          order: 2,
          title: "Property Ownership & New Mexico Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and New Mexico-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in New Mexico",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nNew Mexico-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in New Mexico must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in New Mexico",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nNew Mexico marital property rules:\nNew Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas.\n\nHomestead protection in New Mexico provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in New Mexico",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nNew Mexico-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in New Mexico",
              body: "New Mexico uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of New Mexico where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout New Mexico.\n\nRecording in New Mexico: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. New Mexico follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in New Mexico",
              body: "Transfer of title in New Mexico requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nNew Mexico deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all New Mexico property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "nm_b02q01",
              prompt: "In New Mexico, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "New Mexico Real Estate Commission (NMREC) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in New Mexico are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "nm_b02q02",
              prompt: "Which deed type provides the greatest protection for a New Mexico buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in New Mexico. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "nm_b02q03",
              prompt: "Two friends purchase a New Mexico property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of New Mexico",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in New Mexico. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "nm_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in New Mexico, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in New Mexico."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including New Mexico. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "nm_b04q02",
              prompt: "A New Mexico buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "New Mexico Mortgage Finance Authority (MFA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in New Mexico."
            },
            {
              id: "nm_b05q02",
              prompt: "A New Mexico veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "nm_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in New Mexico?",
              choices: [
...

        {
          id: "nm_b07",
          order: 7,
          title: "Fair Housing & New Mexico Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and New Mexico-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "New Mexico Fair Housing Protections",
              body: "New Mexico may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in New Mexico may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck New Mexico state statutes for current protected classes under New Mexico fair housing law.\n\nNew Mexico enforcement: File complaints with New Mexico Real Estate Commission (NMREC) and/or HUD within applicable time limits. New Mexico Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "nm_b08",
          order: 8,
          title: "Property Management & New Mexico Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply New Mexico landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "New Mexico Landlord-Tenant Basics",
              body: "New Mexico landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey New Mexico rules:\n• Security deposit: New Mexico sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: New Mexico requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in New Mexico:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in New Mexico",
              body: "Property managers in New Mexico generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck New Mexico statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nNew Mexico property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "nm_b08q01",
              prompt: "A New Mexico landlord collects a security deposit from a tenant. Under New Mexico landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in New Mexico must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. New Mexico has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "nm_b10",
          order: 10,
          title: "New Mexico License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply New Mexico license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "New Mexico License Law — Key Provisions",
              body: "New Mexico real estate licensees must comply with:\n\nNew Mexico Real Estate Commission (NMREC) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nNew Mexico specific: New Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas."
            },
            {
              heading: "New Mexico Real Estate Recovery Fund",
              body: "New Mexico maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of New Mexico's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current New Mexico limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in New Mexico\n\nNew Mexico trust account rules:\n• Client funds must be deposited promptly (check New Mexico specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to New Mexico Real Estate Commission (NMREC) audit at any time"
            }
          ],
          quiz: [
            {
              id: "nm_b10q01",
              prompt: "A New Mexico broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of New Mexico's license law and can result in license suspension or revocation."
            },
            {
              id: "nm_b10q02",
              prompt: "The New Mexico Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "nm_b11q02",
              prompt: "A New Mexico investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, New Mexico state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a New Mexico rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) New Mexico state income tax on the gain (if New Mexico has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "nm_b12",
          order: 12,
          title: "New Mexico State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review New Mexico-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "New Mexico State Exam Key Topics",
              body: "New Mexico state exam will focus on:\n\n1. New Mexico license law — New Mexico Real Estate Commission (NMREC) rules and procedures\n2. New Mexico agency law — specific state requirements\n3. New Mexico contract forms and requirements\n4. New Mexico disclosure laws\n5. New Mexico property tax system\n6. New Mexico closing procedures\n7. New Mexico-specific restrictions and regulations\n8. New Mexico fair housing additions\n9. New Mexico landlord-tenant law\n10. New Mexico environmental law\n\nNew Mexico unique state exam emphasis: New Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas.\n\nStudy strategy:\n• Review New Mexico Real Estate Commission (NMREC) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on New Mexico-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "nm_b12q01",
              prompt: "Which New Mexico licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
                "The National Association of Realtors (NAR)",
                "The New Mexico Real Estate Commission (NMREC)",
                "The federal Department of Housing and Urban Development (HUD)",
                "The local Multiple Listing Service (MLS)"
              ],
              answer: 1,
              explanation: "Only the New Mexico Real Estate Commission (NMREC) has the legal authority to suspend or revoke a New Mexico real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "nm_b12q02",
              prompt: "A New Mexico licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "NM MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + New Mexico Financial Institutions Division state requirements",
      requirements: [
        ...
        "Sponsored by a New Mexico-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "New Mexico state license fee", amount: "$150–$300", source: "New Mexico Financial Institutions Division" },
      ...
      modules: [
        {
          id: "nm_m01",
          order: 1,
          title: "SAFE Act & New Mexico MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, New Mexico Financial Institutions Division requirements, and New Mexico Mortgage Finance Authority (MFA) programs.",
          content: [
            {
              heading: "New Mexico MLO Regulation — New Mexico Financial Institutions Division",
              body: "New Mexico MLOs are regulated by the New Mexico Financial Institutions Division through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in New Mexico must hold an active NMLS MLO license with a New Mexico state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for New Mexico state endorsement through NMLS\n6. Obtain sponsorship from New Mexico-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "New Mexico Mortgage Finance Authority (MFA) Programs",
              body: "New Mexico Mortgage Finance Authority (MFA) provides mortgage programs for New Mexico homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in New Mexico:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural New Mexico areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing New Mexico's state housing agency programs differentiates New Mexico MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "nm_m01q01",
              prompt: "Which agency regulates New Mexico MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "New Mexico MLO licenses are regulated by the New Mexico Financial Institutions Division. Real estate brokers and salespersons are regulated by the New Mexico Real Estate Commission (NMREC). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "nm_m01q02",
              prompt: "An MLO in New Mexico must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "NM Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "New Mexico real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "nm_p01",
          order: 1,
          title: "New Mexico Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master New Mexico listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "New Mexico Pre-Listing Preparation",
              body: "Steps to prepare a New Mexico listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research New Mexico-specific issues: community property, acequias, and pueblo land grants\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• New Mexico-specific disclosure items: New Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider New Mexico market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• New Mexico-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "New Mexico Market Dynamics",
              body: "New Mexico's real estate market has unique characteristics:\n\nNew Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas.\n\nKey factors affecting New Mexico real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nNew Mexico market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• New Mexico-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in New Mexico: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "nm_p01q01",
              prompt: "During pre-listing due diligence for a New Mexico property, an agent discovers the property may have community property, acequias, and pueblo land grants issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential community property, acequias, and pueblo land grants issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },

        {
          id: "nm_p02",
          order: 2,
          title: "New Mexico Buyer Representation",
          week: "5-8",
          passingScore: 70,
          icon: "🤝",
          objective: "Execute New Mexico buyer representation from initial consultation through successful closing.",
          content: [
            {
              heading: "Buyer Consultation and Agency Agreement",
              body: "New Mexico buyer representation process:\n\n1. Initial consultation:\n• Explain New Mexico brokerage relationships and agency options\n• Discuss buyer needs, timeline, and budget\n• Sign buyer agency or transaction broker agreement\n• Explain compensation structure (post-NAR settlement changes)\n\n2. Pre-approval:\n• Connect buyer with mortgage professionals\n• Understand CHFA and New Mexico Mortgage Finance Authority (MFA) programs for qualifying buyers\n• Assess budget including down payment, closing costs, and ongoing expenses\n\n3. Property search:\n• Use New Mexico MLS systems\n• Research neighborhoods: schools, safety, amenities, commute\n• Educate buyer on New Mexico-specific considerations: community property, acequias, and pueblo land grants\n\n4. Making offers:\n• Explain New Mexico purchase contract terms\n• Discuss contingencies: inspection, financing, appraisal\n• Strategic advice on pricing and terms\n• Coordinate inspection and due diligence\n• Manage timeline to closing"
            },
            {
              heading: "Investment Property Buyer Representation",
              body: "Representing buyers of New Mexico investment properties:\n\nInvestment analysis tools:\n• NOI (Net Operating Income) = Gross Rents - Vacancy - Expenses\n• Cap Rate = NOI ÷ Value\n• Cash-on-Cash = Annual Cash Flow ÷ Cash Invested\n• GRM = Price ÷ Annual Gross Rent\n\nNew Mexico investment property considerations:\n• Local cap rates for different property types\n• Rent trends and vacancy rates\n• Property tax impact on cash flow\n• Landlord-tenant law compliance costs\n• Property management availability and costs\n\nNew Mexico specific: community property, acequias, and pueblo land grants considerations for investment buyers in New Mexico."
            }
          ],
          quiz: [
            {
              id: "nm_p02q01",
              prompt: "A New Mexico investor is analyzing a property with $4,000 monthly gross rent. After 7% vacancy and $18,000 annual expenses, what is the NOI?",
...

        {
          id: "nm_p03",
          order: 3,
          title: "New Mexico Closing Process & RESPA Compliance",
          week: "9-12",
          passingScore: 70,
          icon: "🎯",
          objective: "Navigate New Mexico closing procedures, RESPA compliance, and build ethical referral networks.",
          content: [
            {
              heading: "New Mexico Closing Procedures",
              body: "The New Mexico closing process:\n\n1. Pre-closing preparation:\n• Title company/attorney orders title search and issues commitment\n• Lender completes underwriting; issues clear to close\n• Closing disclosure prepared and delivered 3 business days before closing\n• Final walk-through by buyer\n\n2. Closing day:\n• Buyer and seller (or their representatives) attend closing\n• Sign all documents (deed, mortgage, closing disclosure, etc.)\n• Funds deposited and disbursed\n• Deed and mortgage recorded\n• Keys transferred\n\n3. Post-closing:\n• Confirm recording\n• Distribute closing packages to all parties\n• Upload documents to transaction management system\n• Collect commission\n\nNew Mexico closing practice: New Mexico follows community property law. New Mexico has unique issues with acequia water rights (traditional Hispanic irrigation systems) and pueblo land grants, with many properties bordering or within Native American land trust areas."
            },
            {
              heading: "RESPA Compliance in New Mexico",
              body: "RESPA Section 8 compliance in New Mexico real estate:\n\nILLEGAL:\n• Title company paying for agent's marketing in exchange for referrals\n• Lender sponsoring office expenses for mortgage referrals\n• Any payment in exchange for settlement service referrals\n• Marketing services agreements that function as referral fees\n\nLEGAL:\n• Genuine affiliated business arrangements (AfBA) with proper disclosure\n• Actual services for actual compensation\n• Educational co-marketing (properly structured)\n• Normal business development activities\n\nNew Mexico specific: small markets may create pressure for informal quid pro quo arrangements. Agents must be vigilant that referral relationships don't cross RESPA lines regardless of market size."
            }
          ],
          quiz: [
            {
              id: "nm_p03q01",
              prompt: "A New Mexico title company offers to pay for a real estate agent's E&O insurance in exchange for referring all closings to the title company. Under RESPA, this arrangement is:",
              choices: [
  ...
  studyPlan: [
    { weeks: "1-2", focus: "New Mexico licensing roadmap + 90-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + community property, acequias, and pueblo land grants" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + New Mexico purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + New Mexico Mortgage Finance Authority (MFA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (New Mexico additions) + New Mexico license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + New Mexico-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + New Mexico tax considerations + 1031 exchange + New Mexico state exam review + full practice exams" }
  ],

  resources: [
    { label: "New Mexico License Requirements", url: "https://www.google.com/search?q=New+Mexico+real+estate+license+requirements", category: "broker" },
    { label: "New Mexico Real Estate Commission (NMREC) Website", url: "https://www.google.com/search?q=New+Mexico+Real+Estate+Commission+(NMREC)+official+website", category: "broker" },
    { label: "PSI Exams — New Mexico Exam", url: "https://www.google.com/search?q=PSI+Exams+New+Mexico+real+estate+exam", category: "broker" },
    { label: "New Mexico Mortgage Finance Authority (MFA)", url: "https://www.google.com/search?q=New+Mexico+Mortgage+Finance+Authority+(MFA)+New+Mexico", category: "mlo" },
    { label: "New Mexico Financial Institutions Division", url: "https://www.google.com/search?q=New+Mexico+Financial+Institutions+Division+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_NM;
