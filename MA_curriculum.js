// ============================================================
// MA_curriculum.js — Massachusetts Real Estate Study System
// Massachusetts Board of Registration of Real Estate Brokers and Salespersons Broker/Salesperson License — 2026
// Sources: Massachusetts Board of Registration of Real Estate Brokers and Salespersons, NMLS, PSI Exams
...
const CURRICULUM_MA = {
  ...
  meta: {
    title: "MA Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Massachusetts",
    stateCode: "MA",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — MA SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "MA Real Estate Salesperson/Broker",
      icon: "🦃",
      color: "#003087",
      description: "Massachusetts Board of Registration of Real Estate Brokers and Salespersons — 40-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Massachusetts broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "40-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$54", source: "PSI Exams" },
        { item: "Massachusetts license fee", amount: "$150", source: "Massachusetts Board of Registration of Real Estate Brokers and Salespersons" },
      ...
      modules: [

        {
          id: "ma_b01",
          order: 1,
          title: "Licensing Process & Massachusetts Board of Registration of Real Estate Brokers and Salespersons Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Massachusetts licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Massachusetts Real Estate",
              body: "The Massachusetts Board of Registration of Real Estate Brokers and Salespersons licenses and regulates real estate salespersons and brokers in Massachusetts.\n\nMassachusetts requires 40 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Massachusetts:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nMassachusetts uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 12 hours every 2 year(s)."
            },
            {
              heading: "40-Hour Pre-License Education",
              body: "Massachusetts requires 40 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Massachusetts real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Massachusetts\n• Massachusetts-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nMassachusetts-specific education note: Massachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Massachusetts uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Massachusetts Board of Registration of Real Estate Brokers and Salespersons\n• Submit background check results\n• Pay license fee of $150\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Massachusetts licenses must be renewed every 2 year(s).\n\nCE requirements: 12 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Massachusetts-specific law\n• Elective topics\n\nMassachusetts-specific requirement: Massachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys."
            },
            {
              heading: "Massachusetts-Specific Real Estate Law",
              body: "Key Massachusetts real estate law topics:\n\nMassachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys.\n\nAdditional Massachusetts-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Massachusetts landlord-tenant law\n• Environmental regulations specific to Massachusetts\n• Agency law under Massachusetts statutes\n\nMassachusetts unique aspect — mandatory attorney closings: Every Massachusetts real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "ma_b01q01",
              prompt: "How many hours of pre-license education does Massachusetts require before taking the PSI Exams exam?",
              choices: [
                "20 hours",
                "40 hours",
                "60 hours",
              ...
              answer: 1,
              explanation: "Massachusetts requires 40 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Massachusetts law, agency, contracts, finance, and other required topics."
            },
            {
              id: "ma_b01q02",
              prompt: "How often must Massachusetts real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Massachusetts real estate licenses are renewed every 2 year(s). Licensees must complete 12 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "ma_b01q03",
              prompt: "Massachusetts's unique real estate requirement regarding mandatory attorney closings means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Massachusetts-specific rules that differ from most other states",
                "All transactions in Massachusetts follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand mandatory attorney closings"
              ],
              answer: 1,
              explanation: "Massachusetts's unique mandatory attorney closings requirement means all licensees must understand state-specific rules. Massachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys."
            },
            {
              id: "ma_b01q04",
              prompt: "The PSI Exams exam used in Massachusetts consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Massachusetts consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "ma_b01q05",
              prompt: "A new Massachusetts licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "ma_b02",
          order: 2,
          title: "Property Ownership & Massachusetts Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Massachusetts-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Massachusetts",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nMassachusetts-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Massachusetts must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Massachusetts",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nMassachusetts marital property rules:\nMassachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys.\n\nHomestead protection in Massachusetts provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Massachusetts",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nMassachusetts-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Massachusetts",
              body: "Massachusetts uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Massachusetts where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Massachusetts.\n\nRecording in Massachusetts: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Massachusetts follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Massachusetts",
              body: "Transfer of title in Massachusetts requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nMassachusetts deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Massachusetts property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "ma_b02q01",
              prompt: "In Massachusetts, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Massachusetts Board of Registration of Real Estate Brokers and Salespersons headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Massachusetts are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "ma_b02q02",
              prompt: "Which deed type provides the greatest protection for a Massachusetts buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Massachusetts. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "ma_b02q03",
              prompt: "Two friends purchase a Massachusetts property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Massachusetts",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Massachusetts. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "ma_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Massachusetts, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Massachusetts."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Massachusetts. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "ma_b04q02",
              prompt: "A Massachusetts buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "MassHousing down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Massachusetts."
            },
            {
              id: "ma_b05q02",
              prompt: "A Massachusetts veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ma_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Massachusetts?",
              choices: [
...

        {
          id: "ma_b07",
          order: 7,
          title: "Fair Housing & Massachusetts Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Massachusetts-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Massachusetts Fair Housing Protections",
              body: "Massachusetts may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Massachusetts may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Massachusetts state statutes for current protected classes under Massachusetts fair housing law.\n\nMassachusetts enforcement: File complaints with Massachusetts Board of Registration of Real Estate Brokers and Salespersons and/or HUD within applicable time limits. Massachusetts Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "ma_b08",
          order: 8,
          title: "Property Management & Massachusetts Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Massachusetts landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Massachusetts Landlord-Tenant Basics",
              body: "Massachusetts landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Massachusetts rules:\n• Security deposit: Massachusetts sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Massachusetts requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Massachusetts:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Massachusetts",
              body: "Property managers in Massachusetts generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Massachusetts statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nMassachusetts property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "ma_b08q01",
              prompt: "A Massachusetts landlord collects a security deposit from a tenant. Under Massachusetts landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Massachusetts must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Massachusetts has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "ma_b10",
          order: 10,
          title: "Massachusetts License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Massachusetts license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Massachusetts License Law — Key Provisions",
              body: "Massachusetts real estate licensees must comply with:\n\nMassachusetts Board of Registration of Real Estate Brokers and Salespersons rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nMassachusetts specific: Massachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys."
            },
            {
              heading: "Massachusetts Real Estate Recovery Fund",
              body: "Massachusetts maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Massachusetts's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Massachusetts limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Massachusetts\n\nMassachusetts trust account rules:\n• Client funds must be deposited promptly (check Massachusetts specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Massachusetts Board of Registration of Real Estate Brokers and Salespersons audit at any time"
            }
          ],
          quiz: [
            {
              id: "ma_b10q01",
              prompt: "A Massachusetts broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Massachusetts's license law and can result in license suspension or revocation."
            },
            {
              id: "ma_b10q02",
              prompt: "The Massachusetts Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ma_b11q02",
              prompt: "A Massachusetts investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Massachusetts state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Massachusetts rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Massachusetts state income tax on the gain (if Massachusetts has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "ma_b12",
          order: 12,
          title: "Massachusetts State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Massachusetts-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Massachusetts State Exam Key Topics",
              body: "Massachusetts state exam will focus on:\n\n1. Massachusetts license law — Massachusetts Board of Registration of Real Estate Brokers and Salespersons rules and procedures\n2. Massachusetts agency law — specific state requirements\n3. Massachusetts contract forms and requirements\n4. Massachusetts disclosure laws\n5. Massachusetts property tax system\n6. Massachusetts closing procedures\n7. Massachusetts-specific restrictions and regulations\n8. Massachusetts fair housing additions\n9. Massachusetts landlord-tenant law\n10. Massachusetts environmental law\n\nMassachusetts unique state exam emphasis: Massachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys.\n\nStudy strategy:\n• Review Massachusetts Board of Registration of Real Estate Brokers and Salespersons website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Massachusetts-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "ma_b12q01",
              prompt: "Which Massachusetts licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Massachusetts Board of Registration of Real Estate Brokers and Salespersons has the legal authority to suspend or revoke a Massachusetts real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "ma_b12q02",
              prompt: "A Massachusetts licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "MA MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Massachusetts Division of Banks state requirements",
      requirements: [
        ...
        "Sponsored by a Massachusetts-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Massachusetts state license fee", amount: "$150–$300", source: "Massachusetts Division of Banks" },
      ...
      modules: [
        {
          id: "ma_m01",
          order: 1,
          title: "SAFE Act & Massachusetts MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Massachusetts Division of Banks requirements, and MassHousing programs.",
          content: [
            {
              heading: "Massachusetts MLO Regulation — Massachusetts Division of Banks",
              body: "Massachusetts MLOs are regulated by the Massachusetts Division of Banks through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Massachusetts must hold an active NMLS MLO license with a Massachusetts state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Massachusetts state endorsement through NMLS\n6. Obtain sponsorship from Massachusetts-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "MassHousing Programs",
              body: "MassHousing provides mortgage programs for Massachusetts homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Massachusetts:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Massachusetts areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Massachusetts's state housing agency programs differentiates Massachusetts MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "ma_m01q01",
              prompt: "Which agency regulates Massachusetts MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Massachusetts MLO licenses are regulated by the Massachusetts Division of Banks. Real estate brokers and salespersons are regulated by the Massachusetts Board of Registration of Real Estate Brokers and Salespersons. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "ma_m01q02",
              prompt: "An MLO in Massachusetts must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "MA Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Massachusetts real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "ma_p01",
          order: 1,
          title: "Massachusetts Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Massachusetts listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Massachusetts Pre-Listing Preparation",
              body: "Steps to prepare a Massachusetts listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Massachusetts-specific issues: mandatory attorney closings\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Massachusetts-specific disclosure items: Massachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Massachusetts market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Massachusetts-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Massachusetts Market Dynamics",
              body: "Massachusetts's real estate market has unique characteristics:\n\nMassachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys.\n\nKey factors affecting Massachusetts real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nMassachusetts market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Massachusetts-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Massachusetts: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "ma_p01q01",
              prompt: "During pre-listing due diligence for a Massachusetts property, an agent discovers the property may have mandatory attorney closings issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential mandatory attorney closings issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
...

        {
          id: "ma_p03",
          order: 3,
          title: "Massachusetts Closing Process & RESPA Compliance",
          week: "9-12",
          passingScore: 70,
          icon: "🎯",
          objective: "Navigate Massachusetts closing procedures, RESPA compliance, and build ethical referral networks.",
          content: [
            {
              heading: "Massachusetts Closing Procedures",
              body: "The Massachusetts closing process:\n\n1. Pre-closing preparation:\n• Title company/attorney orders title search and issues commitment\n• Lender completes underwriting; issues clear to close\n• Closing disclosure prepared and delivered 3 business days before closing\n• Final walk-through by buyer\n\n2. Closing day:\n• Buyer and seller (or their representatives) attend closing\n• Sign all documents (deed, mortgage, closing disclosure, etc.)\n• Funds deposited and disbursed\n• Deed and mortgage recorded\n• Keys transferred\n\n3. Post-closing:\n• Confirm recording\n• Distribute closing packages to all parties\n• Upload documents to transaction management system\n• Collect commission\n\nMassachusetts closing practice: Massachusetts requires attorney closings — all residential real estate closings must be conducted by a licensed Massachusetts attorney. The Commonwealth uses 'Purchase and Sale Agreements' prepared by attorneys."
            },
            {
              heading: "RESPA Compliance in Massachusetts",
              body: "RESPA Section 8 compliance in Massachusetts real estate:\n\nILLEGAL:\n• Title company paying for agent's marketing in exchange for referrals\n• Lender sponsoring office expenses for mortgage referrals\n• Any payment in exchange for settlement service referrals\n• Marketing services agreements that function as referral fees\n\nLEGAL:\n• Genuine affiliated business arrangements (AfBA) with proper disclosure\n• Actual services for actual compensation\n• Educational co-marketing (properly structured)\n• Normal business development activities\n\nMassachusetts specific: small markets may create pressure for informal quid pro quo arrangements. Agents must be vigilant that referral relationships don't cross RESPA lines regardless of market size."
            }
          ],
          quiz: [
            {
              id: "ma_p03q01",
              prompt: "A Massachusetts title company offers to pay for a real estate agent's E&O insurance in exchange for referring all closings to the title company. Under RESPA, this arrangement is:",
              choices: [
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Massachusetts licensing roadmap + 40-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + mandatory attorney closings" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Massachusetts purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + MassHousing programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Massachusetts additions) + Massachusetts license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Massachusetts-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Massachusetts tax considerations + 1031 exchange + Massachusetts state exam review + full practice exams" }
  ],

  resources: [
    { label: "Massachusetts License Requirements", url: "https://www.google.com/search?q=Massachusetts+real+estate+license+requirements", category: "broker" },
    { label: "Massachusetts Board of Registration of Real Estate Brokers and Salespersons Website", url: "https://www.google.com/search?q=Massachusetts+Board+of+Registration+of+Real+Estate+Brokers+and+Salespersons+official+website", category: "broker" },
    { label: "PSI Exams — Massachusetts Exam", url: "https://www.google.com/search?q=PSI+Exams+Massachusetts+real+estate+exam", category: "broker" },
    { label: "MassHousing", url: "https://www.google.com/search?q=MassHousing+Massachusetts", category: "mlo" },
    { label: "Massachusetts Division of Banks", url: "https://www.google.com/search?q=Massachusetts+Division+of+Banks+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_MA;
