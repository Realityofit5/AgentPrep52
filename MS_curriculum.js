// ============================================================
// MS_curriculum.js — Mississippi Real Estate Study System
// Mississippi Real Estate Commission (MREC) Broker/Salesperson License — 2026
// Sources: Mississippi Real Estate Commission (MREC), NMLS, PSI Exams
...
const CURRICULUM_MS = {
  ...
  meta: {
    title: "MS Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Mississippi",
    stateCode: "MS",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — MS SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "MS Real Estate Salesperson/Broker",
      icon: "🌊",
      color: "#002060",
      description: "Mississippi Real Estate Commission (MREC) — 60-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Mississippi broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "60-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$75", source: "PSI Exams" },
        { item: "Mississippi license fee", amount: "$75", source: "Mississippi Real Estate Commission (MREC)" },
      ...
      modules: [

        {
          id: "ms_b01",
          order: 1,
          title: "Licensing Process & Mississippi Real Estate Commission (MREC) Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Mississippi licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Mississippi Real Estate",
              body: "The Mississippi Real Estate Commission (MREC) licenses and regulates real estate salespersons and brokers in Mississippi.\n\nMississippi requires 60 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Mississippi:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nMississippi uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 16 hours every 2 year(s)."
            },
            {
              heading: "60-Hour Pre-License Education",
              body: "Mississippi requires 60 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Mississippi real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Mississippi\n• Mississippi-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nMississippi-specific education note: Mississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Mississippi uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Mississippi Real Estate Commission (MREC)\n• Submit background check results\n• Pay license fee of $75\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Mississippi licenses must be renewed every 2 year(s).\n\nCE requirements: 16 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Mississippi-specific law\n• Elective topics\n\nMississippi-specific requirement: Mississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure."
            },
            {
              heading: "Mississippi-Specific Real Estate Law",
              body: "Key Mississippi real estate law topics:\n\nMississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure.\n\nAdditional Mississippi-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Mississippi landlord-tenant law\n• Environmental regulations specific to Mississippi\n• Agency law under Mississippi statutes\n\nMississippi unique aspect — coastal property regulations: Every Mississippi real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "ms_b01q01",
              prompt: "How many hours of pre-license education does Mississippi require before taking the PSI Exams exam?",
              choices: [
                "30 hours",
                "60 hours",
                "90 hours",
              ...
              answer: 1,
              explanation: "Mississippi requires 60 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Mississippi law, agency, contracts, finance, and other required topics."
            },
            {
              id: "ms_b01q02",
              prompt: "How often must Mississippi real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 2 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Mississippi real estate licenses are renewed every 2 year(s). Licensees must complete 16 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "ms_b01q03",
              prompt: "Mississippi's unique real estate requirement regarding coastal property regulations means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Mississippi-specific rules that differ from most other states",
                "All transactions in Mississippi follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand coastal property regulations"
              ],
              answer: 1,
              explanation: "Mississippi's unique coastal property regulations requirement means all licensees must understand state-specific rules. Mississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure."
            },
            {
              id: "ms_b01q04",
              prompt: "The PSI Exams exam used in Mississippi consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Mississippi consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "ms_b01q05",
              prompt: "A new Mississippi licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "ms_b02",
          order: 2,
          title: "Property Ownership & Mississippi Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Mississippi-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Mississippi",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nMississippi-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Mississippi must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Mississippi",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nMississippi marital property rules:\nMississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure.\n\nHomestead protection in Mississippi provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Mississippi",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nMississippi-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Mississippi",
              body: "Mississippi uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Mississippi where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Mississippi.\n\nRecording in Mississippi: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Mississippi follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Mississippi",
              body: "Transfer of title in Mississippi requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nMississippi deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Mississippi property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "ms_b02q01",
              prompt: "In Mississippi, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Mississippi Real Estate Commission (MREC) headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Mississippi are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "ms_b02q02",
              prompt: "Which deed type provides the greatest protection for a Mississippi buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Mississippi. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "ms_b02q03",
              prompt: "Two friends purchase a Mississippi property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Mississippi",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Mississippi. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "ms_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Mississippi, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Mississippi."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Mississippi. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "ms_b04q02",
              prompt: "A Mississippi buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
          ...
          quiz: [
            {
              ...
              answer: 0,
              explanation: "Mississippi Home Corporation (MHC) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Mississippi."
            },
            {
              id: "ms_b05q02",
              prompt: "A Mississippi veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ms_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Mississippi?",
              choices: [
...

        {
          id: "ms_b07",
          order: 7,
          title: "Fair Housing & Mississippi Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Mississippi-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Mississippi Fair Housing Protections",
              body: "Mississippi may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Mississippi may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Mississippi state statutes for current protected classes under Mississippi fair housing law.\n\nMississippi enforcement: File complaints with Mississippi Real Estate Commission (MREC) and/or HUD within applicable time limits. Mississippi Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "ms_b08",
          order: 8,
          title: "Property Management & Mississippi Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Mississippi landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Mississippi Landlord-Tenant Basics",
              body: "Mississippi landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Mississippi rules:\n• Security deposit: Mississippi sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Mississippi requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Mississippi:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Mississippi",
              body: "Property managers in Mississippi generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Mississippi statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nMississippi property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "ms_b08q01",
              prompt: "A Mississippi landlord collects a security deposit from a tenant. Under Mississippi landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Mississippi must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Mississippi has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "ms_b10",
          order: 10,
          title: "Mississippi License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Mississippi license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Mississippi License Law — Key Provisions",
              body: "Mississippi real estate licensees must comply with:\n\nMississippi Real Estate Commission (MREC) rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nMississippi specific: Mississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure."
            },
            {
              heading: "Mississippi Real Estate Recovery Fund",
              body: "Mississippi maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Mississippi's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Mississippi limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Mississippi\n\nMississippi trust account rules:\n• Client funds must be deposited promptly (check Mississippi specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Mississippi Real Estate Commission (MREC) audit at any time"
            }
          ],
          quiz: [
            {
              id: "ms_b10q01",
              prompt: "A Mississippi broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Mississippi's license law and can result in license suspension or revocation."
            },
            {
              id: "ms_b10q02",
              prompt: "The Mississippi Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "ms_b11q02",
              prompt: "A Mississippi investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Mississippi state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Mississippi rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Mississippi state income tax on the gain (if Mississippi has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "ms_b12",
          order: 12,
          title: "Mississippi State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Mississippi-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Mississippi State Exam Key Topics",
              body: "Mississippi state exam will focus on:\n\n1. Mississippi license law — Mississippi Real Estate Commission (MREC) rules and procedures\n2. Mississippi agency law — specific state requirements\n3. Mississippi contract forms and requirements\n4. Mississippi disclosure laws\n5. Mississippi property tax system\n6. Mississippi closing procedures\n7. Mississippi-specific restrictions and regulations\n8. Mississippi fair housing additions\n9. Mississippi landlord-tenant law\n10. Mississippi environmental law\n\nMississippi unique state exam emphasis: Mississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure.\n\nStudy strategy:\n• Review Mississippi Real Estate Commission (MREC) website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Mississippi-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "ms_b12q01",
              prompt: "Which Mississippi licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
              ...
              answer: 1,
              explanation: "Only the Mississippi Real Estate Commission (MREC) has the legal authority to suspend or revoke a Mississippi real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "ms_b12q02",
              prompt: "A Mississippi licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "MS MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Mississippi Department of Banking and Consumer Finance state requirements",
      requirements: [
        ...
        "Sponsored by a Mississippi-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Mississippi state license fee", amount: "$150–$300", source: "Mississippi Department of Banking and Consumer Finance" },
      ...
      modules: [
        {
          id: "ms_m01",
          order: 1,
          title: "SAFE Act & Mississippi MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Mississippi Department of Banking and Consumer Finance requirements, and Mississippi Home Corporation (MHC) programs.",
          content: [
            {
              heading: "Mississippi MLO Regulation — Mississippi Department of Banking and Consumer Finance",
              body: "Mississippi MLOs are regulated by the Mississippi Department of Banking and Consumer Finance through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Mississippi must hold an active NMLS MLO license with a Mississippi state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Mississippi state endorsement through NMLS\n6. Obtain sponsorship from Mississippi-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Mississippi Home Corporation (MHC) Programs",
              body: "Mississippi Home Corporation (MHC) provides mortgage programs for Mississippi homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Mississippi:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Mississippi areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Mississippi's state housing agency programs differentiates Mississippi MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "ms_m01q01",
              prompt: "Which agency regulates Mississippi MLO licenses?",
              choices: [
              ...
              answer: 1,
              explanation: "Mississippi MLO licenses are regulated by the Mississippi Department of Banking and Consumer Finance. Real estate brokers and salespersons are regulated by the Mississippi Real Estate Commission (MREC). These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "ms_m01q02",
              prompt: "An MLO in Mississippi must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "MS Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Mississippi real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
        "Complete broker pre-license education",
        "Pass PSI Exams exam",
        "Active Mississippi license",
      ...
      modules: [
        {
          id: "ms_p01",
          order: 1,
          title: "Mississippi Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Mississippi listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Mississippi Pre-Listing Preparation",
              body: "Steps to prepare a Mississippi listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Mississippi-specific issues: coastal property regulations\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Mississippi-specific disclosure items: Mississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Mississippi market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Mississippi-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Mississippi Market Dynamics",
              body: "Mississippi's real estate market has unique characteristics:\n\nMississippi follows a single-agency model for real estate representation. Mississippi has unique coastal property regulations in Harrison, Hancock, and Jackson counties due to Gulf Coast exposure.\n\nKey factors affecting Mississippi real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nMississippi market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Mississippi-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Mississippi: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "ms_p01q01",
              prompt: "During pre-listing due diligence for a Mississippi property, an agent discovers the property may have coastal property regulations issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential coastal property regulations issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Mississippi licensing roadmap + 60-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + coastal property regulations" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Mississippi purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Mississippi Home Corporation (MHC) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Mississippi additions) + Mississippi license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Mississippi-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Mississippi tax considerations + 1031 exchange + Mississippi state exam review + full practice exams" }
  ],

  resources: [
    { label: "Mississippi License Requirements", url: "https://www.google.com/search?q=Mississippi+real+estate+license+requirements", category: "broker" },
    { label: "Mississippi Real Estate Commission (MREC) Website", url: "https://www.google.com/search?q=Mississippi+Real+Estate+Commission+(MREC)+official+website", category: "broker" },
    { label: "PSI Exams — Mississippi Exam", url: "https://www.google.com/search?q=PSI+Exams+Mississippi+real+estate+exam", category: "broker" },
    { label: "Mississippi Home Corporation (MHC)", url: "https://www.google.com/search?q=Mississippi+Home+Corporation+(MHC)+Mississippi", category: "mlo" },
    { label: "Mississippi Department of Banking and Consumer Finance", url: "https://www.google.com/search?q=Mississippi+Department+of+Banking+and+Consumer+Finance+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_MS;
