// ============================================================
// IN_curriculum.js — Indiana Real Estate Study System
// Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission Broker/Salesperson License — 2026
// Sources: Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission, NMLS, PSI Exams
...
const CURRICULUM_IN = {
  ...
  meta: {
    title: "IN Real Estate & MLO Licensing System 2026",
    version: "1.0",
    state: "Indiana",
    stateCode: "IN",
  ...
  tracks: {
    ...
    // ──────────────────────────────────────────────────────
    // BROKER TRACK — IN SALESPERSON/BROKER LICENSE
    // ──────────────────────────────────────────────────────
    broker: {
      id: "broker",
      label: "IN Real Estate Salesperson/Broker",
      icon: "🏎️",
      color: "#002663",
      description: "Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission — 90-hour pre-license + PSI Exams exam + state-specific requirements",
      requirements: [
        "18+ years old",
        ...
        "Must be sponsored by a licensed Indiana broker",
        "No disqualifying criminal conviction"
      ],
      fees: [
        { item: "90-hour pre-license education", amount: "$400–$900", note: "varies by provider" },
        { item: "PSI Exams exam fee", amount: "$53", source: "PSI Exams" },
        { item: "Indiana license fee", amount: "$60", source: "Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission" },
      ...
      modules: [

        {
          id: "in_b01",
          order: 1,
          title: "Licensing Process & Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission Roadmap",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Map the complete Indiana licensing process including pre-license education, PSI Exams exam, application process, and renewal requirements.",
          content: [
            {
              heading: "Who Regulates Indiana Real Estate",
              body: "The Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission licenses and regulates real estate salespersons and brokers in Indiana.\n\nIndiana requires 90 hours of pre-license education before taking the PSI Exams licensing exam.\n\nLicense types in Indiana:\n• Salesperson/Broker Associate — entry level; must work under a licensed broker\n• Broker — highest level; can operate independently and supervise others\n\nIndiana uses PSI Exams for its licensing examination. The exam consists of a national section (80 questions) and a state section (40 questions). Passing score is 75% on both sections.\n\nCE requirements: 12 hours every 3 year(s)."
            },
            {
              heading: "90-Hour Pre-License Education",
              body: "Indiana requires 90 hours of approved pre-license education covering:\n\n• Real estate principles and practices\n• Indiana real estate law\n• Agency law and disclosures\n• Contracts and purchase agreements\n• Finance and mortgages\n• Property ownership and transfer\n• Valuation and appraisal\n• Fair housing and anti-discrimination law\n• Environmental issues in Indiana\n• Indiana-specific statutes and regulations\n\nAfter completing the course, candidates must pass the PSI Exams exam and apply for their license.\n\nIndiana-specific education note: Indiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level."
            },
            {
              heading: "Exam Structure and Application Process",
              body: "Indiana uses PSI Exams for its licensing exam.\n\nExam structure:\n• National section: 80 questions, 150 minutes, 75% passing score\n• State section: 40 questions, 60 minutes, 75% passing score\n• Must pass BOTH sections separately\n• Results provided immediately at the test center\n\nAfter passing:\n• Apply for license within 1 year of passing\n• Submit application to Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission\n• Submit background check results\n• Pay license fee of $60\n• Identify sponsoring broker\n\nRetakes: If one section is failed, only the failed section needs to be retaken."
            },
            {
              heading: "License Renewal and Continuing Education",
              body: "Indiana licenses must be renewed every 3 year(s).\n\nCE requirements: 12 hours per renewal cycle.\n\nCE topics typically include:\n• Current real estate law updates\n• Fair housing\n• Ethics\n• Indiana-specific law\n• Elective topics\n\nIndiana-specific requirement: Indiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level."
            },
            {
              heading: "Indiana-Specific Real Estate Law",
              body: "Key Indiana real estate law topics:\n\nIndiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level.\n\nAdditional Indiana-specific knowledge requirements:\n• State-specific disclosure requirements\n• Local zoning and land use regulations\n• Indiana landlord-tenant law\n• Environmental regulations specific to Indiana\n• Agency law under Indiana statutes\n\nIndiana unique aspect — seller disclosure law and no transfer tax: Every Indiana real estate licensee must understand this state-specific area as it regularly appears on the state exam and arises in practice."
            }
          ],
          quiz: [
            {
              id: "in_b01q01",
              prompt: "How many hours of pre-license education does Indiana require before taking the PSI Exams exam?",
              choices: [
                "45 hours",
                "90 hours",
                "135 hours",
              ...
              answer: 1,
              explanation: "Indiana requires 90 hours of approved pre-license education before candidates can take the PSI Exams licensing exam. This education covers real estate principles, Indiana law, agency, contracts, finance, and other required topics."
            },
            {
              id: "in_b01q02",
              prompt: "How often must Indiana real estate licenses be renewed?",
              choices: [
                "Every 1 year",
                "Every 3 year(s)",
                "Every 4 years",
              ...
              answer: 1,
              explanation: "Indiana real estate licenses are renewed every 3 year(s). Licensees must complete 12 hours of continuing education per renewal cycle to maintain their license."
            },
            {
              id: "in_b01q03",
              prompt: "Indiana's unique real estate requirement regarding seller disclosure law and no transfer tax means that:",
              choices: [
                "Licensees only need to follow federal law and can ignore state requirements",
                "Licensees must understand and apply Indiana-specific rules that differ from most other states",
                "All transactions in Indiana follow the same rules as neighboring states",
                "Only brokers (not salespersons) need to understand seller disclosure law and no transfer tax"
              ],
              answer: 1,
              explanation: "Indiana's unique seller disclosure law and no transfer tax requirement means all licensees must understand state-specific rules. Indiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level."
            },
            {
              id: "in_b01q04",
              prompt: "The PSI Exams exam used in Indiana consists of which two sections?",
              choices: [
              ...
              answer: 1,
              explanation: "The PSI Exams exam in Indiana consists of a national section (80 questions, 150 minutes) and a state section (40 questions, 60 minutes). Both sections require a 75% passing score and must be passed separately."
            },
            {
              id: "in_b01q05",
              prompt: "A new Indiana licensee fails the national section of the PSI Exams exam but passes the state section. They must:",
              choices: [
...

        {
          id: "in_b02",
          order: 2,
          title: "Property Ownership & Indiana Land Law",
          week: "1-2",
          passingScore: 75,
          icon: "🏠",
          objective: "Identify property ownership types, concurrent ownership forms, encumbrances, legal descriptions, and Indiana-specific land issues.",
          content: [
            {
              heading: "Real vs. Personal Property in Indiana",
              body: "Real property consists of land and all permanently attached improvements. Personal property is movable.\n\nFixture analysis — courts typically use the three-part test:\n1. Method of annexation (how is it attached?)\n2. Adaptation (how adapted to the property?)\n3. Intent of the annexer\n\nIndiana-specific fixture considerations: heating systems, built-in appliances, and specialty systems common in Indiana must be specified in purchase contracts as included or excluded.\n\nA fixture that appears permanently attached becomes real property and transfers with the deed unless specifically excluded. The purchase agreement should list all included and excluded items to prevent disputes."
            },
            {
              heading: "Concurrent Ownership in Indiana",
              body: "Joint Tenancy:\n• Requires Four Unities: Time, Title, Interest, Possession (TTIP)\n• Right of survivorship — bypasses probate\n• Must be expressly created in the deed\n\nTenancy in Common:\n• Default for co-owners\n• Unequal shares allowed\n• No survivorship right\n• Each co-owner can sell, will, or mortgage their share\n\nIndiana marital property rules:\nIndiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level.\n\nHomestead protection in Indiana provides some protection of the primary residence from certain creditor claims, though the amount and scope varies by state law."
            },
            {
              heading: "Encumbrances in Indiana",
              body: "Encumbrances are claims, liens, or restrictions that affect property value or use.\n\nLiens (monetary claims):\n• Mortgage/Deed of Trust — voluntary, specific\n• Property tax liens — super priority in most states\n• Mechanic's liens — must be filed within state-specific deadline\n• Judgment liens — attach to all real property in jurisdiction\n\nEasements:\n• Express easements created by grant or reservation\n• Implied easements (prior use, necessity)\n• Prescriptive easements (varies by state)\n\nIndiana-specific encumbrance issues include HOA covenants and restrictions recorded against properties in planned communities, subdivision restrictions, and deed conditions."
            },
            {
              heading: "Legal Descriptions in Indiana",
              body: "Indiana uses standard legal description systems:\n\n1. Rectangular Survey (Government Survey) — used in most of Indiana where the public land survey system applies. Describes land by township, range, section, and subdivision.\n\n2. Metes and Bounds — used for irregularly shaped parcels and areas predating the rectangular survey system.\n\n3. Lot and Block (Recorded Plat) — used for subdivisions throughout Indiana.\n\nRecording in Indiana: Real estate documents are recorded at the county recorder's office (or equivalent) in the county where the property is located. Indiana follows a race-notice recording statute, meaning the first to record in good faith without notice of a prior claim prevails."
            },
            {
              heading: "Title and Transfer in Indiana",
              body: "Transfer of title in Indiana requires:\n• Written instrument (deed)\n• Grantor with legal capacity\n• Identifiable grantee\n• Adequate property description\n• Consideration (can be nominal)\n• Granting clause\n• Signature of grantor(s)\n• Delivery and acceptance\n• Recording (not required for validity between parties, but required for priority)\n\nIndiana deed types include: General Warranty Deed (most protection for buyer), Special Warranty Deed (limited warranty), and Quitclaim Deed (no warranty).\n\nTitle insurance is recommended for all Indiana property purchases. An owner's policy protects the buyer against defects existing before closing."
            }
          ],
          quiz: [
            {
              id: "in_b02q01",
              prompt: "In Indiana, real estate documents are recorded at the:",
              choices: [
                "State Secretary of State office",
                "County Recorder or County Clerk office in the property's county",
                "Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission headquarters",
                "Federal land records office"
              ],
              answer: 1,
              explanation: "Real estate documents in Indiana are recorded at the county recorder's (or county clerk's) office in the county where the property is located. Recording provides constructive notice to the world of ownership and encumbrances."
            },
            {
              id: "in_b02q02",
              prompt: "Which deed type provides the greatest protection for a Indiana buyer?",
              choices: [
              ...
              answer: 2,
              explanation: "A General Warranty Deed provides the greatest protection for buyers in Indiana. The grantor warrants against ALL title defects, including those that arose before the grantor's ownership. A Special Warranty Deed covers only defects arising during the seller's ownership, and a Quitclaim Deed provides no warranties."
            },
            {
              id: "in_b02q03",
              prompt: "Two friends purchase a Indiana property as tenants in common. One friend dies without a will. Under tenancy in common, the deceased friend's share:",
              choices: [
                ...
                "Reverts to the state of Indiana",
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "Known material defects must be disclosed to prospective buyers in Indiana. A foundation crack is clearly a material defect that would affect a buyer's decision. While the listing agent has a duty of loyalty to the seller, that duty does not include concealing known defects from buyers."
            },
            {
              id: "in_b03q02",
              prompt: "Under an Exclusive Right-to-Sell listing in Indiana, if the seller finds their own buyer without the agent's involvement, the agent:",
              choices: [
              ...
              answer: 1,
              explanation: "Under an Exclusive Right-to-Sell listing, the broker earns the commission regardless of who finds the buyer — even if the seller finds their own buyer. This is the defining characteristic of the exclusive right-to-sell listing and the reason it is the most common form used in Indiana."
            }
          ]
        },
          ...
          quiz: [
            {
              ...
              answer: 1,
              explanation: "The Statute of Frauds requires contracts for the sale or transfer of real property to be in writing to be enforceable. This is a fundamental rule in all U.S. states including Indiana. An oral agreement to sell real estate is not enforceable."
            },
            {
              id: "in_b04q02",
              prompt: "A Indiana buyer submits an offer with an inspection contingency. The inspection deadline passes without the buyer submitting an inspection objection notice. The result is:",
              choices: [
...

        {
          id: "in_b05",
          order: 5,
          title: "Real Estate Finance & Indiana Mortgage Programs",
          week: "5-6",
          passingScore: 75,
          icon: "💰",
          objective: "Explain Indiana financing options, Indiana Housing and Community Development Authority (IHCDA) programs, and key federal mortgage regulations.",
          content: [
            {
              heading: "Indiana Housing and Community Development Authority (IHCDA) Programs",
              body: "Indiana Housing and Community Development Authority (IHCDA) provides affordable homeownership programs for Indiana residents:\n\nFirst-time homebuyer programs:\n• Below-market interest rate first mortgages\n• Income and purchase price limits apply (vary by county)\n• Must be primary residence\n\nDown payment assistance:\n• Grants or second mortgages for down payment and closing costs\n• Some programs forgivable after period of occupancy\n\nSpecial programs:\n• Veterans/military programs\n• Low-income and workforce housing programs\n• Renovation and rehabilitation loan programs\n\nMLO value in Indiana: understanding Indiana Housing and Community Development Authority (IHCDA) programs is essential as many Indiana first-time buyers use state housing agency financing."
            },
            {
              heading: "Federal Loan Programs in Indiana",
              body: "Federal loan programs important in Indiana:\n\nFHA Loans:\n• 3.5% down payment (with 580+ credit score)\n• MIP (mortgage insurance premium) required\n• Property must meet FHA minimum property standards\n• Common for first-time buyers in Indiana\n\nVA Loans:\n• 0% down for eligible veterans and active military\n• No PMI required\n• Funding fee applies (waived for disabled veterans)\n• Indiana military presence: check local military installations\n\nUSDA Rural Development:\n• 0% down for eligible rural properties\n• Income limits apply\n• Many Indiana rural areas may qualify\n\nConventional/Fannie Mae-Freddie Mac:\n• Dominant in Indiana's mortgage market\n• 3-20% down depending on program\n• Conforming loan limits vary by county"
            },
            {
              heading: "Deed of Trust vs. Mortgage in Indiana",
              body: "Most states use either mortgages or deeds of trust as the security instrument for home loans.\n\nMortgage (two-party instrument):\n• Borrower (mortgagor) and lender (mortgagee)\n• Lender must use judicial foreclosure — court process\n• Generally slower and more expensive process\n• Borrower typically has right of redemption after foreclosure sale\n\nDeed of Trust (three-party instrument):\n• Trustor (borrower), trustee (holds legal title), beneficiary (lender)\n• Allows non-judicial (trustee's sale) foreclosure — faster and cheaper\n• Redemption rights vary; many deed of trust states have no redemption period\n\nIndiana uses: check Indiana statutes to determine whether Indiana primarily uses mortgages or deeds of trust, and what the foreclosure process entails."
            }
          ],
          quiz: [
            {
              id: "in_b05q01",
              prompt: "The Indiana Housing and Community Development Authority (IHCDA) provides down payment assistance to Indiana homebuyers primarily to:",
              choices: [
              ...
              answer: 0,
              explanation: "Indiana Housing and Community Development Authority (IHCDA) down payment assistance programs are designed to help buyers who qualify income-wise for a mortgage but lack the funds for a down payment. These programs make homeownership accessible to first-time buyers and low-to-moderate income households in Indiana."
            },
            {
              id: "in_b05q02",
              prompt: "A Indiana veteran wants to purchase a home with 0% down payment and no private mortgage insurance. The most appropriate loan program is:",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "in_b06q02",
              prompt: "Which approach to value is MOST reliable for a standard residential home in Indiana?",
              choices: [
...

        {
          id: "in_b07",
          order: 7,
          title: "Fair Housing & Indiana Anti-Discrimination Law",
          week: "7-8",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply federal Fair Housing Act and Indiana-specific anti-discrimination requirements.",
          content: [
            {
            ...
            {
              heading: "Indiana Fair Housing Protections",
              body: "Indiana may provide broader fair housing protections than federal law through state anti-discrimination statutes.\n\nAdditional protected classes in Indiana may include:\n• Sexual orientation\n• Gender identity\n• Marital status\n• Source of income\n• Age (beyond federal ECOA)\n• Ancestry\n• Other state-specific protected classes\n\nCheck Indiana state statutes for current protected classes under Indiana fair housing law.\n\nIndiana enforcement: File complaints with Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission and/or HUD within applicable time limits. Indiana Civil Rights agency may also have jurisdiction.\n\nPractical application: Agents must never steer buyers based on any protected characteristic, never make assumptions about where buyers want to live, and never market properties in ways that indicate a preference for or against any protected group."
            }
          ],
          quiz: [
            {
...

        {
          id: "in_b08",
          order: 8,
          title: "Property Management & Indiana Landlord-Tenant Law",
          week: "7-8",
          passingScore: 75,
          icon: "🏢",
          objective: "Apply Indiana landlord-tenant law, security deposit rules, and property management licensing requirements.",
          content: [
            {
              heading: "Indiana Landlord-Tenant Basics",
              body: "Indiana landlord-tenant law governs the relationship between residential landlords and tenants.\n\nKey Indiana rules:\n• Security deposit: Indiana sets limits on maximum security deposit amount and requires return within specified period\n• Entry notice: Indiana requires advance notice before non-emergency landlord entry (typically 24 hours)\n• Habitability: landlords must maintain premises in habitable condition\n• Eviction process: must follow state-specific notice and filing requirements\n\nLeases in Indiana:\n• Written leases recommended for all tenancies\n• Oral leases may be enforceable for short terms\n• Month-to-month tenancies can be terminated with proper notice\n• Long-term leases (over 1 year) must be in writing (Statute of Frauds)"
            },
            {
              heading: "Property Management Licensing in Indiana",
              body: "Property managers in Indiana generally need a real estate license if they:\n• Lease or rent property on behalf of another for compensation\n• Negotiate leases or rental agreements\n• Collect rents on behalf of property owners\n\nCheck Indiana statutes for specific property management licensing exemptions (some states exempt certain on-site managers or resident managers).\n\nTrust accounts for property management:\n• Rents collected on behalf of owners must be kept in a separate trust/escrow account\n• Must not be commingled with the broker's personal funds or operating account\n• Must maintain detailed records of all receipts and disbursements\n\nIndiana property management disclosure: property managers must disclose their agency relationship and compensation to property owners."
            }
          ],
          quiz: [
            {
              id: "in_b08q01",
              prompt: "A Indiana landlord collects a security deposit from a tenant. Under Indiana landlord-tenant law, this deposit must be:",
              choices: [
              ...
              answer: 1,
              explanation: "Security deposits in Indiana must be held separately from the landlord's personal funds (in many states, in a separate escrow or trust account). The deposit must be returned to the tenant within the state-required period after tenancy ends, with an itemized statement of any deductions."
            }
          ]
        },

        {
          ...
          quiz: [
            ...
            },
            {
              ...
              answer: 1,
              explanation: "The EPA recommends taking action to reduce radon when indoor levels reach or exceed 4 picocuries per liter (pCi/L). Radon is the second leading cause of lung cancer in the U.S. Indiana has varying radon risk depending on local geology."
            }
          ]
        },

        {
          id: "in_b10",
          order: 10,
          title: "Indiana License Law, Ethics, and Trust Accounts",
          week: "9-10",
          passingScore: 75,
          icon: "⚖️",
          objective: "Apply Indiana license law requirements, trust account rules, advertising regulations, and the recovery fund.",
          content: [
            {
              heading: "Indiana License Law — Key Provisions",
              body: "Indiana real estate licensees must comply with:\n\nIndiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission rules and regulations\n• Advertising rules: must identify sponsoring broker; no blind ads\n• Trust account rules: earnest money and client funds must be deposited in separate trust accounts\n• Record keeping: maintain transaction records for required period (typically 3-5 years)\n• Disclosure requirements: disclose license status in all transactions\n• Conflicts of interest: disclose any personal interest in a transaction\n\nLicense suspension and revocation grounds:\n• Misrepresentation or fraud\n• Failure to disclose material facts\n• Trust fund violations (commingling or conversion)\n• Violations of fair housing law\n• Criminal convictions\n• Failure to maintain required insurance or CE\n\nIndiana specific: Indiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level."
            },
            {
              heading: "Indiana Real Estate Recovery Fund",
              body: "Indiana maintains a Real Estate Recovery Fund (or similar mechanism) to compensate consumers harmed by licensee misconduct.\n\nKey features of Indiana's recovery fund:\n• Compensates consumers who obtain unsatisfied judgment against a licensee\n• Maximum payment amount (check current Indiana limits)\n• Broker's license automatically suspended if fund pays on their behalf\n• Broker must repay fund with interest before reinstatement\n\nDifference from E&O Insurance:\n• E&O covers negligence and errors\n• Recovery Fund covers fraud and dishonest conduct\n• Both may be available in Indiana\n\nIndiana trust account rules:\n• Client funds must be deposited promptly (check Indiana specific timeline)\n• Never commingle personal/operating funds with client trust funds\n• Complete records required for all deposits and disbursements\n• Subject to Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission audit at any time"
            }
          ],
          quiz: [
            {
              id: "in_b10q01",
              prompt: "A Indiana broker deposits a client's earnest money into their personal checking account rather than a trust account. This is:",
              choices: [
              ...
              answer: 1,
              explanation: "Placing client funds (earnest money, security deposits, rents) in the broker's personal or operating account rather than a separate trust account is called COMMINGLING. Commingling is a serious violation of Indiana's license law and can result in license suspension or revocation."
            },
            {
              id: "in_b10q02",
              prompt: "The Indiana Real Estate Recovery Fund pays a consumer who obtains a judgment against a licensee for fraud. What happens to the licensee's license?",
              choices: [
...

        {
          ...
          quiz: [
            ...
            {
              id: "in_b11q02",
              prompt: "A Indiana investor owns a rental house with an adjusted basis of $150,000. If sold for $350,000, the $200,000 gain is potentially subject to:",
              choices: [
                "Only federal capital gains tax",
                "Federal capital gains tax, Indiana state income tax (if applicable), and depreciation recapture tax",
                "Only depreciation recapture tax",
                "No tax if the investor lived in the property at any point"
              ],
              answer: 1,
              explanation: "The sale of a Indiana rental property triggers: (1) federal capital gains tax (0%, 15%, or 20% depending on income), (2) Indiana state income tax on the gain (if Indiana has income tax), and (3) depreciation recapture tax (max 25% federal) on any depreciation previously claimed. All must be considered in the analysis."
            }
          ]
        },

        {
          id: "in_b12",
          order: 12,
          title: "Indiana State Law Review & Exam Prep",
          week: "11-12",
          passingScore: 75,
          icon: "📚",
          objective: "Review Indiana-specific exam topics, practice state exam questions, and prepare for the PSI Exams exam.",
          content: [
            {
              heading: "Indiana State Exam Key Topics",
              body: "Indiana state exam will focus on:\n\n1. Indiana license law — Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission rules and procedures\n2. Indiana agency law — specific state requirements\n3. Indiana contract forms and requirements\n4. Indiana disclosure laws\n5. Indiana property tax system\n6. Indiana closing procedures\n7. Indiana-specific restrictions and regulations\n8. Indiana fair housing additions\n9. Indiana landlord-tenant law\n10. Indiana environmental law\n\nIndiana unique state exam emphasis: Indiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level.\n\nStudy strategy:\n• Review Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission website for current rules and statutes\n• Take multiple practice state exams\n• Focus on Indiana-specific rules that differ from other states\n• Review recent disciplinary actions for common violations"
            },
            {
          ...
          quiz: [
            {
              id: "in_b12q01",
              prompt: "Which Indiana licensing body has the authority to suspend or revoke a real estate license?",
              choices: [
                "The National Association of Realtors (NAR)",
                "The Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission",
                "The federal Department of Housing and Urban Development (HUD)",
                "The local Multiple Listing Service (MLS)"
              ],
              answer: 1,
              explanation: "Only the Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission has the legal authority to suspend or revoke a Indiana real estate license. NAR can impose disciplinary action on REALTORS® (including expulsion), but this is separate from state licensing. HUD enforces fair housing law but does not issue or revoke state real estate licenses."
            },
            {
              id: "in_b12q02",
              prompt: "A Indiana licensee who fails to renew their license by the renewal deadline will:",
              choices: [
    ...
    mlo: {
      id: "mlo",
      label: "IN MLO License (SAFE Act)",
      icon: "🏦",
      color: "#1565C0",
      description: "NMLS SAFE MLO exam prep — 20-hour federal pre-license + Indiana Department of Financial Institutions state requirements",
      requirements: [
        ...
        "Sponsored by a Indiana-licensed mortgage company",
      ...
      fees: [
        ...
        { item: "Indiana state license fee", amount: "$150–$300", source: "Indiana Department of Financial Institutions" },
      ...
      modules: [
        {
          id: "in_m01",
          order: 1,
          title: "SAFE Act & Indiana MLO Licensing",
          week: "1-2",
          passingScore: 75,
          icon: "📋",
          objective: "Navigate NMLS MU4 process, Indiana Department of Financial Institutions requirements, and Indiana Housing and Community Development Authority (IHCDA) programs.",
          content: [
            {
              heading: "Indiana MLO Regulation — Indiana Department of Financial Institutions",
              body: "Indiana MLOs are regulated by the Indiana Department of Financial Institutions through NMLS.\n\nAll persons taking mortgage applications or negotiating mortgage terms in Indiana must hold an active NMLS MLO license with a Indiana state endorsement.\n\nLicensing steps:\n1. Create NMLS account; complete MU4 form\n2. Authorize criminal background check and credit report\n3. Complete 20 hours of NMLS-approved pre-license education\n4. Pass SAFE MLO National Test with Uniform State Content (75%)\n5. Apply for Indiana state endorsement through NMLS\n6. Obtain sponsorship from Indiana-licensed mortgage company\n7. Pay all fees\n\nAnnual renewal: 8 CE hours by December 31 (3hr federal, 2hr ethics, 2hr non-traditional, 1hr elective)."
            },
            {
              heading: "Indiana Housing and Community Development Authority (IHCDA) Programs",
              body: "Indiana Housing and Community Development Authority (IHCDA) provides mortgage programs for Indiana homebuyers:\n\n• First mortgage programs with below-market rates for income-qualified buyers\n• Down payment assistance programs (grants or second mortgages)\n• Special programs for veterans, teachers, and other qualifying groups\n\nFederal programs in Indiana:\n• FHA loans: common for first-time buyers\n• VA loans: for eligible veterans and service members\n• USDA rural development: for eligible rural Indiana areas\n• Conventional/conforming: Fannie Mae and Freddie Mac programs\n\nMLO value: knowing Indiana's state housing agency programs differentiates Indiana MLOs from competitors, especially for first-time and low-to-moderate income buyers."
            }
          ],
          quiz: [
            {
              id: "in_m01q01",
              prompt: "Which agency regulates Indiana MLO licenses?",
              choices: [
                "Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission",
                "Indiana Department of Financial Institutions",
                "Indiana Attorney General",
                "CFPB"
              ],
              answer: 1,
              explanation: "Indiana MLO licenses are regulated by the Indiana Department of Financial Institutions. Real estate brokers and salespersons are regulated by the Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission. These are separate regulatory systems — an MLO license and a real estate license are different credentials."
            },
            {
              id: "in_m01q02",
              prompt: "An MLO in Indiana must complete annual continuing education by:",
    ...
    practical: {
      id: "practical",
      label: "IN Practical Field Skills",
      icon: "🏡",
      color: "#2E7D32",
      description: "Indiana real-world transaction skills: listing, buyer representation, investment analysis, closing",
      requirements: [
      ...
      modules: [
        {
          id: "in_p01",
          order: 1,
          title: "Indiana Listing Process",
          week: "1-4",
          passingScore: 70,
          icon: "📋",
          objective: "Master Indiana listing procedures from pre-listing due diligence through pricing and marketing.",
          content: [
            {
              heading: "Indiana Pre-Listing Preparation",
              body: "Steps to prepare a Indiana listing:\n\n1. Due diligence:\n• Pull county tax records\n• Research HOA (if applicable) — request documents and status\n• Check for any liens or encumbrances\n• Research Indiana-specific issues: seller disclosure law and no transfer tax\n• Verify property boundary and any easements\n\n2. Complete Seller's Property Disclosure:\n• All known material defects must be disclosed\n• Indiana-specific disclosure items: Indiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level.\n• Review for completeness before listing\n\n3. Pricing analysis:\n• Prepare CMA using recent comparables\n• Consider Indiana market conditions and seasonal patterns\n• Present price range with supporting data\n\n4. Marketing strategy:\n• MLS listing with professional photography\n• Online marketing (Zillow, Realtor.com, brokerage website)\n• Indiana-specific marketing channels\n• Open houses and showings protocol"
            },
            {
              heading: "Indiana Market Dynamics",
              body: "Indiana's real estate market has unique characteristics:\n\nIndiana follows a disclosure-only seller's disclosure requirement under the Indiana Residential Real Estate Disclosure Law. Indiana has no real estate transfer tax at the state level.\n\nKey factors affecting Indiana real estate values:\n• Regional economic drivers\n• Population growth/decline trends\n• Employment centers and job market\n• Climate and geographic factors\n• Infrastructure and transportation access\n• School quality and amenities\n\nIndiana market challenges:\n• Inventory levels and competition\n• Affordability for first-time buyers\n• Indiana-specific regulatory environment\n• Seasonal demand patterns\n\nAgent success in Indiana: Develop deep knowledge of local submarkets, neighborhoods, and communities. Specialize in specific property types or geographic areas where you can provide genuine expertise to clients."
            }
          ],
          quiz: [
            {
              id: "in_p01q01",
              prompt: "During pre-listing due diligence for a Indiana property, an agent discovers the property may have seller disclosure law and no transfer tax issues. The agent should:",
              choices: [
              ...
              answer: 1,
              explanation: "When an agent discovers potential seller disclosure law and no transfer tax issues, they must research thoroughly and ensure proper disclosure. Material facts that would affect a buyer's decision must be disclosed. Concealing known issues exposes the agent and seller to liability."
            }
          ]
        },
  ...
  studyPlan: [
    { weeks: "1-2", focus: "Indiana licensing roadmap + 90-hour pre-license + PSI Exams exam structure + property ownership + concurrent ownership + seller disclosure law and no transfer tax" },
    { weeks: "3-4", focus: "Agency law + disclosure requirements + Indiana purchase contract + contingencies + earnest money trust accounts" },
    { weeks: "5-6", focus: "Financing + Indiana Housing and Community Development Authority (IHCDA) programs + federal mortgage regulations + title insurance + recording system" },
    { weeks: "7-8", focus: "Valuation + CMA + fair housing (Indiana additions) + Indiana license law + advertising rules + trust accounts" },
    { weeks: "9-10", focus: "Landlord-tenant law + property management + environmental disclosures + Indiana-specific issues" },
    { weeks: "11-12", focus: "Investment analysis + Indiana tax considerations + 1031 exchange + Indiana state exam review + full practice exams" }
  ],

  resources: [
    { label: "Indiana License Requirements", url: "https://www.google.com/search?q=Indiana+real+estate+license+requirements", category: "broker" },
    { label: "Indiana Professional Licensing Agency (PLA) / Indiana Real Estate Commission Website", url: "https://www.google.com/search?q=Indiana+Professional+Licensing+Agency+(PLA)+/+Indiana+Real+Estate+Commission+official+website", category: "broker" },
    { label: "PSI Exams — Indiana Exam", url: "https://www.google.com/search?q=PSI+Exams+Indiana+real+estate+exam", category: "broker" },
    { label: "Indiana Housing and Community Development Authority (IHCDA)", url: "https://www.google.com/search?q=Indiana+Housing+and+Community+Development+Authority+(IHCDA)+Indiana", category: "mlo" },
    { label: "Indiana Department of Financial Institutions", url: "https://www.google.com/search?q=Indiana+Department+of+Financial+Institutions+MLO+license", category: "mlo" }
  ]
};

if (typeof module !== 'undefined') module.exports = CURRICULUM_IN;
